...
execute if score #test value matches 0 run return run schedule function flamingo_custom:autoload_daytona_speedway 10t
#=====

#import track
#(note: this will work once, then doing nothing on subsequent import attempts)
function sprint_racer:game_logic/10/storage/import_track {filename:"flamingo_daytona_speedway"}