...
execute if score #praiadeabril value matches 0 if block -1373 74 -1488 air if block -1373 74 -1489 air if block -1373 74 -1488 air if block -1483 80 -1478 air if entity @e[tag=w,type=armor_stand,tag=!switchON] run function sprint_racer:levels/praia_de_abril/close_shortcut