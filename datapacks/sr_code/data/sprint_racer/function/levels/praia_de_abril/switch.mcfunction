...
#TURN OFF (RED)
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,tag=turnItOff] run setblock -1373 68 -1486 air destroy
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,tag=turnItOff] run setblock -1373 68 -1489 air destroy
