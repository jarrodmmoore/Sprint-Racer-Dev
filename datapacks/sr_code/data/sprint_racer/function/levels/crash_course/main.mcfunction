...
#execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gameTime=160..}] run effect give @a[tag=playing,gamemode=adventure,scores={lapFake=..1}] slowness 1 1 false
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gameState=1}] unless entity @a[scores={lapFake=2..}] as @e[tag=itemcontainer] at @s run function sprint_racer:items/container_delete
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gameState=1}] if score #halftick value matches 1 unless entity @a[scores={lapFake=2..}] run scoreboard players set @e[tag=node,tag=itemchest,scores={nodeState=1..}] itemBlockState 10
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gameState=1}] unless entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=halftick] unless entity @a[scores={lapFake=2..}] run scoreboard players set @e[tag=node,tag=itemchest,scores={nodeState=1..}] itemBlockState 5
...
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gameState=1,gameTime=164..}] as @a[tag=playing,tag=!noInventory,gamemode=adventure,tag=!hasTutor] run function sprint_racer_language:levels/crash_course/give_tutor_book
...
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=halftick,scores={gameTime=200..201}] as @a[tag=!noTutorial,scores={tutorProgress=..0}] at @s run function sprint_racer_language:levels/crash_course/tutorial_sprint_gain_speed
