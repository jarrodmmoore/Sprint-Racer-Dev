...
#TURN ON (LIME)
execute if entity @e[tag=w,type=armor_stand,tag=!turnItOff] run clone 784 58 542 787 58 551 784 65 542
execute if entity @e[tag=w,type=armor_stand,tag=!turnItOff] run fill 776 66 585 776 66 587 lime_wool
...
#TURN OFF (RED)
execute if entity @e[tag=w,type=armor_stand,tag=turnItOff] run clone 784 56 542 787 56 551 784 65 542
execute if entity @e[tag=w,type=armor_stand,tag=turnItOff] run fill 776 66 585 776 66 587 red_wool
