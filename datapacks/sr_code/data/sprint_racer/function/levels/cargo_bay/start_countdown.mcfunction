...
execute if entity @e[tag=w,type=armor_stand,scores={gameTime=50}] if entity @e[type=armor_stand,tag=51a,tag=cheats,x=1548,y=148,z=422,distance=..1] run function sprint_racer:levels/cargo_bay/stadium_layout_on
execute if entity @e[tag=w,type=armor_stand,scores={gameTime=50}] unless entity @e[type=armor_stand,tag=51a,tag=cheats,x=1548,y=148,z=422,distance=..1] run function sprint_racer:levels/cargo_bay/stadium_layout_off
