...
execute if entity @e[type=armor_stand,tag=51a,tag=cheats] run scoreboard players set @e[tag=w,type=armor_stand] lap 6
execute if entity @e[type=armor_stand,tag=51a,tag=cheats] run scoreboard players set @e[tag=w,type=armor_stand] check 2
