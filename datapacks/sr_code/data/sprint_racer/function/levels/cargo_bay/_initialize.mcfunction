...
execute if entity @e[type=armor_stand,tag=51a,tag=cheats,x=1548,y=148,z=422,distance=..1] run scoreboard players set @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand] lap 6
execute if entity @e[type=armor_stand,tag=51a,tag=cheats,x=1548,y=148,z=422,distance=..1] run scoreboard players set @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand] check 2
