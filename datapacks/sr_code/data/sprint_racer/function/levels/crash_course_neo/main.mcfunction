...
#sprint
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gameTime=200..}] as @a[tag=!noTutorial,scores={tutorProgress=..0}] run scoreboard players set @s tutorialMessage 1
#jump boost
