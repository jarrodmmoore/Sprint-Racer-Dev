...
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={oTimerGlobal=1}] if loaded 142 39 961 run summon area_effect_cloud 142 39 961 {custom_particle:{type:"block",block_state:{id:"air"}},Duration:50,WaitTime:0,Tags:["risingTrail","randomSpread"]}
