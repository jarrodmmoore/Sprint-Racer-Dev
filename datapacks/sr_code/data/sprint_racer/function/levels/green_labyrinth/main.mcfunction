...
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={mapZone=1}] if entity @e[tag=activeplayer,scores={lapFake=2..}] run function sprint_racer:levels/green_labyrinth/open_yellow_route
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={mapZone=2}] if entity @e[tag=activeplayer,scores={lapFake=3..}] run function sprint_racer:levels/green_labyrinth/open_red_route
