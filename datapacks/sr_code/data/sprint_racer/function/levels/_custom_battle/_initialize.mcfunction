...
#TARGET COUNT
scoreboard players operation @e[tag=w,type=armor_stand] targetData = @s customTTargets

#MUSIC
execute as @e[type=armor_stand,tag=random,scores={rNumber=1..}] run scoreboard players operation @s math = @s rNumber
