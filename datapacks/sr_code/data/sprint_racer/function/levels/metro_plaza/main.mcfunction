...
execute if score global gameState matches 1..3 if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,limit=1,tag=halftick] run function sprint_racer:levels/metro_plaza/cars_main
