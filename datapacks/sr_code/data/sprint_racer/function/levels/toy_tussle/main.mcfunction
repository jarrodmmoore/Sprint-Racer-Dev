...
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,tag=!COPPA,scores={gameTime=180..,gameState=3..8}] run function sprint_racer:levels/toy_tussle/tank_mode