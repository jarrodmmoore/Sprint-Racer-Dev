#night vision
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,limit=1,scores={gameTime=..100100}] run effect give @a minecraft:night_vision 35 1 true
