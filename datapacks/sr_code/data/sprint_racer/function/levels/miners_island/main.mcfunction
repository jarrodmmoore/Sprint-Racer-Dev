...
#slime bouncer
scoreboard players add @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] gerald 1
...
tag @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] remove slimebouncer
