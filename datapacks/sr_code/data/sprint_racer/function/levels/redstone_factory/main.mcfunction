...
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gameTime=100000..}] if block 310 57 334 redstone_block run setblock 310 57 334 air

#change to a new route once someone hits a new lap
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={mapZone=1}] if entity @e[tag=activeplayer,scores={lapFake=2..}] run function sprint_racer:levels/redstone_factory/open_emerald_route
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={mapZone=2}] if entity @e[tag=activeplayer,scores={lapFake=3..}] run function sprint_racer:levels/redstone_factory/open_gold_route

#route 1 wind tunnel
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={oTimerGlobal=1}] if loaded 326 59 275 run summon area_effect_cloud 326 59 275 {custom_particle:{type:"block",block_state:{Name:"air"}},Duration:50,WaitTime:0,Tags:["risingTrail","randomSpread"]}
...
scoreboard players operation @a[tag=playing,x=310,y=61,z=328,dx=2,dy=2,dz=5] mapZone = @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,limit=1] mapZone
scoreboard players operation @a[tag=playing,x=268,y=68,z=275,dx=6,dy=4,dz=7] mapZone = @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,limit=1] mapZone
