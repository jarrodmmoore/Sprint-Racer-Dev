...
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=noRubberBand] run scoreboard players set @e[tag=ai,limit=9] aiRubberBand 0
...
scoreboard players add @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=halftick] GTplatTimer 1
scoreboard players set @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={GTplatTimer=49..}] GTplatTimer 1
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={GTplatTimer=20..21}] run effect give @a[gamemode=adventure,scores={coord_y=..310000}] minecraft:nausea 5 1 true
