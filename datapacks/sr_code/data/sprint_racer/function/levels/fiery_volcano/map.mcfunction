...
item replace entity @a[gamemode=adventure,tag=!hasTrackMap,tag=!noInventory] hotbar.7 with minecraft:filled_map[map_id=345,custom_data={trackMap:1b,rightclick:1b}] 1