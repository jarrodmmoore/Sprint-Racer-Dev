...
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,scores={gameTime=0}] as @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,limit=1] unless score @s lap = @e[tag=chosenTrack,type=armor_stand,limit=1] lap run function sprint_racer:levels/_custom_race/gauntlet_added_laps
