...
item replace entity @a[gamemode=adventure,tag=!hasTrackMap,tag=!noInventory] hotbar.8 with minecraft:filled_map[map_id=181,custom_data={trackMap:1b,rightclick:1b}] 1