...
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gameTime=160..99999,oTimerGlobal=1}] run tag @e[tag=goofNav] remove goofNav
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gameTime=160..99999,oTimerGlobal=1}] run tag @e[limit=1,sort=random,tag=random,x=1548,y=155,z=406,distance=..1,scores={rNumber=1..7}] add goofNav
scoreboard players operation @a recDirection = @e[tag=goofNav,limit=1] rNumber
scoreboard players set @a wrongWayBuffer 0
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gameTime=100000..}] run tag @e[tag=goofNav] remove goofNav
...
execute unless entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gameState=1,gamemodePresetA=2}] run execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={timeRemaining2=..0}] run bossbar set minecraft:gauntlettime players
...
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gameTime=160..99999}] if entity @a[tag=playing,scores={check=0..1}] run function sprint_racer:levels/cotton_void/platforms
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=halftick,scores={gameTime=160..99999}] if entity @a[tag=playing,scores={check=0..1}] run function sprint_racer:levels/cotton_void/platforms
...
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gameTime=160..99999}] as @a[tag=playing,gamemode=adventure,nbt={OnGround:1b}] at @s run function sprint_racer:levels/cotton_void/glass_check
