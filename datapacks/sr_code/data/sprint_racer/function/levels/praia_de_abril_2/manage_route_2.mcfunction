...
#drop-down to switch (open)
execute if block 1504 82 -899 yellow_stained_glass if block 1504 86 -896 yellow_stained_glass run fill 1504 82 -899 1504 86 -896 air
execute if block 1500 82 -895 yellow_stained_glass if block 1503 86 -895 yellow_stained_glass run fill 1500 82 -895 1503 86 -895 air
...
#dropdown to switch
execute unless block 1509 80 -893 gold_block if entity @e[type=marker,tag=pda2_r3,limit=1] run scoreboard players set @e[type=marker,tag=pda2_r3] AIBC_dir1 117
execute unless block 1509 80 -893 gold_block if entity @e[type=marker,tag=pda2_r3,limit=1] run setblock 1509 80 -893 gold_block
