...
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gameTime=200..}] as @e[tag=activeplayer] if score @s lapFake > #pdaLap value run function sprint_racer:levels/praia_de_abril_2/open_next_route
...
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=switchON] run scoreboard players set #pdaSwitch value 1
