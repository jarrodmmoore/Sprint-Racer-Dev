...
#TURN ON (LIME)
execute if entity @e[tag=w,type=armor_stand,tag=!turnItOff] run fill -1206 75 -2924 -1206 77 -2922 air
execute if entity @e[tag=w,type=armor_stand,tag=!turnItOff] run fill -1203 81 -2955 -1201 81 -2955 lime_wool
...
#TURN OFF (RED)
execute if entity @e[tag=w,type=armor_stand,tag=turnItOff] run fill -1206 75 -2924 -1206 77 -2922 warped_fence
execute if entity @e[tag=w,type=armor_stand,tag=turnItOff] run fill -1203 81 -2955 -1201 81 -2955 red_wool
