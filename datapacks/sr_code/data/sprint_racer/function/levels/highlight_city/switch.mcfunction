...
#TURN OFF (RED)
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=turnItOff] run setblock 550 73 300 air destroy
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=turnItOff] run setblock 547 73 300 air destroy
