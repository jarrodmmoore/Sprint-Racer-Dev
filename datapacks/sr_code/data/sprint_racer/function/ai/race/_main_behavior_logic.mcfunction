#rubberbanding stuff
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={currentTimeMsec=1,oTimer=1,gameTime=..99999}] run function sprint_racer:ai/race/rubberbanding/_skill_index
