#-9..-1 and 1001..1017
execute store result score @s aiEntityRandomized run random value -9..16

#re-roll in the proper range if we landed in the credits mannequins
execute if score @s aiEntityRandomized matches 0.. store result score @s aiEntityRandomized run random value 1001..1017
...
execute if score #test2 value matches 2.. run function sprint_racer:ai/general/pick_random_entity_human