...
execute unless entity @s[tag=recoveryPoint] unless entity @s[tag=warpstuck] run function sprint_racer:ai/general/reset
execute if entity @s[tag=warpstuck] run function sprint_racer:ai/general/skip_to_target

scoreboard players add @s[tag=warpstuck] teleportCount 2
kill @s[tag=warpstuck,scores={teleportCount=6..}]
