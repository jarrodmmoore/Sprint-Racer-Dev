...
execute unless entity @e[tag=aiTarget6,type=area_effect_cloud] run summon area_effect_cloud ~ ~ ~ {Tags:["aiTarget6"],Duration:6}
...
data merge entity @e[limit=1,tag=aiTarget6,type=area_effect_cloud] {Duration:6}
