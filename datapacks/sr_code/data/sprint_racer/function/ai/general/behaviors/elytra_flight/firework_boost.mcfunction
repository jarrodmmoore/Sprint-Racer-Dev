...
execute as @e[tag=flyinghere,type=marker,limit=1,sort=nearest] store result score @e[tag=fb_self,limit=1,sort=nearest] mvmt_coord_dx run data get entity @s Pos[0] 10000
...
execute as @e[tag=flyinghere,type=marker,limit=1,sort=nearest] store result score @e[tag=fb_self,limit=1,sort=nearest] mvmt_coord_dz run data get entity @s Pos[2] 10000
