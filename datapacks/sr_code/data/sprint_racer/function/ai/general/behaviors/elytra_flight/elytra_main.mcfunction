...
execute unless entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gameState=3}] run function sprint_racer:ai/general/behaviors/elytra_flight/race_pick_target
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gameState=3}] run function sprint_racer:ai/general/behaviors/elytra_flight/battle_pick_target
