...
execute if entity @s[tag=!elytra_specific] unless entity @e[tag=aiElyTarget8] run function sprint_racer:ai/general/behaviors/elytra_flight/battle_tag_random_player
...
tag @e[tag=newTarget] add aiElyTarget8
