...
execute if entity @s[tag=!elytra_specific] unless entity @e[tag=aiElyTarget6] run function sprint_racer:ai/general/behaviors/elytra_flight/race_tag_next_cp
execute if entity @s[tag=!elytra_specific] unless entity @e[tag=aiElyTarget6] run tag @e[tag=nextcp] add aiElyTarget6
