...
execute if score global gameState matches 3 unless score @s itemCooldown matches ..0 unless entity @e[type=armor_stand,tag=35a,tag=cheats,x=1548,y=148,z=422,distance=..1] run scoreboard players set @s[scores={aiSkill=2..}] aiActMCooldown 3