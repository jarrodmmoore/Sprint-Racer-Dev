...
tag @s add selfCT
execute if entity @s[tag=!playerOrange,tag=!playerCyan] unless entity @e[tag=aiTarget9] run tag @e[limit=1,tag=activeplayer,tag=!selfCT,distance=..10,sort=nearest,scores={invisibility=..0}] add chasetarget
execute if entity @s[tag=playerOrange] unless entity @e[tag=aiTarget9] run tag @e[limit=1,tag=activeplayer,tag=playerCyan,tag=!selfCT,distance=..10,sort=nearest,scores={invisibility=..0}] add chasetarget
execute if entity @s[tag=playerCyan] unless entity @e[tag=aiTarget9] run tag @e[limit=1,tag=activeplayer,tag=playerOrange,tag=!selfCT,distance=..10,sort=nearest,scores={invisibility=..0}] add chasetarget
