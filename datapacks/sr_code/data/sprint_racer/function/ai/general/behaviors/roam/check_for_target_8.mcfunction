...
execute unless entity @e[tag=aiTarget8,type=area_effect_cloud] run summon area_effect_cloud ~ ~ ~ {Tags:["aiTarget8"],Particle:{type:"block",block_state:{Name:"air"}},Duration:6}
...
data merge entity @e[limit=1,tag=aiTarget8,type=area_effect_cloud] {Particle:{type:"block",block_state:{Name:"air"}},Duration:6}
