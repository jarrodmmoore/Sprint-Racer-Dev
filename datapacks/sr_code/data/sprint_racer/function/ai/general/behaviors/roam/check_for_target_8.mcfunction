...
execute unless entity @e[tag=aiTarget8,type=area_effect_cloud] run summon area_effect_cloud ~ ~ ~ {Tags:["aiTarget8"],custom_particle:{type:"block",block_state:{id:"air"}},Duration:6,WaitTime:0}
...
data merge entity @e[limit=1,tag=aiTarget8,type=area_effect_cloud] {custom_particle:{type:"block",block_state:{id:"air"}},Duration:6,WaitTime:0}
