...
execute unless entity @e[tag=aiTarget3,type=area_effect_cloud] run summon area_effect_cloud ~ ~ ~ {Tags:["aiTarget3"],Duration:6}
...
data merge entity @e[limit=1,tag=aiTarget3,type=area_effect_cloud] {Duration:6}
