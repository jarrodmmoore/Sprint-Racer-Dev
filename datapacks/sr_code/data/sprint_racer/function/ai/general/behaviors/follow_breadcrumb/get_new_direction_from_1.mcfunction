...
execute if entity @s[scores={AIBC_dir1=0}] run tag @e[tag=random,x=1548,y=155,z=406,distance=..1,type=armor_stand,scores={rNumber=1..8}] add randomNOGO
execute if entity @s[scores={AIBC_dir2=0}] run tag @e[tag=random,x=1548,y=155,z=406,distance=..1,type=armor_stand,scores={rNumber=9..10}] add randomNOGO
execute if entity @s[scores={AIBC_dir3=0}] run tag @e[tag=random,x=1548,y=155,z=406,distance=..1,type=armor_stand,scores={rNumber=11}] add randomNOGO
execute if entity @s[scores={AIBC_dir4=0}] run tag @e[tag=random,x=1548,y=155,z=406,distance=..1,type=armor_stand,scores={rNumber=12..13}] add randomNOGO
