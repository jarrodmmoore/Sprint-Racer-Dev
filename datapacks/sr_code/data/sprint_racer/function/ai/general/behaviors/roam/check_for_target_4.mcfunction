...
execute unless entity @e[tag=aiTarget4,type=area_effect_cloud] run summon area_effect_cloud ~ ~ ~ {Tags:["aiTarget4"],Particle:{type:"block",block_state:{Name:"air"}},Duration:6,WaitTime:0}
...
data merge entity @e[limit=1,tag=aiTarget4,type=area_effect_cloud] {Particle:{type:"block",block_state:{Name:"air"}},Duration:6,WaitTime:0}
