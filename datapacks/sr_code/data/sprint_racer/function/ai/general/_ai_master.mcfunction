...
#make sure entity exists and isn't missing and respawn if needed
function sprint_racer:ai/general/check_if_alive/_index
...
execute as @e[tag=myCHILD,limit=1] at @s run function sprint_racer:ai/general/_ai_child
#==============================
