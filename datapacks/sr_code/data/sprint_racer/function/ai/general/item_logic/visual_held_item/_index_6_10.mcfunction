...
execute if entity @s[scores={aiHoldingItem=9}] run data merge entity @s {HandItems:[{id:"minecraft:emerald",count:1,components:{"minecraft:damage":31,"minecraft:enchantments":{levels:{"minecraft:knockback":10}}}},{}]}
