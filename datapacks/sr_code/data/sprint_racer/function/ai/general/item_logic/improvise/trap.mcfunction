...
execute if entity @s[scores={aiHasItem13=1..}] run tag @e[tag=random,type=armor_stand,scores={rNumber=1}] add improvPick
execute if entity @s[scores={aiHasItem14=1..}] run tag @e[tag=random,type=armor_stand,scores={rNumber=2}] add improvPick
execute if entity @s[scores={aiHasItem15=1..}] run tag @e[tag=random,type=armor_stand,scores={rNumber=3}] add improvPick
execute if entity @s[scores={aiHasItem16=1..}] run tag @e[tag=random,type=armor_stand,scores={rNumber=4}] add improvPick
execute if entity @s[scores={aiHasItem33=1..}] run tag @e[tag=random,type=armor_stand,scores={rNumber=5}] add improvPick
execute if entity @s[scores={aiHasItem34=1..}] run tag @e[tag=random,type=armor_stand,scores={rNumber=6}] add improvPick
execute if entity @s[scores={aiHasItem35=1..}] run tag @e[tag=random,type=armor_stand,scores={rNumber=7}] add improvPick
execute if entity @s[scores={aiHasItem36=1..}] run tag @e[tag=random,type=armor_stand,scores={rNumber=8}] add improvPick
