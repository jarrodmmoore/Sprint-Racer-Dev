#deploy magma trap
summon armor_stand ~ ~1 ~ {Tags:["magmatrap","trap","giveID"],Motion:[0.0d,0.5d,0.0d],Silent:1b,Invisible:1,Small:1b,DisabledSlots:4144959,ArmorItems:[{},{},{},{id:"minecraft:magma_block",count:1}]}
