...
execute if entity @s[scores={aiHasItem17=1..}] run tag @e[tag=random,type=armor_stand,scores={rNumber=1}] add improvPick
execute if entity @s[scores={aiHasItem18=1..}] run tag @e[tag=random,type=armor_stand,scores={rNumber=2}] add improvPick
execute if entity @s[scores={aiHasItem19=1..}] run tag @e[tag=random,type=armor_stand,scores={rNumber=3}] add improvPick
execute if entity @s[scores={aiHasItem20=1..}] run tag @e[tag=random,type=armor_stand,scores={rNumber=4}] add improvPick
execute if entity @s[scores={aiHasItem37=1..}] run tag @e[tag=random,type=armor_stand,scores={rNumber=5}] add improvPick
execute if entity @s[scores={aiHasItem38=1..}] run tag @e[tag=random,type=armor_stand,scores={rNumber=6}] add improvPick
execute if entity @s[scores={aiHasItem39=1..}] run tag @e[tag=random,type=armor_stand,scores={rNumber=7}] add improvPick
execute if entity @s[scores={aiHasItem40=1..}] run tag @e[tag=random,type=armor_stand,scores={rNumber=8}] add improvPick
