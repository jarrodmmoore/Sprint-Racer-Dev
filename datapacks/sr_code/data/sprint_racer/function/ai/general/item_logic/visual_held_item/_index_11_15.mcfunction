...
execute if entity @s[scores={aiHoldingItem=15}] run data merge entity @s {HandItems:[{id:"minecraft:bricks",count:1,components:{"minecraft:custom_model_data":1111111}},{}]}