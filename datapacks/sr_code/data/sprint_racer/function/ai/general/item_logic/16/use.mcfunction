...
summon item ~ ~1 ~ {PickupDelay:100,Tags:["nopickup"],Motion:[0.0d,0.5d,0.0d],Invulnerable:1,Item:{id:"minecraft:trapped_chest",count:1,components:{"minecraft:custom_data":{no16:1b,stay:1b,item:1b,normalitem:1b,groundDeploy:1b}}}}
