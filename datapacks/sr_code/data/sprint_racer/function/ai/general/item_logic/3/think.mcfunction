...
execute if entity @s[tag=!good2throw] unless entity @e[tag=w,type=armor_stand,scores={gameState=3}] run function sprint_racer:ai/general/item_logic/3/think_alt_race
execute if entity @s[tag=!good2throw] if entity @e[tag=w,type=armor_stand,scores={gameState=3}] run function sprint_racer:ai/general/item_logic/3/think_alt_battle
