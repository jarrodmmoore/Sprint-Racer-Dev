...
scoreboard players operation @s repeatCount = @e[limit=1,type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] playerCountB
scoreboard players operation @s repeatCount /= @e[limit=1,type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] math
