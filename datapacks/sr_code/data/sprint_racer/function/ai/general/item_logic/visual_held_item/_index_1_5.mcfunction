...
execute if entity @s[scores={aiHoldingItem=4}] run data merge entity @s {HandItems:[{id:"minecraft:golden_sword",count:1,components:{"minecraft:damage":32,"minecraft:enchantments":{levels:{"minecraft:knockback":10}}}},{}]}
