#deploy a land mine
summon item ~ ~1 ~ {PickupDelay:100,Tags:["nopickup"],Motion:[0.0d,0.5d,0.0d],Invulnerable:1,Item:{id:"minecraft:smooth_stone_slab",count:1,components:{"minecraft:enchantments":{levels:{"minecraft:lure":1},show_in_tooltip:0b},"minecraft:custom_data":{elite16:1b,stay:1b,item:1b,eliteitem:1b,groundDeploy:1b}}}}
