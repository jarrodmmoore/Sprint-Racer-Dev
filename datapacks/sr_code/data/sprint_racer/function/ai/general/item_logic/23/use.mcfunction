...
#TNT 1
execute as @e[tag=lookinghere1] store result score @e[tag=self] mvmt_coord_dx run data get entity @s Pos[0] 100000
execute as @e[tag=lookinghere1] store result score @e[tag=self] mvmt_coord_dy run data get entity @s Pos[1] 100000
execute as @e[tag=lookinghere1] store result score @e[tag=self] mvmt_coord_dz run data get entity @s Pos[2] 100000
...
execute facing entity @e[tag=lookinghere1,limit=1,sort=nearest] feet positioned ^ ^ ^.5 run summon tnt ~ ~1.8 ~ {fuse:1000,Tags:["giveVel","giveID"]}
...
kill @e[tag=lookinghere1]

#TNT 2
execute as @e[tag=lookinghere2] store result score @e[tag=self] mvmt_coord_dx run data get entity @s Pos[0] 100000
execute as @e[tag=lookinghere2] store result score @e[tag=self] mvmt_coord_dy run data get entity @s Pos[1] 100000
execute as @e[tag=lookinghere2] store result score @e[tag=self] mvmt_coord_dz run data get entity @s Pos[2] 100000
scoreboard players operation @s mvmt_coord_dx -= @s mvmt_coord_x
scoreboard players operation @s mvmt_coord_dy -= @s mvmt_coord_y
scoreboard players operation @s mvmt_coord_dz -= @s mvmt_coord_z
#summon a tnt and give it the right velocity
execute facing entity @e[tag=lookinghere2,limit=1,sort=nearest] feet positioned ^ ^ ^.5 run summon tnt ~ ~1.8 ~ {fuse:1000,Tags:["giveVel","giveID"]}
execute at @e[limit=1,tag=giveVel] run playsound minecraft:entity.snowball.throw master @a ~ ~ ~ .75 .5
execute store result entity @e[limit=1,tag=giveVel] Motion[0] double 0.0156 run scoreboard players get @s mvmt_coord_dx
execute store result entity @e[limit=1,tag=giveVel] Motion[1] double 0.0156 run scoreboard players get @s mvmt_coord_dy
execute store result entity @e[limit=1,tag=giveVel] Motion[2] double 0.0156 run scoreboard players get @s mvmt_coord_dz
tag @e[tag=giveVel] remove giveVel
kill @e[tag=lookinghere2]

#TNT 3
execute as @e[tag=lookinghere3] store result score @e[tag=self] mvmt_coord_dx run data get entity @s Pos[0] 100000
execute as @e[tag=lookinghere3] store result score @e[tag=self] mvmt_coord_dy run data get entity @s Pos[1] 100000
execute as @e[tag=lookinghere3] store result score @e[tag=self] mvmt_coord_dz run data get entity @s Pos[2] 100000
scoreboard players operation @s mvmt_coord_dx -= @s mvmt_coord_x
scoreboard players operation @s mvmt_coord_dy -= @s mvmt_coord_y
scoreboard players operation @s mvmt_coord_dz -= @s mvmt_coord_z
#summon a tnt and give it the right velocity
execute facing entity @e[tag=lookinghere3,limit=1,sort=nearest] feet positioned ^ ^ ^.5 run summon tnt ~ ~1.8 ~ {fuse:1000,Tags:["giveVel","giveID"]}
execute at @e[limit=1,tag=giveVel] run playsound minecraft:entity.snowball.throw master @a ~ ~ ~ .75 .5
execute store result entity @e[limit=1,tag=giveVel] Motion[0] double 0.0156 run scoreboard players get @s mvmt_coord_dx
execute store result entity @e[limit=1,tag=giveVel] Motion[1] double 0.0156 run scoreboard players get @s mvmt_coord_dy
execute store result entity @e[limit=1,tag=giveVel] Motion[2] double 0.0156 run scoreboard players get @s mvmt_coord_dz
tag @e[tag=giveVel] remove giveVel
kill @e[tag=lookinghere3]

#TNT 4
execute as @e[tag=lookinghere4] store result score @e[tag=self] mvmt_coord_dx run data get entity @s Pos[0] 100000
execute as @e[tag=lookinghere4] store result score @e[tag=self] mvmt_coord_dy run data get entity @s Pos[1] 100000
execute as @e[tag=lookinghere4] store result score @e[tag=self] mvmt_coord_dz run data get entity @s Pos[2] 100000
scoreboard players operation @s mvmt_coord_dx -= @s mvmt_coord_x
scoreboard players operation @s mvmt_coord_dy -= @s mvmt_coord_y
scoreboard players operation @s mvmt_coord_dz -= @s mvmt_coord_z
#summon a tnt and give it the right velocity
execute facing entity @e[tag=lookinghere4,limit=1,sort=nearest] feet positioned ^ ^ ^.5 run summon tnt ~ ~1.8 ~ {fuse:1000,Tags:["giveVel","giveID"]}
execute at @e[limit=1,tag=giveVel] run playsound minecraft:entity.snowball.throw master @a ~ ~ ~ .75 .5
execute store result entity @e[limit=1,tag=giveVel] Motion[0] double 0.0156 run scoreboard players get @s mvmt_coord_dx
execute store result entity @e[limit=1,tag=giveVel] Motion[1] double 0.0156 run scoreboard players get @s mvmt_coord_dy
execute store result entity @e[limit=1,tag=giveVel] Motion[2] double 0.0156 run scoreboard players get @s mvmt_coord_dz
tag @e[tag=giveVel] remove giveVel
kill @e[tag=lookinghere4]

#TNT 5
execute as @e[tag=lookinghere5] store result score @e[tag=self] mvmt_coord_dx run data get entity @s Pos[0] 100000
execute as @e[tag=lookinghere5] store result score @e[tag=self] mvmt_coord_dy run data get entity @s Pos[1] 100000
execute as @e[tag=lookinghere5] store result score @e[tag=self] mvmt_coord_dz run data get entity @s Pos[2] 100000
scoreboard players operation @s mvmt_coord_dx -= @s mvmt_coord_x
scoreboard players operation @s mvmt_coord_dy -= @s mvmt_coord_y
scoreboard players operation @s mvmt_coord_dz -= @s mvmt_coord_z
#summon a tnt and give it the right velocity
execute facing entity @e[tag=lookinghere5,limit=1,sort=nearest] feet positioned ^ ^ ^.5 run summon tnt ~ ~1.8 ~ {fuse:1000,Tags:["giveVel","giveID"]}
execute at @e[limit=1,tag=giveVel] run playsound minecraft:entity.snowball.throw master @a ~ ~ ~ .75 .5
execute store result entity @e[limit=1,tag=giveVel] Motion[0] double 0.0156 run scoreboard players get @s mvmt_coord_dx
execute store result entity @e[limit=1,tag=giveVel] Motion[1] double 0.0156 run scoreboard players get @s mvmt_coord_dy
execute store result entity @e[limit=1,tag=giveVel] Motion[2] double 0.0156 run scoreboard players get @s mvmt_coord_dz
tag @e[tag=giveVel] remove giveVel
kill @e[tag=lookinghere5]
