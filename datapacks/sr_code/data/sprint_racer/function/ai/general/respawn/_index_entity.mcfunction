...
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,limit=1,scores={gameState=1}] as @e[tag=set_ai_no,limit=1] run function sprint_racer:game_logic/1/charity_item/_index
