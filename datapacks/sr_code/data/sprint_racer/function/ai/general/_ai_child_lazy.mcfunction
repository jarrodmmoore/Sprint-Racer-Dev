...
execute if entity @s[tag=aiRememberVelocity,tag=!aiFly] unless entity @s[scores={aiBehavior=..0}] unless entity @s[scores={aiSubBehavior=5}] if score @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,limit=1] gameTime matches 160.. run function sprint_racer:ai/general/movement/move_at_target_echo
