...
execute if score #ai_tick value matches 1 as @e[type=armor_stand,tag=AImaster,tag=!aiDisable,tag=random,scores={rNumber=1..9}] run function sprint_racer:ai/general/_ai_master
execute if score #ai_tick value matches 0 as @e[type=armor_stand,tag=AImaster,tag=!aiDisable,tag=random,scores={rNumber=1..9}] run function sprint_racer:ai/general/_ai_master_lazy
