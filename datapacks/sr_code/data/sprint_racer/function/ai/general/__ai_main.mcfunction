...
execute if score #ai_tick value matches 1 as @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1,tag=!aiDisable,scores={rNumber=1..9}] run function sprint_racer:ai/general/_ai_master
execute if score #ai_tick value matches 0 as @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1,tag=!aiDisable,scores={rNumber=1..9}] run function sprint_racer:ai/general/_ai_master_lazy
