...
#go slightly faster when in deep water
scoreboard players set #test value 0
execute if entity @s[tag=inWater] if block ~ ~-0.9 ~ water run scoreboard players add #test value 1
execute if entity @s[tag=inWater] if block ~ ~-0.9 ~ #sprint_racer:waterloggable[waterlogged=true] run scoreboard players add #test value 1
execute if entity @s[tag=inWater] if block ~ ~.1 ~ water run scoreboard players add #test value 1
execute if entity @s[tag=inWater] if block ~ ~.1 ~ #sprint_racer:waterloggable[waterlogged=true] run scoreboard players add #test value 1
...
execute if score #test value matches 2.. run function sprint_racer:ai/general/movement/speed_level_3d/full_underwater_multiplier
