...
#execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=!halftick] run function sprint_racer:ai/general/movement/movement_scaler/_index_not_halftick
