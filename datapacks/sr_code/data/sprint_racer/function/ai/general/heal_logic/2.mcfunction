...
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,scores={oTimerGlobal=1}] if entity @s[tag=maybeRegen,scores={hitstun=..0,rNumber=1..2}] run tag @s add aiHealing
tag @s[tag=maybeRegen] remove maybeRegen
