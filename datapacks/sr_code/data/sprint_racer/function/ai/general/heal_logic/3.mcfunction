...
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={oTimerGlobal=1}] if entity @s[tag=maybeRegen,scores={hitstun=..0,rNumber=1..3}] run tag @s add aiHealing
tag @s[tag=maybeRegen] remove maybeRegen
