...
execute if score global gameState matches 1 if entity @e[type=armor_stand,tag=cheats,x=1548,y=148,z=422,distance=..1,tag=61a] run function sprint_racer:game_logic/1/eliminate_permadeath
