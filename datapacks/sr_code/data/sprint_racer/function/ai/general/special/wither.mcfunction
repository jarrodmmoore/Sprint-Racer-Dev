...
execute if entity @e[tag=w,scores={gameTime=160..}] run scoreboard players set @s aiHasNormal 6
execute if entity @e[tag=w,scores={gameTime=160..}] run scoreboard players set @s aiHasProjectile 6
