...
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gameTime=160..}] at @s if entity @e[tag=activeplayer,distance=..2,tag=!sa_chickenmine,scores={invisibility=..0}] run tag @s add finna_explode
