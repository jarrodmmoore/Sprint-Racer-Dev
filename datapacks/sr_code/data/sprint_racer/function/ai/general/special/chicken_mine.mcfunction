...
execute if entity @e[tag=w,type=armor_stand,scores={gameTime=160..}] at @s if entity @e[tag=activeplayer,distance=..2,tag=!sa_chickenmine,scores={invisibility=..0}] run tag @s add finna_explode
