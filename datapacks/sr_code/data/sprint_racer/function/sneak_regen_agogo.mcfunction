...
#apply heals
execute unless entity @e[type=armor_stand,tag=cheats,x=1548,y=148,z=422,distance=..1,tag=52a] run effect give @s minecraft:instant_health 1 0 true

#cheat code?
execute if entity @e[type=armor_stand,tag=cheats,x=1548,y=148,z=422,distance=..1,tag=24a] if items entity @s weapon.mainhand *[custom_data~{normalitem:1b}] run function sprint_racer:items/crouch_enchant
