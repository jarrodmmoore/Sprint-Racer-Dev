...
#only allow this function to execute if we're in the lobby, Custom Track Manager, or Grand Prix setup
execute unless score global gameState matches 0 unless score global gameState matches 10..11 run return run scoreboard players reset @s tOption
