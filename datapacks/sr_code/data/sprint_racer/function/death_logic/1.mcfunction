...
#respawn
execute unless score #halftick value matches 1 if entity @s[scores={death=10..,hp=1..}] at @s run function sprint_racer:game_logic/1/respawn
execute if score #halftick value matches 1 if entity @s[scores={death=5..,hp=1..}] at @s run function sprint_racer:game_logic/1/respawn
