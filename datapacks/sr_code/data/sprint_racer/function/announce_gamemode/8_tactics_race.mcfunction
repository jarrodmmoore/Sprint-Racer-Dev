scoreboard players set @e[tag=w,type=armor_stand] lastGamemode 8
...
execute as @a[tag=!minChat] unless entity @s[scores={math=0}] run function sprint_racer_language:_dlc_3/gamemode_info/tactics_race

scoreboard players set @a lastGamemode 8