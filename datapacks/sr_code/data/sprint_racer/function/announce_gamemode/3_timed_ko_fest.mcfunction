scoreboard players set @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand] lastGamemode 3
...
execute as @a[tag=!minChat] unless entity @s[scores={math=0}] run function sprint_racer_language:_dlc_1/gamemode_info/timed_ko_fest

scoreboard players set @a lastGamemode 3