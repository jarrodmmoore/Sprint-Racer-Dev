...
execute if entity @e[limit=1,type=armor_stand,tag=cheats,tag=54a] if entity @s[scores={customAIteam=1}] run scoreboard players set @e[tag=w,type=armor_stand] teamCount -1
execute if entity @e[limit=1,type=armor_stand,tag=cheats,tag=54a] if entity @s[scores={customAIteam=2}] run scoreboard players set @e[tag=w,type=armor_stand] teamCount 1
