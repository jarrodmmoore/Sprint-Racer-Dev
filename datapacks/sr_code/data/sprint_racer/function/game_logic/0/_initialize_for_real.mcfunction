...
scoreboard players operation @e[limit=1,type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] math = @e[limit=1,sort=random,tag=random,x=1548,y=155,z=406,distance=..1,type=armor_stand,scores={rNumber=1..2}] rNumber
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,limit=1,scores={math=1}] run tag @e[type=armor_stand,tag=random,x=1548,y=155,z=406,distance=..1,scores={rNumber=2}] add musicViable
...
scoreboard players operation @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] readyDummy = @e[tag=w,x=1560,y=150,z=406,distance=..1,limit=1] playerCountA
scoreboard players set @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] math 2
scoreboard players operation @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] readyDummy /= @e[tag=w,x=1560,y=150,z=406,distance=..1,limit=1] math
scoreboard players operation @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] readyRequired = @e[tag=w,x=1560,y=150,z=406,distance=..1,limit=1] readyDummy
scoreboard players add @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] readyRequired 1
...
scoreboard players set @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] readyDummy 0
...
scoreboard players operation @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] readyCount = @e[tag=w,x=1560,y=150,z=406,distance=..1,limit=1] readyDummy
...
scoreboard players operation @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] readyDummy -= @e[tag=w,x=1560,y=150,z=406,distance=..1,limit=1] readyRequired
...
tag @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] remove needAnnounce
tag @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=remind2vote] remove remind2vote
...
scoreboard players set @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] dropBarrier 1
...
scoreboard players set @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] gameTime 800
scoreboard players set @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] voteTime 600
...
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=!grandprix] run clone 1576 80 425 1580 84 433 1576 88 425
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=!grandprix] run fill 1576 91 456 1579 91 456 water replace iron_bars
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=grandprix] run clone 1576 68 425 1580 72 433 1576 88 425
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=grandprix] run fill 1576 91 456 1579 91 456 iron_bars[waterlogged=true] replace water
