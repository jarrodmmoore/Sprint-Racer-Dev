...
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,scores={wmCustomMode=1}] as @e[tag=customtrack,tag=customrace] run scoreboard players operation @s customDummyID = #test value
...
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,scores={wmCustomMode=2}] as @e[tag=customtrack,tag=custombattle] run scoreboard players operation @s customDummyBID = #test value
