...
execute if entity @s[tag=roundNo2] run tp @s ~ ~4.5 ~-1
execute if entity @s[tag=roundNo3] run tp @s ~ ~4.5 ~-2
execute if entity @s[tag=roundNo4] run tp @s ~ ~4.5 ~-3
execute if entity @s[tag=roundNo5] run tp @s ~ ~4.5 ~-4
execute if entity @s[tag=roundNo6] run tp @s ~ ~4.5 ~-5
execute if entity @s[tag=roundNo7] run tp @s ~ ~4.5 ~-6
execute if entity @s[tag=roundNo8] run tp @s ~ ~4.5 ~-7
execute if entity @s[tag=roundNo9] run tp @s ~ ~4.5 ~-8
execute if entity @s[tag=roundNo10] run tp @s ~ ~4.5 ~-9
...
execute if score #round_number value matches 2 at @s run tp @s ~ ~ ~1
execute if score #round_number value matches 3 at @s run tp @s ~ ~ ~2
execute if score #round_number value matches 4 at @s run tp @s ~ ~ ~3
execute if score #round_number value matches 5 at @s run tp @s ~ ~ ~4
execute if score #round_number value matches 6 at @s run tp @s ~ ~ ~5
execute if score #round_number value matches 7 at @s run tp @s ~ ~ ~6
execute if score #round_number value matches 8 at @s run tp @s ~ ~ ~7
execute if score #round_number value matches 9 at @s run tp @s ~ ~ ~8
execute if score #round_number value matches 10 at @s run tp @s ~ ~ ~9
execute if score #round_number value matches 11.. at @s run tp @s ~ ~ ~10
