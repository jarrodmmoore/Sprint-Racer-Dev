...
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=gp_no_skip_1] run tag @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] remove gp_skip2next
tag @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] remove gp_no_skip_1

#go straight to track select area if using "choose" mode
execute if entity @s[tag=gp_skip2next] if score #gpTrackSelect value matches 5 run tag @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] add skiptochoose
