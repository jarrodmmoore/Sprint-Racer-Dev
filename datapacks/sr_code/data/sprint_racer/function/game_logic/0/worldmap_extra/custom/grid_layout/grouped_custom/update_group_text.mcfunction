...
#apply the string
execute if score #trackGridEnd value matches ..18 as @e[type=text_display,tag=trackGridCustomText,distance=..2] run data modify entity @s text set value [{nbt:"group_string",storage:"sprint_racer:custom_track_list",interpret:true,underlined:true,bold:true,color:white}]
execute if score #trackGridEnd value matches 19.. as @e[type=text_display,tag=trackGridCustomText,distance=..2] run data modify entity @s text set value [{nbt:"group_string",storage:"sprint_racer:custom_track_list",interpret:true,underlined:true,bold:true,color:white},{text:" (",underlined:true,bold:true},{score:{name:"#test",objective:value},underlined:true,bold:true},{text:"/",underlined:true,bold:true},{score:{name:"#test2",objective:value},underlined:true,bold:true},{text:")",underlined:true,bold:true}]
