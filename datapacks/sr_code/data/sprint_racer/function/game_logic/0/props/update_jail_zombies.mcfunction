...
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,tag=!optRAInever] unless entity @e[tag=lobbyprop,tag=jail,tag=jailz1] positioned 1620 88 361 run summon zombie ~ ~ ~ {NoGravity:1b,NoAI:1,Invulnerable:1b,Silent:1b,Tags:["lobbyprop","jail","jailz1"]}
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,tag=!optBAInever] unless entity @e[tag=lobbyprop,tag=jail,tag=jailz2] positioned 1620 88 354 run summon zombie ~ ~ ~ {NoGravity:1b,NoAI:1,Invulnerable:1b,Silent:1b,Tags:["lobbyprop","jail","jailz2"]}
