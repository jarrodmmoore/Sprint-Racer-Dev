...
#2 = elimination
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=!randomPresetA,scores={gamemodePresetA=2}] run summon armor_stand 1615 80 371 {Tags:["lobbyprop","chestdisplay","gpA","tpMeUp"],Invisible:1b,Invulnerable:1b,NoBasePlate:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"skeleton_skull",count:1}],HandItems:[{},{}],DisabledSlots:2039583}
...
#2tag = random
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=randomPresetA] run summon armor_stand 1615 80 371 {Tags:["lobbyprop","chestdisplay","gpA","tpMeUp"],Invisible:1b,Invulnerable:1b,NoBasePlate:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"black_concrete",count:1}],HandItems:[{},{}],DisabledSlots:2039583}
