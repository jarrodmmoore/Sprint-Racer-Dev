...
#2 = elimination
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=!randomPresetB,scores={gamemodePresetB=2}] run summon armor_stand 1611 80 371 {Tags:["lobbyprop","chestdisplay","gpB","tpMeUp"],Invisible:1b,Invulnerable:1b,NoBasePlate:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"skeleton_skull",count:1}],HandItems:[{},{}],DisabledSlots:2039583}
...
#2tag = random
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=randomPresetB] run summon armor_stand 1611 80 371 {Tags:["lobbyprop","chestdisplay","gpB","tpMeUp"],Invisible:1b,Invulnerable:1b,NoBasePlate:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"black_concrete",count:1}],HandItems:[{},{}],DisabledSlots:2039583}
