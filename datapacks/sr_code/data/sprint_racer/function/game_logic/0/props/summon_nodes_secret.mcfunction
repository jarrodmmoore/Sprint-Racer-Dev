...
#egg
execute positioned 1575 19 352 positioned ~.35 ~ ~.35 run summon minecraft:armor_stand ~ ~-1.4 ~ {Tags:["cheategg","lobbyprop"],NoGravity:1b,Invulnerable:1b,Invisible:1b,NoBasePlate:1b,DisabledSlots:4144959,equipment:{head:{id:"minecraft:dragon_egg",count:1}},CustomName:{text:"UNDERWORLD",bold:true,italic:false}}