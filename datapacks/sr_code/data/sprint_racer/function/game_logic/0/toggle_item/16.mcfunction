tag @e[tag=w,tag=banNo16] add unban


tag @e[tag=w,tag=!unban] add banNo16
execute if entity @e[tag=w,tag=!unban] run tag @e[tag=random,scores={rNumber=16}] add capsuleBan
...
tag @e[tag=w,tag=unban] remove banNo16
execute if entity @e[tag=w,tag=unban] run tag @e[tag=random,scores={rNumber=16}] remove capsuleBan
