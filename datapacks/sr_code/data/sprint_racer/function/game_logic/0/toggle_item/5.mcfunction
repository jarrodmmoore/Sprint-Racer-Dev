execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=!banNo5,tag=!banEnchant5] run return \
    run function sprint_racer:game_logic/0/toggle_item/enchant_ban {item:"5",category:"yellow"}
#=====

tag @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=banNo5] add unban
tag @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=banNo5] remove banEnchant5


tag @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=!unban] add banNo5
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=!unban] run tag @e[tag=random,x=1548,y=155,z=406,distance=..1,scores={rNumber=5}] add capsuleBan
...
tag @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=unban] remove banNo5
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=unban] run tag @e[tag=random,x=1548,y=155,z=406,distance=..1,scores={rNumber=5}] remove capsuleBan
