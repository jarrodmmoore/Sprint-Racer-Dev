execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=!banNo20,tag=!banEnchant20] run return \
    run function sprint_racer:game_logic/0/toggle_item/enchant_ban {item:"20",category:"purple"}
#=====

tag @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=banNo20] add unban
tag @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=banNo20] remove banEnchant20


tag @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=!unban] add banNo20
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=!unban] run tag @e[tag=random,x=1548,y=155,z=406,distance=..1,scores={rNumber=20}] add capsuleBan
...
tag @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=unban] remove banNo20
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=unban] run tag @e[tag=random,x=1548,y=155,z=406,distance=..1,scores={rNumber=20}] remove capsuleBan
