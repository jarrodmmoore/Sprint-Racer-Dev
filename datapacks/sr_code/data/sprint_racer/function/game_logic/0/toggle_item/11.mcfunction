execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=!banNo11,tag=!banEnchant11] run return \
    run function sprint_racer:game_logic/0/toggle_item/enchant_ban {item:"11",category:"blue"}
#=====

tag @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=banNo11] add unban
tag @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=banNo11] remove banEnchant11


tag @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=!unban] add banNo11
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=!unban] run tag @e[tag=random,x=1548,y=155,z=406,distance=..1,scores={rNumber=11}] add capsuleBan
...
tag @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=unban] remove banNo11
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=unban] run tag @e[tag=random,x=1548,y=155,z=406,distance=..1,scores={rNumber=11}] remove capsuleBan
