tag @e[tag=w,tag=banNo14] add unban


tag @e[tag=w,tag=!unban] add banNo14
execute if entity @e[tag=w,tag=!unban] run tag @e[tag=random,scores={rNumber=14}] add capsuleBan
...
tag @e[tag=w,tag=unban] remove banNo14
execute if entity @e[tag=w,tag=unban] run tag @e[tag=random,scores={rNumber=14}] remove capsuleBan
