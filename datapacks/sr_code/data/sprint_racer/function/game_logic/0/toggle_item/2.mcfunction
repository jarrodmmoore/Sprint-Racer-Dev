tag @e[tag=w,tag=banNo2] add unban


tag @e[tag=w,tag=!unban] add banNo2
execute if entity @e[tag=w,tag=!unban] run tag @e[tag=random,scores={rNumber=2}] add capsuleBan
...
tag @e[tag=w,tag=unban] remove banNo2
execute if entity @e[tag=w,tag=unban] run tag @e[tag=random,scores={rNumber=2}] remove capsuleBan
