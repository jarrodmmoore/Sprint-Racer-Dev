tag @e[tag=w,tag=banNo4] add unban


tag @e[tag=w,tag=!unban] add banNo4
execute if entity @e[tag=w,tag=!unban] run tag @e[tag=random,scores={rNumber=4}] add capsuleBan
...
tag @e[tag=w,tag=unban] remove banNo4
execute if entity @e[tag=w,tag=unban] run tag @e[tag=random,scores={rNumber=4}] remove capsuleBan
