tag @e[tag=w,tag=banNo17] add unban


tag @e[tag=w,tag=!unban] add banNo17
execute if entity @e[tag=w,tag=!unban] run tag @e[tag=random,scores={rNumber=17}] add capsuleBan
...
tag @e[tag=w,tag=unban] remove banNo17
execute if entity @e[tag=w,tag=unban] run tag @e[tag=random,scores={rNumber=17}] remove capsuleBan
