tag @e[tag=w,tag=banNo3] add unban


tag @e[tag=w,tag=!unban] add banNo3
execute if entity @e[tag=w,tag=!unban] run tag @e[tag=random,scores={rNumber=3}] add capsuleBan
...
tag @e[tag=w,tag=unban] remove banNo3
execute if entity @e[tag=w,tag=unban] run tag @e[tag=random,scores={rNumber=3}] remove capsuleBan
