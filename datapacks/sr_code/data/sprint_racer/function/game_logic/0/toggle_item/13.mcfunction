tag @e[tag=w,tag=banNo13] add unban


tag @e[tag=w,tag=!unban] add banNo13
execute if entity @e[tag=w,tag=!unban] run tag @e[tag=random,scores={rNumber=13}] add capsuleBan
...
tag @e[tag=w,tag=unban] remove banNo13
execute if entity @e[tag=w,tag=unban] run tag @e[tag=random,scores={rNumber=13}] remove capsuleBan
