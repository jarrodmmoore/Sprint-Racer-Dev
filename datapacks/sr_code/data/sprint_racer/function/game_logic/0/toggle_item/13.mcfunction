execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=!banNo13,tag=!banEnchant13] run return \
    run function sprint_racer:game_logic/0/toggle_item/enchant_ban {item:"13",category:"green"}
#=====

tag @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=banNo13] add unban
tag @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=banNo13] remove banEnchant13


tag @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=!unban] add banNo13
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=!unban] run tag @e[tag=random,x=1548,y=155,z=406,distance=..1,scores={rNumber=13}] add capsuleBan
...
tag @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=unban] remove banNo13
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=unban] run tag @e[tag=random,x=1548,y=155,z=406,distance=..1,scores={rNumber=13}] remove capsuleBan
