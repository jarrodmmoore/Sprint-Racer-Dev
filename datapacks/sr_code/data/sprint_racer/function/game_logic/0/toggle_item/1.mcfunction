tag @e[tag=w,tag=banNo1] add unban


tag @e[tag=w,tag=!unban] add banNo1
execute if entity @e[tag=w,tag=!unban] run tag @e[tag=random,scores={rNumber=1}] add capsuleBan
...
tag @e[tag=w,tag=unban] remove banNo1
execute if entity @e[tag=w,tag=unban] run tag @e[tag=random,scores={rNumber=1}] remove capsuleBan
