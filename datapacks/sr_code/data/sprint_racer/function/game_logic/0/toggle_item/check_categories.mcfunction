...
execute if entity @e[tag=w,type=armor_stand,tag=!banRedItem] run scoreboard players set #catRed value 1
scoreboard players set #catYel value 0
execute if entity @e[tag=w,type=armor_stand,tag=!banYelItem] run scoreboard players set #catYel value 1
scoreboard players set #catBlu value 0
execute if entity @e[tag=w,type=armor_stand,tag=!banBluItem] run scoreboard players set #catBlu value 1
scoreboard players set #catGre value 0
execute if entity @e[tag=w,type=armor_stand,tag=!banGreItem] run scoreboard players set #catGre value 1
scoreboard players set #catPur value 0
execute if entity @e[tag=w,type=armor_stand,tag=!banPurItem] run scoreboard players set #catPur value 1
