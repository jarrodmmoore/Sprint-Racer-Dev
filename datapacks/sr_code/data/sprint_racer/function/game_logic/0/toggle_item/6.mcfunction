execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=!banNo6,tag=!banEnchant6] run return \
    run function sprint_racer:game_logic/0/toggle_item/enchant_ban {item:"6",category:"yellow"}
#=====

tag @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=banNo6] add unban
tag @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=banNo6] remove banEnchant6


tag @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=!unban] add banNo6
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=!unban] run tag @e[tag=random,x=1548,y=155,z=406,distance=..1,scores={rNumber=6}] add capsuleBan
...
tag @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=unban] remove banNo6
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=unban] run tag @e[tag=random,x=1548,y=155,z=406,distance=..1,scores={rNumber=6}] remove capsuleBan
