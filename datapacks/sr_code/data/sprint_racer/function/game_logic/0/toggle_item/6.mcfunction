tag @e[tag=w,tag=banNo6] add unban


tag @e[tag=w,tag=!unban] add banNo6
execute if entity @e[tag=w,tag=!unban] run tag @e[tag=random,scores={rNumber=6}] add capsuleBan
...
tag @e[tag=w,tag=unban] remove banNo6
execute if entity @e[tag=w,tag=unban] run tag @e[tag=random,scores={rNumber=6}] remove capsuleBan
