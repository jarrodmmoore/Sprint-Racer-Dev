tag @e[tag=w,tag=banNo9] add unban


tag @e[tag=w,tag=!unban] add banNo9
execute if entity @e[tag=w,tag=!unban] run tag @e[tag=random,scores={rNumber=9}] add capsuleBan
...
tag @e[tag=w,tag=unban] remove banNo9
execute if entity @e[tag=w,tag=unban] run tag @e[tag=random,scores={rNumber=9}] remove capsuleBan
