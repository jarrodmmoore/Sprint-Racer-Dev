tag @e[tag=w,tag=banNo15] add unban


tag @e[tag=w,tag=!unban] add banNo15
execute if entity @e[tag=w,tag=!unban] run tag @e[tag=random,scores={rNumber=15}] add capsuleBan
...
tag @e[tag=w,tag=unban] remove banNo15
execute if entity @e[tag=w,tag=unban] run tag @e[tag=random,scores={rNumber=15}] remove capsuleBan
