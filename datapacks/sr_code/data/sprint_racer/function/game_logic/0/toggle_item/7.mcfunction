tag @e[tag=w,tag=banNo7] add unban


tag @e[tag=w,tag=!unban] add banNo7
execute if entity @e[tag=w,tag=!unban] run tag @e[tag=random,scores={rNumber=7}] add capsuleBan
...
tag @e[tag=w,tag=unban] remove banNo7
execute if entity @e[tag=w,tag=unban] run tag @e[tag=random,scores={rNumber=7}] remove capsuleBan
