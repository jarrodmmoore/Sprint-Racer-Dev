tag @e[tag=w,tag=banNo19] add unban


tag @e[tag=w,tag=!unban] add banNo19
execute if entity @e[tag=w,tag=!unban] run tag @e[tag=random,scores={rNumber=19}] add capsuleBan
...
tag @e[tag=w,tag=unban] remove banNo19
execute if entity @e[tag=w,tag=unban] run tag @e[tag=random,scores={rNumber=19}] remove capsuleBan
