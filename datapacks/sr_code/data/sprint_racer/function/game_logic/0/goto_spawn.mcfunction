...
execute unless score #specialCredits value matches 1.. positioned 1556 89 406 rotated 90 0 run function sprint_racer:varied_teleport
execute if score #specialCredits value matches 1.. positioned 1556 89 406 rotated 90 -15 run function sprint_racer:varied_teleport
