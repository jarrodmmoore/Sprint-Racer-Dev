...
execute as @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,limit=1] positioned 1627 67 460 run function sprint_racer:game_logic/0/save_state/load_block_state
