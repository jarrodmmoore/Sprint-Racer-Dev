...
scoreboard players set @e[tag=cheats,x=1548,y=148,z=422,distance=..1] aiHasItem1 8
tellraw @a[x=1574,y=97,z=438,dx=20,dy=14,dz=13,gamemode=adventure] ["",{"text":"8","bold":true}]
