...
execute if entity @s[tag=optCustomRounds] run scoreboard players set global value 4
...
execute if block 1618 ~ 460 light_blue_wool run scoreboard players set global value 4
