...
function sprint_racer_language:_dlc_5/lobby/cheat_room/cheat_found/cars
tellraw @a ["",{"text":" "}]

#stuff
tag @e[tag=cheats,x=1550,y=148,z=406,distance=..1] add foundacheat
tag @e[tag=cheats,x=1550,y=148,z=406,distance=..1] add 58

#set display
scoreboard players set @e[tag=cheats,x=1550,y=148,z=406,distance=..1] aiHoldingItem 58
