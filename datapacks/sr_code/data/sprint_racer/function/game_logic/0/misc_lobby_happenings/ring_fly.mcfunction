...
execute if score #lobby_ring value matches 6 positioned 1636 88 332 run summon minecraft:armor_stand ~ ~-1.4 ~ {Tags:["cheategg","lobbyprop"],NoGravity:1b,Invulnerable:1b,Invisible:1b,NoBasePlate:1b,DisabledSlots:4144959,equipment:{head:{id:"minecraft:dragon_egg",count:1}},CustomName:{text:"SKYSCAPERS",bold:true,italic:false}}