...
function sprint_racer_language:_dlc_1/lobby/cheat_room/cheat_found/punishment
tellraw @a ["",{"text":" "}]

#stuff
tag @e[tag=cheats,x=1550,y=148,z=406,distance=..1] add foundacheat
tag @e[tag=cheats,x=1550,y=148,z=406,distance=..1] add 22

#set display
scoreboard players set @e[tag=cheats,x=1550,y=148,z=406,distance=..1] aiHoldingItem 22
