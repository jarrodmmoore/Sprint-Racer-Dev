...
function sprint_racer_language:_dlc_4/lobby/cheat_room/cheat_found/customai
tellraw @a ["",{"text":" "}]

#stuff
tag @e[tag=cheats,x=1548,y=148,z=422,distance=..1] add foundacheat
tag @e[tag=cheats,x=1548,y=148,z=422,distance=..1] add 54

#set display
scoreboard players set @e[tag=cheats,x=1548,y=148,z=422,distance=..1] aiHoldingItem 54
