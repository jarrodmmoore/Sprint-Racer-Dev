...
execute as @a[x=1623,y=81,z=371,dx=0,dy=2,dz=0] as @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] at @s run schedule function sprint_racer:game_logic/6/_initialize 1t
execute as @a[x=1627,y=81,z=371,dx=0,dy=2,dz=0] as @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] at @s run schedule function sprint_racer:game_logic/5/_initialize 1t
execute unless entity @s[tag=realms] as @a[x=1623,y=81,z=360,dx=0,dy=2,dz=0] as @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] at @s run schedule function sprint_racer:game_logic/10/_initialize_def 1t
execute as @a[x=1627,y=81,z=360,dx=0,dy=2,dz=0] as @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] at @s run schedule function sprint_racer:game_logic/9/_initialize 1t
execute as @a[x=1619,y=81,z=360,dx=0,dy=2,dz=0] as @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] at @s run schedule function sprint_racer:game_logic/11/_initialize 1t
