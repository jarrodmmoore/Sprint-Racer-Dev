...
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=requireAdmin,tag=anyPlayerLoadsSave] run scoreboard players set @a[x=1605,y=88,z=455,dx=10,dy=5,dz=7,gamemode=adventure,tag=!admin,scores={actionbarState=..2}] actionbarState2 5
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=requireAdmin,tag=anyPlayerLoadsSave] run scoreboard players set @a[x=1605,y=88,z=455,dx=10,dy=5,dz=7,gamemode=adventure,tag=!admin,scores={actionbarState=..2}] actionbarState -50