tag @e[tag=activeplayer,dx=9,dy=9,dz=9] add checkTarget
...
execute as @a[tag=checkTarget,tag=checkWarn,gamemode=adventure] run scoreboard players set @s[scores={actionbarState=..8}] actionbarState 8
execute as @a[tag=checkTarget,tag=checkWarn,gamemode=adventure] run scoreboard players set @s[scores={actionbarState=..8}] actionbarState2 40
