...
tag @e[tag=w,type=armor_stand,tag=return2lobby,tag=!optItems] add taNoItems
tag @e[tag=w,type=armor_stand,tag=return2lobby,tag=optItems] remove taNoItems
tag @e[tag=w,type=armor_stand,tag=return2lobby,tag=optItemsB] remove taNoItems

tag @e[tag=w,type=armor_stand] remove taValidFinish
...
tag @e[tag=w,type=armor_stand,tag=autotick] add halftick
...
scoreboard players set @e[tag=w,type=armor_stand] gameState 8
scoreboard players set @e[tag=w,type=armor_stand] gameTime 80
...
#special stuff?
execute as @e[tag=playing] at @s run function sprint_racer:game_logic/7/self_scoreboard_setup
kill @e[type=item,nbt={Item:{components:{"minecraft:custom_data":{item:1b}}}}]
scoreboard players set @e[tag=targetStay] lifespan 2
scoreboard players set @e[tag=targetVisual] lifespan 2
...
execute unless entity @e[tag=w,type=armor_stand,tag=initFailed] run effect give @a blindness 1 1 true
...
execute unless entity @e[tag=w,type=armor_stand,tag=initFailed] run gamemode adventure @a[tag=playing]
execute unless entity @e[tag=w,type=armor_stand,tag=initFailed] run gamemode spectator @a[tag=!playing]
...
execute if entity @e[tag=w,type=armor_stand,tag=initFailed] run function sprint_racer:game_logic/6/_initialize