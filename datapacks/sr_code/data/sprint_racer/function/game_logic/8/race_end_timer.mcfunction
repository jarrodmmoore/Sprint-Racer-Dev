...
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,scores={timeRemaining=201..}] run bossbar set minecraft:timeremaining color white
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,scores={timeRemaining=..200}] run bossbar set minecraft:timeremaining color red
