...
execute as @e[tag=missile,type=armor_stand] at @s positioned ~ ~1 ~ if entity @e[tag=taTargetCore,type=magma_cube,distance=..2] at @s run function sprint_racer:items/item_tick/missile_explode_target
