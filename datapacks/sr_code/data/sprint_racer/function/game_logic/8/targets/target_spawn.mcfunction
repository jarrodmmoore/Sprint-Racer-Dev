...
execute if entity @s[tag=targetImpossible] if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=taNoItems] run tag @e[tag=setme,type=magma_cube] add target_silent
execute if entity @s[tag=targetImpossible] if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=taNoItems] run tag @e[tag=setme,type=magma_cube] add targetHit
