...
#execute unless entity @e[tag=cheats,tag=20a] run kill @s[tag=!ai,scores={hp=1..,recDirection=10,boundaryTimer=..0}]
...
execute if entity @s[tag=!ai,scores={hp=1..,recDirection=12}] unless entity @e[tag=cheats,tag=20a] run function sprint_racer:game_logic/3/boundaries_kill
