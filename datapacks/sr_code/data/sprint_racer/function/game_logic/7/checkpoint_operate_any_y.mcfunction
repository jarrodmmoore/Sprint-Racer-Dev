...
execute as @a[tag=checkTarget,tag=skip_available,scores={nCheck=2}] if entity @e[type=armor_stand,tag=50a,tag=cheats,x=1548,y=148,z=422,distance=..1] at @s run function sprint_racer:cheats/skip_checkpoint
