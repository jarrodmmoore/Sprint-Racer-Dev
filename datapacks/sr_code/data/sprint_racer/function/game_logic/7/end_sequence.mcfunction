...
execute if entity @s[tag=taValidFinish,scores={gameTime=100040}] run function sprint_racer:game_logic/7/medal_award/setup
...
#did we get medals?
execute if entity @s[tag=taValidFinish,scores={gameTime=100060}] run function sprint_racer:game_logic/7/medal_award/bronze
execute if entity @s[tag=taValidFinish,scores={gameTime=100080}] run function sprint_racer:game_logic/7/medal_award/silver
execute if entity @s[tag=taValidFinish,scores={gameTime=100100}] run function sprint_racer:game_logic/7/medal_award/gold
execute if entity @s[tag=taValidFinish,scores={gameTime=100120}] run function sprint_racer:game_logic/7/medal_award/diamond
...
#go back to lobby
execute if entity @s[tag=return2lobby,scores={gameTime=100160..}] run tag @s[tag=optChoose,tag=!grandprix] add skiptochoose
