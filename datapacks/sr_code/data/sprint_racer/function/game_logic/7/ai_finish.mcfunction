execute if entity @s[tag=ai1] run tag @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1,scores={rNumber=1}] add AIdaddy
execute if entity @s[tag=ai2] run tag @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1,scores={rNumber=2}] add AIdaddy
execute if entity @s[tag=ai3] run tag @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1,scores={rNumber=3}] add AIdaddy
execute if entity @s[tag=ai4] run tag @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1,scores={rNumber=4}] add AIdaddy
execute if entity @s[tag=ai5] run tag @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1,scores={rNumber=5}] add AIdaddy
execute if entity @s[tag=ai6] run tag @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1,scores={rNumber=6}] add AIdaddy
execute if entity @s[tag=ai7] run tag @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1,scores={rNumber=7}] add AIdaddy
execute if entity @s[tag=ai8] run tag @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1,scores={rNumber=8}] add AIdaddy
execute if entity @s[tag=ai9] run tag @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1,scores={rNumber=9}] add AIdaddy
...
scoreboard players operation @e[tag=AIdaddy,x=1548,y=155,z=406,distance=..1,type=armor_stand] finishPos = @e[tag=w,x=1560,y=150,z=406,distance=..1,limit=1] finishPos
scoreboard players add @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] finishPos 1
...
scoreboard players operation @e[tag=AIdaddy,x=1548,y=155,z=406,distance=..1,type=armor_stand] addPoints = @e[tag=w,x=1560,y=150,z=406,distance=..1,limit=1] addPoints
scoreboard players set @e[tag=AIdaddy,x=1548,y=155,z=406,distance=..1,type=armor_stand,scores={addPoints=..0}] addPoints 1
scoreboard players remove @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] addPoints 1
...
execute as @e[tag=AIdaddy,x=1548,y=155,z=406,distance=..1,type=armor_stand] run function sprint_racer_language:gameplay/position_display/ai_sidebar_finish_color
