...
execute if entity @e[tag=w,tag=initFailed] run tag @e[tag=w,type=armor_stand] add noskip2next
execute if entity @e[tag=w,tag=initFailed] run function sprint_racer:game_logic/6/_initialize