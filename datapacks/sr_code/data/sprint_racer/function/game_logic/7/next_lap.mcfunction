...
scoreboard players operation @s storedTimeMin = @e[limit=1,tag=w,type=armor_stand] currentTimeMin
scoreboard players operation @s storedTimeSec = @e[limit=1,tag=w,type=armor_stand] currentTimeSec
scoreboard players operation @s storedTimeMsec = @e[limit=1,tag=w,type=armor_stand] currentTimeMsec
