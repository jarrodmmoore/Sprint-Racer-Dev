...
execute if entity @s[scores={gameTime=100}] run function sprint_racer:announce_gamemode/5_time_attack_race
execute if entity @s[scores={gameTime=50}] run gamemode adventure @a[tag=playing,tag=!spectate]
execute if entity @s[scores={gameTime=50}] as @a[tag=playing] at @s run function sprint_racer:game_logic/7/self_scoreboard_setup
