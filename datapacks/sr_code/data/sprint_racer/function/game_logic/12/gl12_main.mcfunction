...
execute if entity @s[scores={gameTime=200..}] run function sprint_racer:game_logic/12/end_game_logic

#credits sequence
execute if entity @s[scores={creditsSeq1=0..}] run function sprint_racer:game_logic/12/credits_main
...
scoreboard players remove @e[tag=node,tag=itemchest,type=marker,scores={nodeState=1..,itemBlockState=19..}] itemBlockState 12

#starting countdown
execute if entity @s[scores={gameTime=..240}] run function sprint_racer:game_logic/12/start_countdown
...
execute as @e[tag=checkpoint,type=marker,tag=node,scores={nodeState=1..}] at @s positioned ~-5 -64 ~-5 if entity @e[tag=activeplayer,dx=9,dy=300,dz=9] run function sprint_racer:game_logic/1/checkpoint_operate_any_y
execute as @e[tag=finishline,type=marker,tag=node,scores={nodeState=1..}] at @s positioned ~-5 -64 ~-5 if entity @e[tag=activeplayer,dx=9,dy=300,dz=9] run function sprint_racer:game_logic/1/finishline_operate_any_y
