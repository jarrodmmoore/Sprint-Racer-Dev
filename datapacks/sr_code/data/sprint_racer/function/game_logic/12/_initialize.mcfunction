...
tag @e[tag=random,type=armor_stand,scores={rNumber=1}] add chosenTrack
...
scoreboard players set @e[tag=w,type=armor_stand] playerCountB -999
...
scoreboard players set @e[tag=w,type=armor_stand] lap 5
scoreboard players set @e[tag=w,type=armor_stand] check 3
scoreboard players set @e[tag=w,type=armor_stand] timeRemaining 10009
...
execute unless entity @e[tag=w,type=armor_stand,tag=initFailed] unless entity @e[tag=w,type=armor_stand,tag=customTesting] run scoreboard players set @e[tag=w,type=armor_stand] gameState 12