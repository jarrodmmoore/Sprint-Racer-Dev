...
execute if entity @s[scores={gameTime=49..50}] if entity @e[type=armor_stand,tag=cheats,x=1548,y=148,z=422,distance=..1,tag=45a] as @a[tag=playing] at @s run gamemode adventure @s
