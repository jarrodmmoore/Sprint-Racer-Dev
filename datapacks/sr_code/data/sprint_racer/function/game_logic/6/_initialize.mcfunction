...
tag @e[tag=w,type=armor_stand] add timeattack

function sprint_racer:ai/general/ai_stop_all
execute if entity @e[tag=w,type=armor_stand,tag=autotick] run tag @e[tag=w,type=armor_stand] remove halftick
...
execute unless entity @e[tag=w,type=armor_stand,tag=noTAmessage] if entity @e[tag=w,type=armor_stand,tag=optNoItems] run tag @e[tag=w,type=armor_stand] add taNoItems
execute unless entity @e[tag=w,type=armor_stand,tag=noTAmessage] unless entity @e[tag=w,type=armor_stand,tag=optNoItems] run tag @e[tag=w,type=armor_stand] remove taNoItems
execute unless entity @e[tag=w,type=armor_stand,tag=noTAmessage] run function sprint_racer_language:_dlc_1/gameplay/time_attack_enabled
execute unless entity @e[tag=w,type=armor_stand,tag=noTAmessage] run scoreboard objectives remove taLastChosen
execute unless entity @e[tag=w,type=armor_stand,tag=noTAmessage] run scoreboard objectives add taLastChosen dummy
function sprint_racer_language:_dlc_1/gameplay/time_attack_sidebar
tag @e[tag=noTAmessage] remove noTAmessage

gamemode adventure @a

scoreboard players set @e[tag=w,type=armor_stand] gameState 6
