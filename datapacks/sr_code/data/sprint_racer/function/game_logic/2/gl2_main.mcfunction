...
execute if entity @s[tag=executor] if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,limit=1,tag=!halftick,scores={oTimerGlobal=1}] as @e[tag=node,distance=..35,limit=40,sort=nearest] at @s run function sprint_racer:game_logic/2/node_nametag
execute if entity @s[tag=executor] if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,limit=1,tag=halftick] as @e[tag=node,distance=..35,limit=40,sort=nearest] at @s run function sprint_racer:game_logic/2/node_nametag
