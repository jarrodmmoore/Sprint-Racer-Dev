summon marker ~ ~ ~ {CustomNameVisible:1b,NoGravity:1b,Invulnerable:1b,Tags:["refreshcloud","setup","node","teleporter","showing"],Age:-2147483648,custom_particle:{type:"block",block_state:{id:"air"}},Duration:-1,WaitTime:-2147483648}
