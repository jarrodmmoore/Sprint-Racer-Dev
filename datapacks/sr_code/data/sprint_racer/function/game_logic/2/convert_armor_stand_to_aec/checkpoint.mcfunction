summon marker ~ ~ ~ {CustomNameVisible:1b,NoGravity:1b,Invulnerable:1b,Tags:["refreshcloud","setup","node","checkpoint","showing","visualBound","showDispenser"],Age:-2147483648,Particle:{type:"block",block_state:{Name:"air"}},Duration:-1,WaitTime:-2147483648}
