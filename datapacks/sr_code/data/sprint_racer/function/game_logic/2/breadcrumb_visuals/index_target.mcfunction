...
execute unless entity @e[tag=AIBC,type=marker,distance=..100,tag=go_here] run kill @s
execute if entity @e[tag=AIBC,type=marker,distance=..2,tag=go_here] run kill @s
