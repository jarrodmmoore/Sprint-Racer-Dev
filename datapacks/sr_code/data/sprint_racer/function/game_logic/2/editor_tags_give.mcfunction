...
execute if score global gameState matches 10 if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={tvPoolMode=2}] run tag @s add itemBattle
...
execute if score global gameState matches 10 if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={tvPoolMode=2}] run tag @s add psBattle
