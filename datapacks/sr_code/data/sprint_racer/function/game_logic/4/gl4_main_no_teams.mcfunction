...
execute if entity @s[scores={gameTime=99}] as @e[tag=random,type=armor_stand,scores={rNumber=1..9}] run function sprint_racer:game_logic/4/check_for_ai_placements
