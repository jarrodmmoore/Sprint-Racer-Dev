#end grand prix here
scoreboard players set @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=grandprix] gpRound 1
execute if entity @s[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=grandprix,tag=!grandprixloop] run scoreboard players set grandprix gameState 0

execute if entity @s[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=grandprix,tag=!grandprixloop] run setblock 1615 81 369 stone_button[facing=north]
execute if entity @s[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=grandprix,tag=!grandprixloop] run setblock 1611 81 369 stone_button[facing=north]

tag @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=grandprix,tag=!grandprixloop] remove grandprix
