...
execute if entity @e[tag=focusT,tag=btBlacklist] run tag @e[tag=w,type=armor_stand] add focusTrackBan
execute unless entity @e[tag=focusT,tag=btBlacklist] run tag @e[tag=w,type=armor_stand] remove focusTrackBan