...
execute if entity @e[tag=w,type=armor_stand,tag=realms,scores={tvPoolNum=46,tvPoolMode=1}] run scoreboard players remove @e[tag=w,type=armor_stand] tvPoolNum 1
