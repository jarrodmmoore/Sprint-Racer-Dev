...
execute if entity @e[tag=w,type=armor_stand,scores={tvPoolNum=50,tvPoolMode=1}] unless entity @e[type=armor_stand,tag=cheats,tag=38] run scoreboard players remove @e[tag=w,type=armor_stand] tvPoolNum 1
