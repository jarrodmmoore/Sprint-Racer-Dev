...
#execute if score #secret_track_r value matches 1 run scoreboard players set @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={tvPoolMode=1}] tvPoolNum 50
...
#execute if score #secret_track_b value matches 1 run scoreboard players set @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={tvPoolMode=2}] tvPoolNum 50
