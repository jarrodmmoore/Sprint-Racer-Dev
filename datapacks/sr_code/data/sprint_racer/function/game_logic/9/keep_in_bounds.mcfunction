#race
scoreboard players set @e[tag=w,scores={tvPoolMode=1,tvPoolNum=50..}] tvPoolNum 1
scoreboard players set @e[tag=w,scores={tvPoolMode=1,tvPoolNum=..0}] tvPoolNum 49
...
#battle
scoreboard players set @e[tag=w,scores={tvPoolMode=2,tvPoolNum=18..}] tvPoolNum 1
scoreboard players set @e[tag=w,scores={tvPoolMode=2,tvPoolNum=..0}] tvPoolNum 17
