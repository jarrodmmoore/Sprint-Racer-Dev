...
execute if entity @e[limit=1,tag=39,type=armor_stand,tag=cheats,x=1550,y=148,z=406,distance=..1] positioned 1583 68 447 run summon minecraft:armor_stand ~ ~-1.4 ~ {Tags:["cheategg","lobbyprop"],NoGravity:1b,Invulnerable:1b,Invisible:1b,NoBasePlate:1b,DisabledSlots:4144959,ArmorItems:[{},{},{},{id:"minecraft:dragon_egg",count:1}],CustomNameVisible:0,CustomName:'{"text":"CUSTOMLAPS","bold":true,"italic":false}'}
