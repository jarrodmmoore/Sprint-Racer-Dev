...
tag @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand] add eraseTrack
...
execute unless entity @s[tag=nope_avi] run scoreboard players remove @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand] gpNumber 1
