...
tag @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] add eraseTrack

execute unless entity @e[tag=w,x=1560,y=150,z=406,distance=..1,scores={gpNumber=1..}] run tag @s add nope_avi

execute unless entity @s[tag=nope_avi] run scoreboard players add @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] gpNumber 0
...
execute unless entity @s[tag=nope_avi] as @e[tag=w,x=1560,y=150,z=406,distance=..1,limit=1,type=armor_stand] run function sprint_racer:game_logic/11/remove_track
execute unless entity @s[tag=nope_avi] run scoreboard players remove @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] gpNumber 1
