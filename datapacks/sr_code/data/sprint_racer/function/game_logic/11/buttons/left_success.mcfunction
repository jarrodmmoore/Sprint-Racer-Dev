scoreboard players remove @e[tag=w,type=armor_stand] gpRound 1
...
scoreboard players operation @e[type=item_frame,tag=gpFrame,scores={aiEntity=2}] gpNumber = @e[tag=w,limit=1,type=armor_stand] gpRound
scoreboard players operation @e[type=item_frame,tag=gpFrame,scores={aiEntity=2}] gpNumber -= @e[tag=w,limit=1,type=armor_stand] math2
