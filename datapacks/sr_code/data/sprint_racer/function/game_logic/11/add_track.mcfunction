...
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gpNumber=50..}] run tag @s add nope_avi
...
#tag!
scoreboard players operation #wgpNumber value = @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,limit=1] gpNumber
