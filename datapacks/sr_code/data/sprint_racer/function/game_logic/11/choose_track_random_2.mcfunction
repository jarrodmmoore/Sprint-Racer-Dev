...
tag @e[tag=w,type=armor_stand] add randomTrack

execute if entity @e[tag=w,scores={gpNumber=50..}] run tag @s add nope_avi
...
execute unless entity @s[tag=nope_avi] run function sprint_racer_language:_dlc_3/grand_prix/add_random_2
