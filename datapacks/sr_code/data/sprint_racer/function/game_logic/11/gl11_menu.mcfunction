...
execute unless entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,limit=1,tag=requireAdmin] run gamemode adventure @a
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,limit=1,tag=requireAdmin] run gamemode adventure @a[tag=admin]
...
execute if entity @e[limit=1,type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gpNumber=1..}] as @a[gamemode=!creative,tag=!hasLectern] run function sprint_racer_language:_dlc_3/grand_prix/give_lectern
execute if entity @e[limit=1,type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gpNumber=..0}] run clear @a[gamemode=!creative,tag=hasLectern] lectern[custom_data~{gpSettings:1b}]
