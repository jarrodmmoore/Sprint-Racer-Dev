...
tag @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] add grandprix
scoreboard players set grandprix gameState 1

#save gamemode preset
scoreboard players operation @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=grandprix] gamePresetA_save = @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,limit=1] gamemodePresetA
scoreboard players operation @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=grandprix] gamePresetB_save = @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,limit=1] gamemodePresetB
