...
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gameTime=200..}] run function sprint_racer:game_logic/3/show_position/show_lives_sidebar
tag @e[tag=displayViable] remove displayViable