execute if entity @s[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1] run scoreboard players operation #getPlayer value = @s playerID
execute if entity @s[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1] as @e[tag=ai] if score @s playerID = #getPlayer value run tag @s add show1UP
...
execute if entity @s[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1] as @e[tag=show1UP] at @s as @e[tag=setscore,distance=..4] run function sprint_racer:damage_logic/damage_number_entity_slow
...
execute if entity @s[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1] as @e[tag=show1UP] at @s run playsound minecraft:entity.player.levelup master @a ~ ~ ~ 1.75 0.75
execute if entity @s[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1] as @e[tag=show1UP] at @s run particle heart ~ ~1 ~ 1 1 1 0 20 force
...
#clean up tags
execute if entity @s[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1] run tag @e[tag=show1UP] remove show1UP