...
execute if entity @s[scores={gameTime=100000}] run scoreboard players set @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1,tag=!aiDisable] finishPos 1
execute if entity @s[scores={gameTime=100000}] run function sprint_racer:music/global/stop_music
execute if entity @s[scores={gameTime=100000}] as @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1,tag=!aiDisable] run function sprint_racer:game_logic/3/elimination/ai_survived
...
execute if entity @s[scores={gameTime=100120}] as @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1] run scoreboard players operation @s battlePos = @s finishPos
