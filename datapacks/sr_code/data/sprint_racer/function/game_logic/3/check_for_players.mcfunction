...
execute as @e[tag=testForPlayers,limit=1] if entity @e[tag=activeplayer,tag=!testForPlayers] run scoreboard players set @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,limit=1] timeOut 0
