...
#no traps teams mode
execute if entity @s[tag=!teamplay,scores={nodeTimeCycle=1,math=1..4}] as @e[tag=node,sort=random,limit=1] at @s run summon chicken ~ ~ ~ {Tags:["chickenmine","cmineset","trap"],attributes:[{id:"generic.movement_speed",base:0}]}
execute if entity @s[tag=!teamplay,scores={nodeTimeCycle=1,math=5..6}] as @e[tag=node,sort=random,limit=1] at @s run summon chicken ~ ~ ~ {Tags:["chickenmine","cmineset","hyper","trap"],attributes:[{id:"generic.movement_speed",base:0}]}
...
execute if entity @s[tag=!teamplay,tag=halftick,scores={nodeTimeCycle=1,math=1..4}] as @e[tag=node,sort=random,limit=1] at @s run summon chicken ~ ~ ~ {Tags:["chickenmine","cmineset","trap"],attributes:[{id:"generic.movement_speed",base:0}]}
execute if entity @s[tag=!teamplay,tag=halftick,scores={nodeTimeCycle=1,math=5..6}] as @e[tag=node,sort=random,limit=1] at @s run summon chicken ~ ~ ~ {Tags:["chickenmine","cmineset","hyper","trap"],attributes:[{id:"generic.movement_speed",base:0}]}
