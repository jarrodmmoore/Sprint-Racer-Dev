...
execute if entity @s[scores={timeRemaining=..-1400}] run scoreboard players set @e[limit=1,sort=random,type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1,tag=!aiDisable] playerLives 0