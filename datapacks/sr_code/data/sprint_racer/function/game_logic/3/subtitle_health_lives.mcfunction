...
execute if entity @s[tag=!eliminated,tag=!miniHUD,scores={subtitleDelay=..0,heartRate=..100}] run function sprint_racer:game_logic/3/subtitle_health_lives_bright
execute if entity @s[tag=!eliminated,tag=!miniHUD,scores={subtitleDelay=..0,heartRate=101..}] run function sprint_racer:game_logic/3/subtitle_health_lives_dark

#miniHUD: show nothing
execute if entity @s[tag=miniHUD,scores={subtitleDelay=..0}] run title @s subtitle [""]

execute if entity @s[tag=eliminated,scores={subtitleDelay=..0}] run title @s subtitle [""]
