...
execute as @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1] if score @s KOs >= @s KOgoal at @s run function sprint_racer:game_logic/3/elimination/1up
