...
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,scores={math=1..}] run scoreboard players operation @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] optBAIcount -= @e[tag=w,x=1560,y=150,z=406,distance=..1,limit=1] math
