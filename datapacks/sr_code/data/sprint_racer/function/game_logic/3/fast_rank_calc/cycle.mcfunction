...
execute as @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1,tag=!gotRank] run function sprint_racer:game_logic/3/fast_rank_calc/player_check
...
execute as @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1,tag=!gotRank] if score @s KOs >= #bestKOcount value run function sprint_racer:game_logic/3/fast_rank_calc/player_get_rank
