...
scoreboard players add @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1] KOs 0
...
scoreboard players set @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1] battlePos 1

#clear tags
tag @a[tag=playing] remove gotRank
tag @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1] remove gotRank

#don't let players with negative KOs mess with calc
tag @a[tag=players,scores={KOs=..-999999}] add gotRank
tag @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1,scores={KOs=..-999999}] add gotRank
...
execute as @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1,tag=!gotRank] run scoreboard players add #untagged value 1
...
execute as @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1,scores={battlePos=1..}] run scoreboard players operation @s battPosDisplay = @s battlePos
execute as @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1,scores={battlePos=1..}] run scoreboard players operation @s itemPosition = @s battPosDisplay
