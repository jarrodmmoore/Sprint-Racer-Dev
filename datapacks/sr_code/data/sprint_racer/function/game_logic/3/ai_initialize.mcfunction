...
tag @e[tag=random,tag=eliminated,type=armor_stand] remove eliminated

tag @e[tag=random,tag=aiDisable,type=armor_stand] remove aiDisable
scoreboard players set @e[tag=random,type=armor_stand,scores={rNumber=1..9}] KOs 0
scoreboard players set @e[tag=random,type=armor_stand,scores={rNumber=1..9}] KOgoal 3
...
execute if entity @e[tag=w,type=armor_stand,tag=optBAIsingle,scores={playerCount=..1}] run tag @s add agogo
execute if entity @e[tag=w,type=armor_stand,tag=optBAIalways,tag=!BAIautocount] run tag @s add agogo
execute if entity @e[tag=w,type=armor_stand,tag=optBAIalways,tag=BAIautocount,scores={playerCount=..3}] run tag @s add agogo
execute if entity @e[tag=w,type=armor_stand,tag=optBAInever] run tag @s remove agogo
