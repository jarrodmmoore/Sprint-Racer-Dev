...
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,tag=optBAInever] run tag @e[tag=AImaster,type=armor_stand] remove AImaster
...
scoreboard players set @e[tag=AImaster,type=armor_stand] playerLives 3

scoreboard players set @e[tag=AImaster,type=armor_stand] KOs 0
