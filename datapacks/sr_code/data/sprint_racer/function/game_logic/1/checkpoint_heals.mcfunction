...
execute if score #dHP value matches ..-20 run summon armor_stand ~ ~1.8 ~ {CustomName:'{"text":"+20","color":"light_purple","bold":true}',CustomNameVisible:1b,Marker:1b,Invulnerable:1,Invisible:1,Tags:["setscore","floatup"]}
execute if score #dHP value matches -19 run summon armor_stand ~ ~1.8 ~ {CustomName:'{"text":"+19","color":"light_purple","bold":true}',CustomNameVisible:1b,Marker:1b,Invulnerable:1,Invisible:1,Tags:["setscore","floatup"]}
execute if score #dHP value matches -18 run summon armor_stand ~ ~1.8 ~ {CustomName:'{"text":"+18","color":"light_purple","bold":true}',CustomNameVisible:1b,Marker:1b,Invulnerable:1,Invisible:1,Tags:["setscore","floatup"]}
execute if score #dHP value matches -17 run summon armor_stand ~ ~1.8 ~ {CustomName:'{"text":"+17","color":"light_purple","bold":true}',CustomNameVisible:1b,Marker:1b,Invulnerable:1,Invisible:1,Tags:["setscore","floatup"]}
execute if score #dHP value matches -16 run summon armor_stand ~ ~1.8 ~ {CustomName:'{"text":"+16","color":"light_purple","bold":true}',CustomNameVisible:1b,Marker:1b,Invulnerable:1,Invisible:1,Tags:["setscore","floatup"]}
execute if score #dHP value matches -15 run summon armor_stand ~ ~1.8 ~ {CustomName:'{"text":"+15","color":"light_purple","bold":true}',CustomNameVisible:1b,Marker:1b,Invulnerable:1,Invisible:1,Tags:["setscore","floatup"]}
execute if score #dHP value matches -14 run summon armor_stand ~ ~1.8 ~ {CustomName:'{"text":"+14","color":"light_purple","bold":true}',CustomNameVisible:1b,Marker:1b,Invulnerable:1,Invisible:1,Tags:["setscore","floatup"]}
execute if score #dHP value matches -13 run summon armor_stand ~ ~1.8 ~ {CustomName:'{"text":"+13","color":"light_purple","bold":true}',CustomNameVisible:1b,Marker:1b,Invulnerable:1,Invisible:1,Tags:["setscore","floatup"]}
execute if score #dHP value matches -12 run summon armor_stand ~ ~1.8 ~ {CustomName:'{"text":"+12","color":"light_purple","bold":true}',CustomNameVisible:1b,Marker:1b,Invulnerable:1,Invisible:1,Tags:["setscore","floatup"]}
execute if score #dHP value matches -11 run summon armor_stand ~ ~1.8 ~ {CustomName:'{"text":"+11","color":"light_purple","bold":true}',CustomNameVisible:1b,Marker:1b,Invulnerable:1,Invisible:1,Tags:["setscore","floatup"]}
execute if score #dHP value matches -10 run summon armor_stand ~ ~1.8 ~ {CustomName:'{"text":"+10","color":"light_purple","bold":true}',CustomNameVisible:1b,Marker:1b,Invulnerable:1,Invisible:1,Tags:["setscore","floatup"]}
execute if score #dHP value matches -9 run summon armor_stand ~ ~1.8 ~ {CustomName:'{"text":"+9","color":"light_purple","bold":true}',CustomNameVisible:1b,Marker:1b,Invulnerable:1,Invisible:1,Tags:["setscore","floatup"]}
