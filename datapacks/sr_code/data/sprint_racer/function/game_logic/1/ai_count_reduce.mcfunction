...
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,scores={math=1..}] run scoreboard players operation @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand] optRAIcount -= @e[tag=w,x=1560,y=150,z=406,distance=..1,limit=1] math
