...
execute if entity @s[scores={rNumber=46}] if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=!COPPA] run function sprint_racer:levels/casino_chase/_initialize
execute if entity @s[scores={rNumber=46}] if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=COPPA] run tag @s remove chosenTrack
