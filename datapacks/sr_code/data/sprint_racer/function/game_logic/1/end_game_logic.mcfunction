execute if entity @s[scores={timeRemaining=1220}] run function sprint_racer_language:gameplay/race_end/60_sec_warning
execute if entity @s[scores={timeRemaining=620}] run function sprint_racer_language:gameplay/race_end/30_sec_warning
...
execute unless entity @a[tag=playing,scores={playerState=2}] if entity @s[scores={timeRemaining=0..1220}] run function sprint_racer:game_logic/1/race_end_timer
...
#end sequence
execute if entity @s[scores={timeRemaining=..-1}] run function sprint_racer:game_logic/1/end_sequence