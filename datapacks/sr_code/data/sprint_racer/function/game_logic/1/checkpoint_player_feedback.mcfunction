...
execute if entity @s[tag=checkIncrement] run scoreboard players operation @s storedTimeMin = @e[limit=1,type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] currentTimeMin
execute if entity @s[tag=checkIncrement] run scoreboard players operation @s storedTimeSec = @e[limit=1,type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] currentTimeSec
execute if entity @s[tag=checkIncrement] run scoreboard players operation @s storedTimeMsec = @e[limit=1,type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] currentTimeMsec
