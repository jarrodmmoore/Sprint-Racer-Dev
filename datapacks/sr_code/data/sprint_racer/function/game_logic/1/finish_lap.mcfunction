...
execute unless entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gameState=1,gamemodePresetA=2}] run function sprint_racer:game_logic/1/record_lap/_index

#more than 10 laps, tell us our lap number
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={lap=11..}] unless entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gamemodePresetA=2}] run function sprint_racer_language:_dlc_3/gameplay/show_laps_remaining
...
#get time difference
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,limit=1,tag=optBalance,tag=timeBalance] run function sprint_racer:game_logic/1/checkpoint_time_difference/_lap
