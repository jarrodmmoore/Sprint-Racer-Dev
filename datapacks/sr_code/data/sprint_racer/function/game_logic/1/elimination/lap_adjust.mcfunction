...
execute if entity @e[tag=activeplayer,scores={math=0..}] run scoreboard players add @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] lap 1

#reduce everyone's lap count by 1, including the max lap count, if nobody is on lap 1
execute unless entity @a[tag=playing,scores={lap=..1}] unless entity @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1,scores={lap=..1}] run tag @s add reduceLap
execute if entity @s[tag=reduceLap] run scoreboard players remove @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] lap 1
...
execute if entity @s[tag=reduceLap] run scoreboard players remove @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1] lap 1
