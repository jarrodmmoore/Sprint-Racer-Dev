...
#players still alive have their actionbar cleared
scoreboard players set @a[gamemode=adventure] actionbarState 9
scoreboard players set @a[gamemode=adventure] actionbarState2 10
...
execute if entity @s[scores={gameTime=100259}] run kill @e[type=ender_pearl]
