...
tag @e[tag=checkTarget,tag=!finished,scores={nCheck=1}] add checkIncrement
...
execute as @a[tag=checkTarget] at @s run function sprint_racer:game_logic/1/checkpoint_player_feedback
