...
execute unless entity @e[tag=cheats,tag=23a] if entity @e[tag=w,tag=noBots] unless entity @e[tag=w,scores={math=2..}] run function sprint_racer:game_logic/1/_switch_to_time_attack
execute if entity @e[tag=cheats,tag=23a] run function sprint_racer:game_logic/1/_switch_to_time_attack
