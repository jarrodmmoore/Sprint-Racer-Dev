...
tag @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] remove noBots
...
tag @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] remove sayit
...
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=optRAIsingle,scores={playerCount=..1}] run tag @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] add sayit
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=optRAIalways,scores={playerCount=..1}] run tag @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] add sayit
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=optRAInever] run tag @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] remove sayit

execute if entity @e[tag=cheats,x=1548,y=148,z=422,distance=..1,tag=23a] run tag @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] remove sayit
...
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=noAItrack] run tag @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] remove sayit
tag @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] remove sayit
