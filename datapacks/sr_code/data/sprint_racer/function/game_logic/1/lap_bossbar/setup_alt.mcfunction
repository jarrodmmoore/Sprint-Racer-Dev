...
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,tag=classicHUD] if score #count value matches ..32 run function sprint_racer_language:gameplay/race_lap_counter/setup_0
