...
execute if entity @s[tag=new_split] run scoreboard players operation check19 itemSplitTime = @s itemSplitTime
execute if entity @s[tag=new_split] run scoreboard players operation check19 lap = @s lap
...
execute if score @s lap < check19 lap run tag @s add lap_behind
execute if entity @s[tag=lap_behind] run scoreboard players set @s itemSplitTime 999999

#same lap, find time difference
execute if entity @s[tag=!new_split,tag=!lap_behind] run scoreboard players operation @s itemSplitTime -= check19 itemSplitTime
