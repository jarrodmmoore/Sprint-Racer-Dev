...
execute unless entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,limit=1,tag=noCharity] unless entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=banNo10] run function sprint_racer:game_logic/1/charity_item/_index
