...
scoreboard players operation @e[tag=AIdaddy,x=1548,y=155,z=406,distance=..1,type=armor_stand] finishPos = @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,limit=1] finishPos
...
scoreboard players operation @e[tag=AIdaddy,x=1548,y=155,z=406,distance=..1,type=armor_stand] addPoints = @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,limit=1] addPoints
...
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=allowAIfinish] unless entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={timeRemaining=..1500}] run scoreboard players set @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] timeRemaining 1500
...
execute unless entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=teamplay] as @e[tag=AIdaddy,x=1548,y=155,z=406,distance=..1,type=armor_stand] run function sprint_racer_language:gameplay/position_display/ai_sidebar_finish_color