...
execute unless entity @e[tag=w,x=1560,y=150,z=406,distance=..1,scores={timeRemaining=..1500}] run scoreboard players set @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] timeRemaining 1500
...
execute if score #bbPersonalize value matches 2 if score @s hudNode matches 1.. if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=!gauntletTrack] run function sprint_racer:custom_hud/_update_index_race
execute if score #bbPersonalize value matches 2 if score @s hudNode matches 1.. if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=gauntletTrack] run function sprint_racer:custom_hud/_update_index_race_gauntlet
...
#crowd reaction
execute if entity @s[scores={finishPos=1}] if score grandprix gameState matches 1 if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=!noCrowdSFX,limit=1] at @s run function sprint_racer:grand_prix/crowd_cheer_big
execute if entity @s[scores={finishPos=2..4}] if score grandprix gameState matches 1 if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=!noCrowdSFX,limit=1] at @s run function sprint_racer:grand_prix/crowd_cheer
execute if entity @s[scores={finishPos=5..,itemPosition=1}] if score grandprix gameState matches 1 if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=!noCrowdSFX,limit=1] at @s run function sprint_racer:grand_prix/crowd_claps
