...
execute unless entity @e[tag=w,scores={timeRemaining=..1500}] run scoreboard players set @e[tag=w,type=armor_stand] timeRemaining 1500
...
execute if score #bbPersonalize value matches 2 if score @s hudNode matches 1.. if entity @e[tag=w,type=armor_stand,tag=!gauntletTrack] run function sprint_racer:custom_hud/_update_index_race
execute if score #bbPersonalize value matches 2 if score @s hudNode matches 1.. if entity @e[tag=w,type=armor_stand,tag=gauntletTrack] run function sprint_racer:custom_hud/_update_index_race_gauntlet
...
#crowd reaction
execute if entity @s[scores={finishPos=1}] if score grandprix gameState matches 1 if entity @e[tag=w,type=armor_stand,tag=!noCrowdSFX,limit=1] at @s run function sprint_racer:grand_prix/crowd_cheer_big
execute if entity @s[scores={finishPos=2..4}] if score grandprix gameState matches 1 if entity @e[tag=w,type=armor_stand,tag=!noCrowdSFX,limit=1] at @s run function sprint_racer:grand_prix/crowd_cheer
execute if entity @s[scores={finishPos=5..,itemPosition=1}] if score grandprix gameState matches 1 if entity @e[tag=w,type=armor_stand,tag=!noCrowdSFX,limit=1] at @s run function sprint_racer:grand_prix/crowd_claps
...
execute unless entity @e[tag=w,tag=teamplay] run team join playerFinished @s
