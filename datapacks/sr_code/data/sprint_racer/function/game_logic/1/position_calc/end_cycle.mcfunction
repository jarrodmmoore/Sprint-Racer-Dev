...
execute if entity @e[tag=activeplayer,tag=!getgot] run scoreboard players operation @e[tag=activeplayer,tag=!getgot] racePosCalc = @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] finishPos
...
execute as @e[tag=activeplayer,scores={racePosCalc=1..}] run scoreboard players operation @s itemPosition -= @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] finishPos
...
execute as @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1,tag=!eliminated,scores={finishPos=1..4}] run scoreboard players operation @s racePosDisplay = @s finishPos
...
tag @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1,scores={racePosDisplay=1..4}] add top4
...
execute as @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1,tag=top4] run function sprint_racer:game_logic/1/position_calc/publish_positions_top_ai
tag @e[tag=top4] remove top4

tag @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] remove calcEnd
tag @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] add calcStart

#elimination mode, peg whoever's in last
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,scores={gameState=1,gamemodePresetA=2}] run function sprint_racer:game_logic/1/elimination/find_last_place_main