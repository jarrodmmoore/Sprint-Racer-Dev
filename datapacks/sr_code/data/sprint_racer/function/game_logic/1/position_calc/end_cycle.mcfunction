...
execute if entity @e[tag=activeplayer,tag=!getgot] run scoreboard players operation @e[tag=activeplayer,tag=!getgot] racePosCalc = @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand] finishPos
...
execute as @e[tag=activeplayer,scores={racePosCalc=1..}] run scoreboard players operation @s itemPosition -= @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand] finishPos
...
tag @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand] add calcStart
