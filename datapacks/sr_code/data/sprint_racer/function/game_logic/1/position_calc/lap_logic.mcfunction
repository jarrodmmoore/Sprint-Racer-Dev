...
scoreboard players operation @e[tag=w,type=armor_stand] checkCalc = @e[tag=w,limit=1] check
scoreboard players add @e[tag=w,type=armor_stand] checkCalc 1
...
scoreboard players operation @e[tag=activeplayer,tag=!finished] lapCalc -= @e[tag=w,limit=1] lapCalc
