...
scoreboard players set @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] capsuleState 1
...
execute if entity @e[tag=random,x=1548,y=155,z=406,distance=..1,type=armor_stand,tag=!specialOddBan,scores={rNumber=1..44}] run tag @e[tag=random,x=1548,y=155,z=406,distance=..1,type=armor_stand,scores={rNumber=45..50}] add specialOddBan