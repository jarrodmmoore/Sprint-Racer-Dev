scoreboard players operation @s storedTimeMin = @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,limit=1] currentTimeMin
scoreboard players operation @s storedTimeSec = @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,limit=1] currentTimeSec
scoreboard players operation @s storedTimeMsec = @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,limit=1] currentTimeMsec
