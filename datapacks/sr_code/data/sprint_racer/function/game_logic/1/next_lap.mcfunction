scoreboard players operation @s storedTimeMin = @e[tag=w,type=armor_stand,limit=1] currentTimeMin
scoreboard players operation @s storedTimeSec = @e[tag=w,type=armor_stand,limit=1] currentTimeSec
scoreboard players operation @s storedTimeMsec = @e[tag=w,type=armor_stand,limit=1] currentTimeMsec
