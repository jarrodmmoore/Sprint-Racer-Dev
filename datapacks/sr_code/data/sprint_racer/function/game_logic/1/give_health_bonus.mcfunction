execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=absorpAlways] if score global playerRequire matches ..4 run effect give @a[tag=playing] minecraft:absorption 1000000 0 true
...
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=absorpAlways] if score global playerRequire matches ..4 run tag @a[tag=playing] add absorption