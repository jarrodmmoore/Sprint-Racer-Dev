...
execute if entity @e[tag=w,type=armor_stand,tag=RAIautocount] run scoreboard players set @e[tag=w,type=armor_stand] optRAIcount 4
execute if entity @e[tag=w,type=armor_stand,tag=RAIautocount] run scoreboard players operation @e[tag=w,type=armor_stand] optRAIcount -= @e[tag=w,type=armor_stand] playerCount
...
execute if entity @s[tag=agogo] if entity @e[tag=w,type=armor_stand,scores={optRAIcount=1}] run tag @e[tag=random,type=armor_stand,scores={rNumber=1}] add AImaster
execute if entity @s[tag=agogo] if entity @e[tag=w,type=armor_stand,scores={optRAIcount=2}] run tag @e[tag=random,type=armor_stand,scores={rNumber=1..2}] add AImaster
execute if entity @s[tag=agogo] if entity @e[tag=w,type=armor_stand,scores={optRAIcount=3}] run tag @e[tag=random,type=armor_stand,scores={rNumber=1..3}] add AImaster
execute if entity @s[tag=agogo] if entity @e[tag=w,type=armor_stand,scores={optRAIcount=4}] run tag @e[tag=random,type=armor_stand,scores={rNumber=1..4}] add AImaster
execute if entity @s[tag=agogo] if entity @e[tag=w,type=armor_stand,scores={optRAIcount=5}] run tag @e[tag=random,type=armor_stand,scores={rNumber=1..5}] add AImaster
execute if entity @s[tag=agogo] if entity @e[tag=w,type=armor_stand,scores={optRAIcount=6}] run tag @e[tag=random,type=armor_stand,scores={rNumber=1..6}] add AImaster
execute if entity @s[tag=agogo] if entity @e[tag=w,type=armor_stand,scores={optRAIcount=7}] run tag @e[tag=random,type=armor_stand,scores={rNumber=1..7}] add AImaster
execute if entity @s[tag=agogo] if entity @e[tag=w,type=armor_stand,scores={optRAIcount=8}] run tag @e[tag=random,type=armor_stand,scores={rNumber=1..8}] add AImaster
execute if entity @s[tag=agogo] if entity @e[tag=w,type=armor_stand,scores={optRAIcount=9..}] run tag @e[tag=random,type=armor_stand,scores={rNumber=1..9}] add AImaster
