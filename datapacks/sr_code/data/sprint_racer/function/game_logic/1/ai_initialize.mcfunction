...
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,tag=optRAIsingle,scores={playerCount=..1}] run tag @s add agogo
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,tag=optRAIalways,tag=!RAIautocount] run tag @s add agogo
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,tag=optRAIalways,tag=RAIautocount,scores={playerCount=..3}] run tag @s add agogo
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,tag=optRAInever] run tag @s remove agogo
...
scoreboard players operation #test value = @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand] optRAIcount

#auto ai count? only add ais until we meet the desired player count
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,tag=RAIautocount] run scoreboard players operation #test value -= @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand] playerCount
...
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,tag=optRAInever] run tag @e[tag=AImaster,type=armor_stand] remove AImaster
...
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,scores={optAIdiff=-1}] as @e[tag=AImaster,type=armor_stand] run scoreboard players operation @s aiSkill = @e[limit=1,sort=random,tag=random,x=1548,y=155,z=406,distance=..1,type=armor_stand,scores={rNumber=1..3}] rNumber
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,scores={optAIdiff=0}] run scoreboard players set @e[tag=AImaster,type=armor_stand] aiSkill 0
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,scores={optAIdiff=1}] run scoreboard players set @e[tag=AImaster,type=armor_stand] aiSkill 1
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,scores={optAIdiff=2}] run scoreboard players set @e[tag=AImaster,type=armor_stand] aiSkill 2
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,scores={optAIdiff=3}] run scoreboard players set @e[tag=AImaster,type=armor_stand] aiSkill 3
...
execute if score global aiLevel matches ..0 if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,scores={optAIdiff=-1}] run scoreboard players set @e[tag=AImaster,type=armor_stand,scores={aiSkill=2..}] aiSkill 0
execute if score global aiLevel matches 1..3 if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,scores={optAIdiff=-1}] run scoreboard players set @e[tag=AImaster,type=armor_stand,scores={aiSkill=2..}] aiSkill 0
execute if score global aiLevel matches 4..6 if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,scores={optAIdiff=-1}] run scoreboard players set @e[tag=AImaster,type=armor_stand,scores={aiSkill=2..}] aiSkill 1
execute if score global aiLevel matches 7 if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,scores={optAIdiff=-1}] run scoreboard players set @e[tag=AImaster,type=armor_stand,scores={aiSkill=3..}] aiSkill 1
execute if score global aiLevel matches 8..9 if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,scores={optAIdiff=-1}] run scoreboard players set @e[tag=AImaster,type=armor_stand,scores={aiSkill=3..}] aiSkill 2
execute if score global aiLevel matches 13.. if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,scores={optAIdiff=-1}] run scoreboard players set @e[tag=AImaster,type=armor_stand,scores={rNumber=1}] aiSkill 3
...
execute as @e[tag=AImaster,type=armor_stand] run scoreboard players add @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand] addPoints 1
