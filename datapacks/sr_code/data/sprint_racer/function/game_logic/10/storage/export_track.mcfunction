...
$execute if score #success value matches 1 run tellraw @a ["",{translate:"sr.custom_track.export_success",with:[{text:"saves/.../data/$(filename)/command_storage.dat",color:"yellow"}]}]
