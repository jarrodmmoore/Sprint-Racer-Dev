...
execute if score #success value matches 0 if entity @s[type=player] run tellraw @s ["",{"translate":"sr.custom_track.import_failed_uuid","color":"red","bold":true}]
