...
#race
$execute if score #ct_version value matches 1 if score #version_created_in value matches ..10600 run function sprint_racer:game_logic/10/storage/import_track_race_lookup {filename:"$(filename)"}
$execute if score #ct_version value matches 1 if score #version_created_in value matches 10601.. run function sprint_racer:game_logic/10/storage/import_track_race_lookup {filename:"$(filename)"}

#battle
$execute if score #ct_version value matches 2 if score #version_created_in value matches ..10600 run function sprint_racer:game_logic/10/storage/import_track_battle_lookup {filename:"$(filename)"}
$execute if score #ct_version value matches 2 if score #version_created_in value matches 10601.. run function sprint_racer:game_logic/10/storage/import_track_battle_lookup {filename:"$(filename)"}