...
$execute store result storage $(filename):track_data version_created_in int 1 run scoreboard players get @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,limit=1] mapVersion
...
$execute if entity @s[tag=b_1_only] run data modify storage $(filename):track_data track_random_weight set value 2
$execute if entity @s[tag=b_rare_track] run data modify storage $(filename):track_data track_random_weight set value 1
$execute if entity @s[tag=btBlacklist] run data modify storage $(filename):track_data track_random_weight set value 0
#--track group
...
$execute if entity @s[tag=o_locatorBarOn] run data modify storage $(filename):settings_overrides locator_bar set value 1
