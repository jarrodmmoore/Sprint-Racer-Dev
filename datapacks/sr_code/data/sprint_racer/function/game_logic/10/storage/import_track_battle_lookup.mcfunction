...
$execute as @e[tag=customtrack,type=armor_stand,tag=imnew] run function sprint_racer:game_logic/10/storage/import_track_battle with storage $(filename):track_data
######
