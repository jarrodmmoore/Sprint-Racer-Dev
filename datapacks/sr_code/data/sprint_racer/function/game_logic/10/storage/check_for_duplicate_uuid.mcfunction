...
execute if score #test1 value = #UUID_check_0 value if score #test2 value = #UUID_check_1 value if score #test3 value = #UUID_check_2 value if score #test4 value = #UUID_check_3 value run scoreboard players set #success value -1