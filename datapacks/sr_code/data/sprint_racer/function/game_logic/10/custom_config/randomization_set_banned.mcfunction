...
tag @e[tag=focusT,tag=customrace] remove r_1_only
tag @e[tag=focusT,tag=custombattle] remove b_1_only
tag @e[tag=focusT,tag=customrace] remove r_rare_track
tag @e[tag=focusT,tag=custombattle] remove b_rare_track
tag @e[tag=focusT,tag=customrace] add rtBlacklist
tag @e[tag=focusT,tag=custombattle] add btBlacklist
