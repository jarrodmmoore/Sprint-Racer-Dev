...
execute if entity @s[tag=act3] run tag @e[tag=focusT] add trackIntermed
execute if entity @s[tag=act4] run tag @e[tag=focusT] add trackExpert
execute if entity @s[tag=act1] run tag @e[tag=focusT] add trackMaster
execute if entity @s[tag=act2] run tag @e[tag=focusT] add trackNovice
