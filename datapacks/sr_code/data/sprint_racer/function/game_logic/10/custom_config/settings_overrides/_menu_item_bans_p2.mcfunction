...
execute as @e[tag=focusT,type=armor_stand,limit=1] run function sprint_racer:game_logic/10/custom_config/settings_overrides/_load_bans_5_8
...
#items
tellraw @a [{nbt:"item_5",storage:"sprint_racer:custom_track_text",interpret:true}]
tellraw @a [{nbt:"item_6",storage:"sprint_racer:custom_track_text",interpret:true}]
tellraw @a [{nbt:"item_7",storage:"sprint_racer:custom_track_text",interpret:true}]
tellraw @a [{nbt:"item_8",storage:"sprint_racer:custom_track_text",interpret:true}]

#page select
tellraw @a ["",{text:"[<<]",color:"yellow",click_event:{action:"run_command",command:"/trigger tTrackEditor set 1141"},hover_event:{action:"show_text",value:[{translate:"sr.basic.previous"}]}},{text:"  "},{text:"p. 2/6",italic:true},{text:"  "},{text:"[>>]",color:"yellow",click_event:{action:"run_command",command:"/trigger tTrackEditor set 1238"},hover_event:{action:"show_text",value:[{translate:"sr.basic.next"}]}}]
