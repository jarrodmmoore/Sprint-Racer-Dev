...
execute as @e[tag=focusT,type=armor_stand,limit=1] run function sprint_racer:game_logic/10/custom_config/settings_overrides/_load_bans_1_4
...
#items
tellraw @a [{nbt:"item_1",storage:"sprint_racer:custom_track_text",interpret:true}]
tellraw @a [{nbt:"item_2",storage:"sprint_racer:custom_track_text",interpret:true}]
tellraw @a [{nbt:"item_3",storage:"sprint_racer:custom_track_text",interpret:true}]
tellraw @a [{nbt:"item_4",storage:"sprint_racer:custom_track_text",interpret:true}]

#page select
tellraw @a ["",{text:"[<<]",color:"dark_gray"},{text:"  "},{text:"p. 1/6",italic:true},{text:"  "},{text:"[>>]",color:"yellow",click_event:{action:"run_command",command:"/trigger tTrackEditor set 1237"},hover_event:{action:"show_text",value:[{translate:"sr.basic.next"}]}}]
