...
execute as @e[tag=focusT,type=armor_stand,limit=1] run function sprint_racer:game_logic/10/custom_config/settings_overrides/_load_bans_13_16
...
#items
tellraw @a [{nbt:"item_13",storage:"sprint_racer:custom_track_text",interpret:true}]
tellraw @a [{nbt:"item_14",storage:"sprint_racer:custom_track_text",interpret:true}]
tellraw @a [{nbt:"item_15",storage:"sprint_racer:custom_track_text",interpret:true}]
tellraw @a [{nbt:"item_16",storage:"sprint_racer:custom_track_text",interpret:true}]

#page select
tellraw @a ["",{text:"[<<]",color:"yellow",click_event:{action:"run_command",command:"/trigger tTrackEditor set 1238"},hover_event:{action:"show_text",value:[{translate:"sr.basic.previous"}]}},{text:"  "},{text:"p. 4/6",italic:true},{text:"  "},{text:"[>>]",color:"yellow",click_event:{action:"run_command",command:"/trigger tTrackEditor set 1240"},hover_event:{action:"show_text",value:[{translate:"sr.basic.next"}]}}]
