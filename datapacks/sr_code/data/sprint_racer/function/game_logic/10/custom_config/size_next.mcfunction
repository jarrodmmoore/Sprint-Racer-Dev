...
execute if entity @e[tag=focusT,tag=trackTiny] run tag @s add act0
...
tag @e[tag=focusT] remove trackTiny
tag @e[tag=focusT] remove trackSmall
tag @e[tag=focusT] remove trackMedium
tag @e[tag=focusT] remove trackLarge

execute if entity @s[tag=act0] run tag @e[tag=focusT] add trackSmall
execute if entity @s[tag=act1] run tag @e[tag=focusT] add trackMedium
execute if entity @s[tag=act2] run tag @e[tag=focusT] add trackLarge
execute if entity @s[tag=act3] run tag @e[tag=focusT] add trackTiny
