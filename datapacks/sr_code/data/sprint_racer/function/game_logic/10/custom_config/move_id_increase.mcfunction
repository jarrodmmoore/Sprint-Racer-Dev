...
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,scores={tvPoolMode=1}] run scoreboard players add @e[tag=focusT,type=armor_stand] customTrackID 1
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,scores={tvPoolMode=2}] run scoreboard players add @e[tag=focusT,type=armor_stand] customTrackBID 1

#scoot over the other track that's in our way
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,scores={tvPoolMode=1}] as @e[type=armor_stand,tag=customrace,tag=!focusT] if score @s customTrackID = @e[limit=1,type=armor_stand,tag=focusT] customTrackID run scoreboard players remove @s customTrackID 1
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,scores={tvPoolMode=2}] as @e[type=armor_stand,tag=custombattle,tag=!focusT] if score @s customTrackBID = @e[limit=1,type=armor_stand,tag=focusT] customTrackBID run scoreboard players remove @s customTrackBID 1
