...
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gamemodePresetA=1}] run data merge block 1581 77 369 {front_text:{has_glowing_text:0b,messages:[{text:"",click_event:{action:"run_command",command:"trigger tOption set 1000"}},{text:"RACE TYPE",bold:true,color:"black"},{text:"[STANDARD]",color:"dark_blue"},{text:""}]},is_waxed:1b}
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gamemodePresetA=2}] run data merge block 1581 77 369 {front_text:{has_glowing_text:0b,messages:[{text:"",click_event:{action:"run_command",command:"trigger tOption set 1000"}},{text:"RACE TYPE",bold:true,color:"black"},{text:"[ELIMINATION]",color:"dark_blue"},{text:""}]},is_waxed:1b}
...
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=randomPresetA] run data merge block 1581 77 369 {front_text:{has_glowing_text:0b,messages:[{text:"",click_event:{action:"run_command",command:"trigger tOption set 1000"}},{text:"RACE TYPE",bold:true,color:"black"},{text:"[RANDOM]",color:"dark_blue"},{text:""}]},is_waxed:1b}
#battle
