scoreboard players set @e[tag=w,type=armor_stand] customDummyBID 1 
...
tag @e[tag=imnew,type=armor_stand,limit=1] add trackMedium
tag @e[tag=imnew,type=armor_stand,limit=1] add noAItrack
scoreboard players set @e[tag=imnew,type=armor_stand,limit=1] rNumber -2
...
scoreboard players set @e[tag=imnew,type=armor_stand,limit=1] customTTargets 1
...
scoreboard players set @e[tag=imnew,type=armor_stand,limit=1] medalBattle 0
...
scoreboard players operation @e[tag=w,type=armor_stand] tvPoolNum = @e[limit=1,tag=w] customDummyBID
