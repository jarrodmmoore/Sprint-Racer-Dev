...
#summon new stand
execute as @e[tag=w,type=armor_stand] at @s positioned ~ 80 ~ run summon armor_stand ~ ~ ~ {Invulnerable:1b,NoGravity:1b,Tags:["customtrack","trackStandR","rtBlacklist","imnew"]}
