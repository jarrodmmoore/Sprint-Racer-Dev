...
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,limit=1,tag=requireAdmin,scores={gameState=1..}] run function sprint_racer:game_logic/10/spectators
