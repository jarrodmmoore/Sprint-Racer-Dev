...
scoreboard players set @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] wmCustomMode 1

#IMPORTANT TAG
tag @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] add customTesting
