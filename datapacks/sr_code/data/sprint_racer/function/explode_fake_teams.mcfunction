...
execute if entity @s[tag=itemCyan] run tag @e[tag=checkmyid,tag=playerOrange] add hitMe
execute if entity @s[tag=!itemCyan] run tag @e[tag=checkmyid,tag=playerCyan] add hitMe
