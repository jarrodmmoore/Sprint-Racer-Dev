...
execute if entity @e[tag=w,scores={oTimerGlobal=1}] as @a[scores={hitstun=1..}] run xp set @s 0 points
execute if entity @e[tag=w,scores={oTimerGlobal=1}] as @a[scores={hitstun=1..}] run xp set @s 0 levels