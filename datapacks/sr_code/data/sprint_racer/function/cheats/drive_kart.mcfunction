...
execute unless entity @e[tag=cheats,tag=01a] run function sprint_racer:cheats/kart_velocity_scale_a
execute if entity @e[tag=cheats,tag=01a] run function sprint_racer:cheats/kart_velocity_scale_b
