...
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=halftick,limit=1] as @e[tag=homer] at @s run function sprint_racer:cheats/homing
