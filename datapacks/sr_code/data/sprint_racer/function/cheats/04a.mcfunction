...
execute if entity @e[tag=AImaster,type=armor_stand] unless entity @e[tag=cheats,x=1550,y=148,z=406,distance=..1,type=armor_stand,tag=35a] run scoreboard players set @e[tag=ai] itemCooldown 0
