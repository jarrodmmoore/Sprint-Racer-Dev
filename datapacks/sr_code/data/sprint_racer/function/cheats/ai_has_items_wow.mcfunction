...
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={math=1}] run scoreboard players set @e[tag=ai,limit=1,sort=random] aiHasGlobal 10