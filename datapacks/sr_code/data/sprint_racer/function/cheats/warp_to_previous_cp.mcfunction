...
execute if score #math value matches 1 run scoreboard players operation @s check += @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,limit=1] check
...
scoreboard players operation @s nCheck = @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,limit=1] check
