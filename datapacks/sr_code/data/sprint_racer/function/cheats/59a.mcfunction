...
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gameState=1,gameTime=160..99999}] run scoreboard players set #59aValid value 1
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gameState=7,gameTime=160..99999}] run scoreboard players set #59aValid value 1
