...
execute if entity @e[type=armor_stand,tag=cheats,tag=01a] run tag @e[tag=aimMe,type=armor_stand,limit=1,sort=nearest] add hurryUp
...
execute if entity @e[type=armor_stand,tag=cheats,tag=11a] as @e[tag=aimMe,limit=1,type=armor_stand,sort=nearest] run function sprint_racer:cheats/homing_entity_chance_rare
