...
execute as @a[gamemode=adventure] unless score @s kart_model matches 10.. run scoreboard players operation @s kart_model = @e[limit=1,sort=random,type=armor_stand,tag=random,scores={rNumber=11..18}] rNumber
