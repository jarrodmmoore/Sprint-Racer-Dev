...
execute if entity @e[tag=w,tag=!halftick,scores={oTimerGlobal=1}] as @e[tag=mychickenmine] at @s facing entity @e[limit=1,tag=revengineer,sort=nearest] feet run function sprint_racer:cheats/chickenmine_follow_owner
