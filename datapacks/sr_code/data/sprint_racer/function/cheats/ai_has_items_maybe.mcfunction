scoreboard players operation @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] math = @e[limit=1,sort=random,tag=random,x=1548,y=155,z=406,distance=..1,scores={rNumber=1..5}] rNumber

execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gameTime=160..}] run function sprint_racer:cheats/ai_has_items_wow
...
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={math=5}] run scoreboard players set @e[tag=ai] aiHasItem8 3

scoreboard players set @e[tag=ai] aiHasItem9 0
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={math=4}] run scoreboard players set @e[tag=ai] aiHasItem9 3

scoreboard players set @e[tag=ai] aiHasItem10 3

scoreboard players set @e[tag=ai] aiHasItem11 0
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={math=1}] run scoreboard players set @e[tag=ai] aiHasItem11 3

scoreboard players set @e[tag=ai] aiHasItem12 0
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={math=2}] run scoreboard players set @e[tag=ai] aiHasItem12 3
...
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={math=3}] run scoreboard players set @e[tag=ai] aiHasItem16 3
