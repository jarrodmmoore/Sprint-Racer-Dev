...
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=halftick,scores={gameState=1,gameTime=240..}] run scoreboard players add global touhou 1
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gameState=1,gameTime=240..}] run scoreboard players add global touhou 1
