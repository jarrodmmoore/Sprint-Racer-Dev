...
execute if entity @e[tag=w,type=armor_stand,tag=halftick,scores={gameState=1,gameTime=240..}] run scoreboard players add global touhou 1
execute if entity @e[tag=w,type=armor_stand,scores={gameState=1,gameTime=240..}] run scoreboard players add global touhou 1
