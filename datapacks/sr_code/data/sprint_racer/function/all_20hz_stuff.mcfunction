...
#20Hz lobby stuff
execute if score global gameState matches 0 as @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,limit=1] run function sprint_racer:game_logic/0/misc_lobby_happenings/20hz_stuff
