...
execute if score #catRed value matches 0 run tag @e[tag=random,scores={rNumber=1..24}] add tempBan
execute if score #catYel value matches 0 run tag @e[tag=random,scores={rNumber=25..35}] add tempBan
execute if score #catBlu value matches 0 run tag @e[tag=random,scores={rNumber=36..41}] add tempBan
...
execute if score @s lastCatPicked matches 2 if score #catTotal value matches 2.. run tag @e[tag=random,type=armor_stand,scores={rNumber=25..35}] add tempBan
execute if score @s lastCatPicked matches 3 if score #catTotal value matches 2.. run tag @e[tag=random,type=armor_stand,scores={rNumber=36..41}] add tempBan
