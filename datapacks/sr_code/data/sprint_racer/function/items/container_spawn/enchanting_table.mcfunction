summon armor_stand ~ ~-2 ~ {Tags:["itemcontainer","chest2","cSETME"],Invisible:1b,Invulnerable:1b,NoBasePlate:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"enchanting_table",count:1,components:{"minecraft:custom_model_data":1111111}}],HandItems:[{},{}],DisabledSlots:2039583}
