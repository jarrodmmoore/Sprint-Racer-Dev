summon armor_stand ~ ~-2 ~ {Tags:["itemcontainer","chest9","cSETME"],Invisible:1b,Invulnerable:1b,NoBasePlate:1b,NoGravity:1b,equipment:{head:{id:"magenta_wool",count:1,components:{"minecraft:item_model":"sr/container/pink"}}},DisabledSlots:2039583}
