summon armor_stand ~ ~-2 ~ {Tags:["itemcontainer","chest7","cSETME"],Invisible:1b,Invulnerable:1b,NoBasePlate:1b,NoGravity:1b,equipment:{head:{id:"light_blue_wool",count:1,components:{"minecraft:item_model":"sr/container/blue"}}},DisabledSlots:2039583,Passengers:[ \
    {id:"minecraft:item_display",Tags:["setChestDisplay"],item:{id:"minecraft:light_blue_wool",count:1,components:{"minecraft:item_model":"sr/container/blue"}},item_display:"head",teleport_duration:10,interpolation_duration:0} \
]}
