summon armor_stand ~ ~-2 ~ {Tags:["itemcontainer","chest6","cSETME"],Invisible:1b,Invulnerable:1b,NoBasePlate:1b,NoGravity:1b,equipment:{head:{id:"yellow_wool",count:1,components:{"minecraft:item_model":"sr/container/yellow"}}},DisabledSlots:2039583}
