...
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=banEnchant18] run return \
    run function sprint_racer:items/ai_enchant/deny_enchant {1:"scoreboard players add @s aiHasItem18 1",2:"scoreboard players add @s aiHasGlobal 1",3:"scoreboard players add @s aiHasNormal 1"}
#=====
...
execute if entity @s[scores={enchantQty=..9,aiHasItem18=1..}] run function sprint_racer:items/ai_enchant/18
