...
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=banEnchant3] run return \
    run function sprint_racer:items/ai_enchant/deny_enchant {1:"scoreboard players add @s aiHasItem3 1",2:"scoreboard players add @s aiHasProjectile 1",3:"scoreboard players add @s aiHasNormal 1"}
#=====
