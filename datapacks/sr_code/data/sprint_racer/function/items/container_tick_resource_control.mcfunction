...
execute if entity @e[tag=AImaster,type=armor_stand] unless entity @e[tag=cheats,x=1548,y=148,z=422,distance=..1,type=armor_stand,tag=35a] run scoreboard players set @e[tag=ai,scores={itemCooldown=2..}] itemCooldown 1
execute if entity @e[tag=AImaster,type=armor_stand] unless entity @e[tag=cheats,x=1548,y=148,z=422,distance=..1,type=armor_stand,tag=35a] run scoreboard players set @e[tag=ai,scores={itemCooldown2=..51}] itemCooldown2 51
