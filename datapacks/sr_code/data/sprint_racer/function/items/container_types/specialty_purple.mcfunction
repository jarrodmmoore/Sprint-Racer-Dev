tag @e[limit=1,sort=nearest,tag=itemcontainer,tag=chest9,distance=..3] add chestTarget
...
execute as @e[tag=chestTarget,distance=..3] at @s run particle block{block_state:"minecraft:magenta_wool"} ~ ~1.5 ~ .2 .2 .2 1 20
