...
#battle bat
execute if entity @s[nbt={Item:{components:{"minecraft:custom_data":{battlebat_basic:1b}}}}] run return run execute as @e[tag=capsuleCollect,distance=..5] run function sprint_racer_language:_dlc_6/gameplay/give_battle_bat
#potato
