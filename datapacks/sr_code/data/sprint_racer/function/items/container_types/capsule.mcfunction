...
execute at @e[tag=chestTarget,type=armor_stand,limit=1,sort=nearest] as @e[distance=..2,limit=1,sort=nearest,type=item,tag=capsuleItem] run function sprint_racer:items/container_types/capsule_item_collect
