...
execute as @e[tag=chestTarget] at @s run particle block{block_state:"minecraft:lime_wool"} ~ ~1.5 ~ .2 .2 .2 1 20
...
execute if entity @e[tag=cheats,x=1550,y=148,z=406,distance=..1,type=armor_stand,tag=15a] run function sprint_racer:items/pick_item/trap/_main
