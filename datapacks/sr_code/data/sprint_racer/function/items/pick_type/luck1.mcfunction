...
execute if score #catRed value matches 0 run tag @e[tag=random,type=armor_stand,scores={rNumber=1..13}] add tempBan
execute if score #catYel value matches 0 run tag @e[tag=random,type=armor_stand,scores={rNumber=14..31}] add tempBan
#execute if score #catBlu value matches 0 run tag @e[tag=random,type=armor_stand,scores={rNumber=26..30}] add tempBan
execute if score #catGre value matches 0 run tag @e[tag=random,type=armor_stand,scores={rNumber=32..50}] add tempBan
...
execute if score @s lastCatPicked matches 1 if score #catTotal value matches 4.. run tag @e[tag=random,type=armor_stand,scores={rNumber=1..13}] add tempBan
execute if score @s lastCatPicked matches 2 if score #catTotal value matches 4.. run tag @e[tag=random,type=armor_stand,scores={rNumber=14..31}] add tempBan
execute if score @s lastCatPicked matches 4 if score #catTotal value matches 4.. run tag @e[tag=random,type=armor_stand,scores={rNumber=32..50}] add tempBan
...
execute if entity @s[scores={rNumber=0}] if entity @e[tag=w,type=armor_stand,tag=banRedItem,tag=banYelItem,tag=banGreItem,tag=!banPurItem] run scoreboard players set @s rNumber 52
execute if entity @s[scores={rNumber=0}] if entity @e[tag=w,type=armor_stand,tag=banRedItem,tag=banYelItem,tag=banGreItem,tag=!banBluItem] run scoreboard players set @s rNumber 51
