...
execute if score #catBlu value matches 0 run tag @e[tag=random,type=armor_stand,scores={rNumber=9..38}] add tempBan
execute if score #catGre value matches 0 run tag @e[tag=random,type=armor_stand,scores={rNumber=39..40}] add tempBan
...
#execute if score @s lastCatPicked matches 3 if score #catTotal value matches 2.. run tag @e[tag=random,type=armor_stand,scores={rNumber=9..38}] add tempBan
execute if score @s lastCatPicked matches 4 if score #catTotal value matches 2.. run tag @e[tag=random,type=armor_stand,scores={rNumber=39..40}] add tempBan
