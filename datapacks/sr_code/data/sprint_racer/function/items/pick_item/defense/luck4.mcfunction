...
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,tag=banNo5] run tag @e[tag=random,x=1548,y=155,z=406,distance=..1,scores={rNumber=1..13}] add tempBan
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,tag=banNo6] run tag @e[tag=random,x=1548,y=155,z=406,distance=..1,scores={rNumber=14..26}] add tempBan
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,tag=banNo7] run tag @e[tag=random,x=1548,y=155,z=406,distance=..1,scores={rNumber=27..37}] add tempBan
