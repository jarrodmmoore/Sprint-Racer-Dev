...
execute if entity @e[tag=w,type=armor_stand,tag=banNo5] run tag @e[tag=random,scores={rNumber=1..16}] add tempBan
execute if entity @e[tag=w,type=armor_stand,tag=banNo6] run tag @e[tag=random,scores={rNumber=17..24}] add tempBan
execute if entity @e[tag=w,type=armor_stand,tag=banNo7] run tag @e[tag=random,scores={rNumber=25..38}] add tempBan
execute if entity @e[tag=w,type=armor_stand,tag=banNo8] run tag @e[tag=random,scores={rNumber=39..40}] add tempBan
...
execute if score #test value matches 1.. unless entity @e[tag=w,type=armor_stand,tag=banNo5,tag=banNo6,tag=banNo7] run tag @e[tag=random,scores={rNumber=39..40}] add tempBan
