...
execute if entity @e[tag=w,type=armor_stand,tag=banNo5] run tag @e[tag=random,scores={rNumber=1..11}] add tempBan
execute if entity @e[tag=w,type=armor_stand,tag=banNo6] run tag @e[tag=random,scores={rNumber=12..28}] add tempBan
execute if entity @e[tag=w,type=armor_stand,tag=banNo7] run tag @e[tag=random,scores={rNumber=29..37}] add tempBan
