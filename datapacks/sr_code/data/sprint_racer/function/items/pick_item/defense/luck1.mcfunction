...
execute if entity @e[tag=w,type=armor_stand,tag=banNo5] run tag @e[tag=random,scores={rNumber=1..19}] add tempBan
execute if entity @e[tag=w,type=armor_stand,tag=banNo6] run tag @e[tag=random,scores={rNumber=20..24}] add tempBan
execute if entity @e[tag=w,type=armor_stand,tag=banNo7] run tag @e[tag=random,scores={rNumber=25..37}] add tempBan
