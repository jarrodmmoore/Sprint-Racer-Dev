...
execute if entity @e[tag=w,tag=banNo17] run tag @e[tag=random,scores={rNumber=1..18}] add tempBan
execute if entity @e[tag=w,tag=banNo18] run tag @e[tag=random,scores={rNumber=19..33}] add tempBan
execute if entity @e[tag=w,tag=banNo19] run tag @e[tag=random,scores={rNumber=34..38}] add tempBan
execute if entity @e[tag=w,tag=banNo20] run tag @e[tag=random,scores={rNumber=39..40}] add tempBan
