...
execute if entity @e[tag=w,tag=banNo17] run tag @e[tag=random,scores={rNumber=1..14}] add tempBan
execute if entity @e[tag=w,tag=banNo18] run tag @e[tag=random,scores={rNumber=15..26}] add tempBan
execute if entity @e[tag=w,tag=banNo19] run tag @e[tag=random,scores={rNumber=27..34}] add tempBan
execute if entity @e[tag=w,tag=banNo20] run tag @e[tag=random,scores={rNumber=35..40}] add tempBan
