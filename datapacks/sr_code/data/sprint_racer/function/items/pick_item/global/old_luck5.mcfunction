...
execute if entity @e[tag=w,tag=banNo17] run tag @e[tag=random,scores={rNumber=1..2}] add tempBan
execute if entity @e[tag=w,tag=banNo18] run tag @e[tag=random,scores={rNumber=3..7}] add tempBan
execute if entity @e[tag=w,tag=banNo19] run tag @e[tag=random,scores={rNumber=8..22}] add tempBan
execute if entity @e[tag=w,tag=banNo20] run tag @e[tag=random,scores={rNumber=23..40}] add tempBan
