...
execute if entity @e[tag=w,type=armor_stand,tag=banNo13] run tag @e[tag=random,scores={rNumber=1..18}] add tempBan
execute if entity @e[tag=w,type=armor_stand,tag=banNo14] run tag @e[tag=random,scores={rNumber=19..20}] add tempBan
execute if entity @e[tag=w,type=armor_stand,tag=banNo15] run tag @e[tag=random,scores={rNumber=21..32}] add tempBan
execute if entity @e[tag=w,type=armor_stand,tag=banNo16] run tag @e[tag=random,scores={rNumber=33..40}] add tempBan
...
execute if score #test value matches 1.. unless entity @e[tag=w,type=armor_stand,tag=banNo13,tag=banNo15,tag=banNo16] run tag @e[tag=random,scores={rNumber=19..20}] add tempBan
