...
execute if entity @e[tag=w,tag=banNo13] run tag @e[tag=random,scores={rNumber=1..14}] add tempBan
execute if entity @e[tag=w,tag=banNo14] run tag @e[tag=random,scores={rNumber=15..26}] add tempBan
execute if entity @e[tag=w,tag=banNo15] run tag @e[tag=random,scores={rNumber=27..34}] add tempBan
execute if entity @e[tag=w,tag=banNo16] run tag @e[tag=random,scores={rNumber=35..40}] add tempBan
