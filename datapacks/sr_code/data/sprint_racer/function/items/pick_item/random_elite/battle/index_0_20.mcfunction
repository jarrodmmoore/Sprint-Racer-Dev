...
execute if entity @s[scores={rNumber=0}] if score global gameState matches 3 if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=!banObliterator] run function sprint_racer_language:_dlc_6/gameplay/give_obliterator {count:3}
