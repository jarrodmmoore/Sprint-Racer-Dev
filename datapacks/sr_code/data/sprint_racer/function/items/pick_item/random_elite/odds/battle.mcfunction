...
execute unless entity @e[tag=w,x=1560,y=150,z=406,distance=..1,limit=1,type=armor_stand,scores={capsuleState=6}] as @e[limit=1,type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] run function sprint_racer:items/container_spawn/capsule_category_odds/load_battle_odds_enchant
