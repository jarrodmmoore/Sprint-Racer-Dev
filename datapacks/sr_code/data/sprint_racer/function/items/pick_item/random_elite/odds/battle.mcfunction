...
execute unless entity @e[tag=w,x=1560,y=150,z=406,distance=..1,limit=1,type=armor_stand,scores={capsuleState=6}] as @e[limit=1,tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand] run function sprint_racer:items/container_spawn/capsule_category_odds/load_battle_odds_enchant

#summon random item, provided it isn't banned
scoreboard players set @s rNumber 0
scoreboard players operation @s rNumber = @e[limit=1,sort=random,tag=!specialEnchantBan,tag=random,x=1548,y=155,z=406,distance=..1,type=armor_stand,scores={rNumber=1..50}] rNumber
