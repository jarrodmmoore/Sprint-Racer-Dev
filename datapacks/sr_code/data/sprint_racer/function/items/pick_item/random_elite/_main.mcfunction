...
execute unless entity @e[tag=w,type=armor_stand,scores={gameState=3}] run function sprint_racer:items/pick_item/random_elite/odds/race
execute if entity @e[tag=w,type=armor_stand,scores={gameState=3}] run function sprint_racer:items/pick_item/random_elite/odds/battle
#=======================
