...
execute if entity @e[tag=w,type=armor_stand,tag=banNo9] run tag @e[tag=random,scores={rNumber=1..8}] add tempBan
execute if entity @e[tag=w,type=armor_stand,tag=banNo10] run tag @e[tag=random,scores={rNumber=9..16}] add tempBan
execute if entity @e[tag=w,type=armor_stand,tag=banNo11] run tag @e[tag=random,scores={rNumber=17..32}] add tempBan
