...
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=banNo10] run tag @e[tag=random,x=1548,y=155,z=406,distance=..1,scores={rNumber=5..25}] add tempBan
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=banNo11] run tag @e[tag=random,x=1548,y=155,z=406,distance=..1,scores={rNumber=26..30}] add tempBan
