...
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,tag=banNo9] run tag @e[tag=random,x=1548,y=155,z=406,distance=..1,scores={rNumber=1..4}] add tempBan
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,tag=banNo10] run tag @e[tag=random,x=1548,y=155,z=406,distance=..1,scores={rNumber=5..25}] add tempBan
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,tag=banNo11] run tag @e[tag=random,x=1548,y=155,z=406,distance=..1,scores={rNumber=26..30}] add tempBan
...
execute if entity @s[scores={rNumber=5..25}] run function sprint_racer_language:gameplay/give_item/no10
execute if entity @s[scores={rNumber=26..30}] run function sprint_racer_language:gameplay/give_item/no11
