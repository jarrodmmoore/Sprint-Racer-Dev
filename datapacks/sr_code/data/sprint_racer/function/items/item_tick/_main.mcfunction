...
execute unless entity @e[type=armor_stand,tag=cheats,x=1548,y=148,z=422,distance=..1,tag=26a] as @e[tag=missile,type=armor_stand] at @s run function sprint_racer:items/item_tick/missile
execute if entity @e[type=armor_stand,tag=cheats,x=1548,y=148,z=422,distance=..1,tag=26a] as @e[tag=missile,type=armor_stand] at @s run function sprint_racer:items/item_tick/missile_fast_init
