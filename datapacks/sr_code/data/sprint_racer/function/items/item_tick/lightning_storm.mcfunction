...
execute if entity @s[scores={lightningSafe=..0}] run scoreboard players operation @s lightningSafe = @e[limit=1,sort=random,tag=random,x=1548,y=155,z=406,distance=..1,scores={rNumber=12..50}] rNumber

execute if entity @s[scores={storm=20}] if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=raining] run weather rain
execute if entity @s[scores={storm=20}] if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=!raining] run weather clear
