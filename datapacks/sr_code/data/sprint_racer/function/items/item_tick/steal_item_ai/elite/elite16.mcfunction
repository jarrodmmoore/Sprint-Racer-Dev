...
scoreboard players remove @e[tag=stealTarget1] aiHasItem36 1
...
execute if entity @s[scores={giveQty=..9}] if entity @e[tag=stealTarget1,scores={aiHasItem36=1..}] run function sprint_racer:items/item_tick/steal_item_ai/elite/elite16
