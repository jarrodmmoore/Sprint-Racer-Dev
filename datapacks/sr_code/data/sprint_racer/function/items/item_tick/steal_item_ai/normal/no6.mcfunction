...
scoreboard players remove @e[tag=stealTarget2] aiHasItem6 1
...
execute if entity @s[scores={giveQty=..9}] if entity @e[tag=stealTarget2,scores={aiHasItem6=1..}] run function sprint_racer:items/item_tick/steal_item_ai/normal/no6
