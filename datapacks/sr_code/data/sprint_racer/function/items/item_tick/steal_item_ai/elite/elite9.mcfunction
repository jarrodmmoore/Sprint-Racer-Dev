...
scoreboard players remove @e[tag=stealTarget1] aiHasItem29 1
...
execute if entity @s[scores={giveQty=..9}] if entity @e[tag=stealTarget1,scores={aiHasItem29=1..}] run function sprint_racer:items/item_tick/steal_item_ai/elite/elite9
