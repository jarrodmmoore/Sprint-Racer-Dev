...
execute as @e[type=snowball,tag=!itemCyan,tag=!mHitbox,tag=!targetVisual,tag=sHasID] at @s run particle falling_dust{block_state:"minecraft:orange_concrete"} ~ ~.1 ~ 0 0 0 0 1 force
execute as @e[type=snowball,tag=itemCyan,tag=!mHitbox,tag=!targetVisual,tag=sHasID] at @s run particle falling_dust{block_state:"minecraft:cyan_concrete"} ~ ~.1 ~ 0 0 0 0 1 force
execute as @e[type=snowball,tag=!mHitbox,tag=!targetVisual,tag=sHasID] at @s run particle end_rod ~ ~.1 ~ .6 .6 .6 0 3
execute as @e[type=snowball,tag=!itemCyan,tag=!mHitbox,tag=!targetVisual,tag=sHasID] at @s run function sprint_racer:items/item_tick/snowball_hit_detect_orange
execute as @e[type=snowball,tag=itemCyan,tag=!mHitbox,tag=!targetVisual,tag=sHasID] at @s run function sprint_racer:items/item_tick/snowball_hit_detect_cyan
