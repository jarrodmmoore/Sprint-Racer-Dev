...
execute if entity @s[tag=!itemCyan,tag=!mHitbox,tag=!targetVisual,tag=sHasID] run particle falling_dust{block_state:"minecraft:orange_concrete"} ~ ~.1 ~ 0 0 0 0 1 force
execute if entity @s[tag=itemCyan,tag=!mHitbox,tag=!targetVisual,tag=sHasID] run particle falling_dust{block_state:"minecraft:cyan_concrete"} ~ ~.1 ~ 0 0 0 0 1 force
execute if entity @s[tag=!mHitbox,tag=!targetVisual,tag=sHasID] run particle end_rod ~ ~.1 ~ .6 .6 .6 0 3
execute if entity @s[tag=!itemCyan,tag=!mHitbox,tag=!targetVisual,tag=sHasID] run function sprint_racer:items/item_tick/snowball_hit_detect_orange
execute if entity @s[tag=itemCyan,tag=!mHitbox,tag=!targetVisual,tag=sHasID] run function sprint_racer:items/item_tick/snowball_hit_detect_cyan
...
execute if entity @s[tag=!mHitbox,tag=!targetVisual,scores={age=2..}] at @s run scoreboard players set @e[distance=..4,tag=chickenmine] electrocute 1