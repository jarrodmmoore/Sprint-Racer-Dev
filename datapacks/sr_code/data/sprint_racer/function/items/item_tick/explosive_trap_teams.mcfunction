...
#don't explode if the chest is on your team
execute if entity @s[tag=playerOrange] run tag @e[tag=kaboom,tag=!itemCyan] remove kaboom
execute if entity @s[tag=playerCyan] run tag @e[tag=kaboom,tag=itemCyan] remove kaboom
