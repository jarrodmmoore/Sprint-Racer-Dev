...
execute unless entity @s[scores={moveState=3}] run summon chicken ~ ~ ~ {Tags:["chickenmine","cmineset","trap","giveID"],attributes:[{id:"generic.movement_speed",base:0}]}
execute if entity @s[scores={moveState=3}] run summon chicken ~ ~1 ~ {Tags:["chickenmine","cmineset","trap","giveID"],attributes:[{id:"generic.movement_speed",base:0}]}
