...
#don't hit teammates!
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=teamplay] if entity @s[tag=playerOrange] run tag @e[tag=lightningTarget,tag=playerOrange] remove lightningTarget
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=teamplay] if entity @s[tag=playerCyan] run tag @e[tag=lightningTarget,tag=playerCyan] remove lightningTarget
