...
execute if entity @e[tag=cheats,tag=11a] as @e[tag=setme] run function sprint_racer:cheats/homing_entity_chance
...
execute unless entity @e[tag=w,tag=halftick] run scoreboard players set @e[tag=squidTarget] blinddelay 12
execute if score #halftick value matches 1 run scoreboard players set @e[tag=squidTarget] blinddelay 6
execute unless entity @e[tag=w,tag=halftick] run scoreboard players set @e[tag=squidTarget] blindtime 64
