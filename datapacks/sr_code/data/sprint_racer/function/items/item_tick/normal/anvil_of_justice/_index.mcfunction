...
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gameState=0}] run tag @s add anvilLobby
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=!teamplay,scores={gameState=1}] run tag @s add anvilRace
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=teamplay,scores={gameState=1}] run tag @s add anvilRaceTeams
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=!teamplay,scores={gameState=3}] unless entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gamemodePresetB=2}] run tag @s add anvilBattle
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=teamplay,scores={gameState=3}] unless entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gamemodePresetB=2}] run tag @s add anvilBattleTeams
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=!teamplay,scores={gameState=3}] if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gamemodePresetB=2}] run tag @s add anvilBattle2
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=teamplay,scores={gameState=3}] if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gamemodePresetB=2}] run tag @s add anvilBattleTeams2
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gameState=5}] run tag @s add anvilBattle
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=!teamplay,scores={gameState=12}] run tag @s add anvilRace
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=teamplay,scores={gameState=12}] run tag @s add anvilRaceTeams
