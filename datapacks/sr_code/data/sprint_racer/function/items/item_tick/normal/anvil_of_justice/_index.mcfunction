...
execute if entity @e[tag=w,type=armor_stand,scores={gameState=0}] run tag @s add anvilLobby
execute if entity @e[tag=w,type=armor_stand,tag=!teamplay,scores={gameState=1}] run tag @s add anvilRace
execute if entity @e[tag=w,type=armor_stand,tag=teamplay,scores={gameState=1}] run tag @s add anvilRaceTeams
execute if entity @e[tag=w,type=armor_stand,tag=!teamplay,scores={gameState=3}] unless entity @e[tag=w,type=armor_stand,scores={gamemodePresetB=2}] run tag @s add anvilBattle
execute if entity @e[tag=w,type=armor_stand,tag=teamplay,scores={gameState=3}] unless entity @e[tag=w,type=armor_stand,scores={gamemodePresetB=2}] run tag @s add anvilBattleTeams
execute if entity @e[tag=w,type=armor_stand,tag=!teamplay,scores={gameState=3}] if entity @e[tag=w,type=armor_stand,scores={gamemodePresetB=2}] run tag @s add anvilBattle2
execute if entity @e[tag=w,type=armor_stand,tag=teamplay,scores={gameState=3}] if entity @e[tag=w,type=armor_stand,scores={gamemodePresetB=2}] run tag @s add anvilBattleTeams2
execute if entity @e[tag=w,type=armor_stand,scores={gameState=5}] run tag @s add anvilBattle
execute if entity @e[tag=w,type=armor_stand,tag=!teamplay,scores={gameState=12}] run tag @s add anvilRace
execute if entity @e[tag=w,type=armor_stand,tag=teamplay,scores={gameState=12}] run tag @s add anvilRaceTeams
