summon lingering_potion ~ ~ ~ {Tags:["setPotionOwner"],Motion:[0.0d,-0.5d,0.0d],Item:{id:"minecraft:lingering_potion",count:1,components:{"minecraft:potion_contents":{potion:"minecraft:strong_poison",custom_color:9186694,custom_effects:[{id:"minecraft:nausea",amplifier:1,duration:140,show_particles:0b}]}}}}
