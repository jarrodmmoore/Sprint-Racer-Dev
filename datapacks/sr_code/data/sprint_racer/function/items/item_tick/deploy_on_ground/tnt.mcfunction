...
execute if entity @e[type=armor_stand,tag=cheats,x=1548,y=148,z=422,distance=..1,tag=11a] as @e[tag=giveID,limit=1] run function sprint_racer:cheats/homing_entity_chance
...
execute if entity @s[tag=!itemCyan] if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=teamplay] run team join playerOrange @e[tag=giveID,limit=1]
