summon armor_stand ~ ~-2 ~ {Tags:["itemcontainer","chest10","land_mine","cSETME"],Invisible:1b,Invulnerable:1b,NoBasePlate:1b,NoGravity:1b,equipment:{head:{}},DisabledSlots:2039583}
