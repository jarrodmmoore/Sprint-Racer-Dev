summon armor_stand ~ ~ ~ {Tags:["magmatrap","trap","giveID"],Motion:[0.0d,0.0d,0.0d],Silent:1b,Invisible:1b,Small:1b,DisabledSlots:4144959,equipment:{head:{id:"minecraft:magma_block",count:1}}}
