summon armor_stand ~ ~ ~ {Tags:["slimetrap","trap","giveID"],Motion:[0.0d,0.0d,0.0d],Silent:1b,Invisible:1b,Small:1b,DisabledSlots:4144959,equipment:{head:{id:"minecraft:slime_block",count:1}}}
