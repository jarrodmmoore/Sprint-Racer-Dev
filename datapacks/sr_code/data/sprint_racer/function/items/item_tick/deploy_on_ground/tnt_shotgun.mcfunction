...
execute if entity @s[tag=!itemCyan] if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=teamplay] run team join playerOrange @e[tag=giveID,limit=5,sort=nearest]
