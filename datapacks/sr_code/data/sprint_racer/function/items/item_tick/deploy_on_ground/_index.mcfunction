...
#execute if entity @s[nbt={Item:{components:{"minecraft:custom_data":{no16:1b}}}}] unless entity @e[tag=w,x=1560,y=150,z=406,distance=..1,scores={gameState=1..}] at @s run function sprint_racer:items/item_tick/deploy_on_ground/trap_error
#execute if entity @s[nbt={Item:{components:{"minecraft:custom_data":{elite16:1b}}}}] unless entity @e[tag=w,x=1560,y=150,z=406,distance=..1,scores={gameState=1..}] at @s run function sprint_racer:items/item_tick/deploy_on_ground/trap_error