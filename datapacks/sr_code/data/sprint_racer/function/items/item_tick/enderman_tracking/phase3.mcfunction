...
execute if entity @s[scores={enderSteal=50},tag=getClocked] unless entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=teamplay] at @e[tag=myEndie3,limit=1,sort=nearest] run summon tnt ~ ~ ~ {fuse:10000,Motion:[0.0d,0.3d,0.0d]}
