...
execute if entity @s[tag=changeButton] run data merge entity @s {IsBaby:0b,ArmorItems:[{},{},{},{id:"minecraft:stone_button",count:1,components:{"minecraft:enchantments":{levels:{"minecraft:depth_strider":3,"minecraft:binding_curse":1,"minecraft:vanishing_curse":1}}}}],drop_chances:{head:0.0,chest:0.0,legs:0.0,feet:0.0,mainhand:0.0,offhand:0.0,body:0.0}}
