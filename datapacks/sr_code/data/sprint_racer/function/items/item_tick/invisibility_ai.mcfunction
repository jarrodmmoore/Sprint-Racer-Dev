...
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,scores={gameTime=161..}] if entity @s[tag=changeButton] run data merge entity @s {IsBaby:1b,equipment:{head:{}}}
