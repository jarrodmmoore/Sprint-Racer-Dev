...
execute as @e[tag=explosion,tag=boom] at @s run summon creeper ~ ~ ~ {Invulnerable:1,NoGravity:1b,Silent:1b,Health:1.0f,Fuse:0,attributes:[{id:"knockback_resistance",base:1}]}
