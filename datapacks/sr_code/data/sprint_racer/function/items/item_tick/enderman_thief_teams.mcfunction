...
execute as @e[scores={enderman=1..35}] at @s run function sprint_racer:items/item_tick/enderman_tracking/phase1

#PHASE 2
scoreboard players set @e[scores={enderman=60}] giveItem -1
execute as @e[tag=!playerCyan,scores={enderman=60..340}] at @s run function sprint_racer:items/item_tick/enderman_tracking/phase2_teams_orange
execute as @e[tag=playerCyan,scores={enderman=60..340}] at @s run function sprint_racer:items/item_tick/enderman_tracking/phase2_teams_cyan
