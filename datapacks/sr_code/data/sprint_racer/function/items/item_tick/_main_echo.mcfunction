...
execute if entity @e[tag=slimetrap] run function sprint_racer:items/item_tick/slime_trap
execute if entity @e[tag=magmatrap] run function sprint_racer:items/item_tick/magma_trap
