...
execute if block ~ ~1 ~ #sprint_racer:missile_do_not_explode if block ~ ~2 ~ #sprint_racer:missile_do_not_explode run tp @s ~ ~1 ~

effect give @s levitation 1 15 true
effect give @s[tag=elytraMed] levitation 1 20 true
effect give @s[tag=elytraLong] levitation 1 35 true
