tag @e[limit=1,sort=random,tag=activeplayer,tag=!self,tag=!anvilled] add anvTarget
...
execute if entity @s[scores={repeatCount=1..}] run function sprint_racer:items/item_tick/elite/anvil_of_injustice_repeat