...
#don't hit teammates!
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,tag=teamplay] if entity @s[tag=playerOrange] run scoreboard players set @e[tag=activeplayer,tag=playerOrange] lightningSafe 440
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,tag=teamplay] if entity @s[tag=playerCyan] run scoreboard players set @e[tag=activeplayer,tag=playerCyan] lightningSafe 440

scoreboard players add @s[scores={lightningSafe=..400}] lightningSafe 440
scoreboard players operation @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,limit=1] attackerID = @s playerID
...
scoreboard players add @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand] storm 440
scoreboard players set @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,scores={storm=801..}] storm 800
