...
execute if entity @e[scores={enderman=..999}] run function sprint_racer:items/item_tick/enderman_thief_teams
...
#chicken mine
#execute if entity @e[tag=chickenmine] run function sprint_racer:items/item_tick/chicken_mine_teams
...
#some projectiles...
execute if entity @e[type=snowball,tag=!mHitbox] run function sprint_racer:items/item_tick/snowball_teams
execute as @e[tag=missile,type=armor_stand] at @s run function sprint_racer:items/item_tick/missile_teams