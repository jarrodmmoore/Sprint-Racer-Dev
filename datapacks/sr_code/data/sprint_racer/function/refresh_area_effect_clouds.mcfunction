...
execute as @e[tag=refreshcloud,limit=5,sort=random,type=marker] run data merge entity @s {Age:-2147483648,custom_particle:{type:"block",block_state:{id:"air"}},Duration:-1,WaitTime:-2147483648}