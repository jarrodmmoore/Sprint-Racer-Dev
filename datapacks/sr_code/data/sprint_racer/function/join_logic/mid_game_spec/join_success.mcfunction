...
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=teamplay] run function sprint_racer:teams/pick_team
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=teamplay,scores={forcePlayerTeam=1}] run function sprint_racer:teams/join_orange
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=teamplay,scores={forcePlayerTeam=2}] run function sprint_racer:teams/join_cyan
...
#respawn
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gameState=1}] at @s run function sprint_racer:game_logic/1/respawn
execute unless entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gameState=1}] at @s run function sprint_racer:game_logic/3/respawn
...
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gameTime=..150}] run effect give @s minecraft:invisibility 15 0 true
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gameTime=151..}] run effect clear @s