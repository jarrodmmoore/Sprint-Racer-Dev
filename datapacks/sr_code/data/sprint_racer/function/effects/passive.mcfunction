...
#prevent PVP
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=!allowPVP] as @a[gamemode=adventure] unless items entity @s weapon.mainhand *[custom_data~{stronk:1b}] run effect give @s minecraft:weakness 3 5 true
