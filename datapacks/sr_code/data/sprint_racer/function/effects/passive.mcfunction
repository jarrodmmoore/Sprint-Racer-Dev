...
#prevent PVP
execute if entity @e[tag=w,type=armor_stand,tag=!allowPVP] as @a[gamemode=adventure] unless items entity @s weapon.mainhand *[custom_data~{stronk:1b}] run effect give @s minecraft:weakness 3 5 true
