...
execute if entity @s[tag=forcespectate] if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gameState=1..3}] run function sprint_racer:join_logic/mid_game_spec/join_success
