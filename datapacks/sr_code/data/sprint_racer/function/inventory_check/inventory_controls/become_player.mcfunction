...
execute if entity @s[tag=forcespectate] if entity @e[tag=w,type=armor_stand,scores={gameState=1..3}] run function sprint_racer:join_logic/mid_game_spec/join_success
