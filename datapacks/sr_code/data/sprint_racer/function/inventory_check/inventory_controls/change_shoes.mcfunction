...
execute unless entity @e[type=armor_stand,tag=60a,tag=cheats] run function sprint_racer:cheats/shoes/0
execute unless entity @e[type=armor_stand,tag=60a,tag=cheats] run tag @s remove needShoeButton
