...
execute unless entity @e[type=armor_stand,tag=60a,tag=cheats,x=1550,y=148,z=406,distance=..1] run function sprint_racer:cheats/shoes/0
execute unless entity @e[type=armor_stand,tag=60a,tag=cheats,x=1550,y=148,z=406,distance=..1] run tag @s remove needShoeButton
