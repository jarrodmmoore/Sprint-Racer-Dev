...
scoreboard players set @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,limit=1] playerCountB 0
execute as @a[tag=playing] run scoreboard players add @e[tag=w,x=1560,y=150,z=406,distance=..1,limit=1] playerCountB 1
scoreboard players set @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,limit=1] maturity 0
execute as @a[tag=playing] run scoreboard players operation @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,limit=1] maturity += @s maturity
scoreboard players operation @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,limit=1] maturity /= @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,limit=1] playerCountB
scoreboard players set @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,limit=1,scores={difficultyRamp=..0}] maturity 100
...
tag @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] remove forcetutorial
execute if entity @e[tag=trackTutorial,tag=!rtBlacklist,type=armor_stand] run tag @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={maturity=..1}] add forcetutorial
...
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={maturity=2..}] run tag @e[tag=trackStandR,tag=!rtBlacklist,tag=trackTutorial,type=armor_stand] add voteViable
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={maturity=3..}] run tag @e[tag=trackStandR,tag=!rtBlacklist,tag=trackIntermed,type=armor_stand] add voteViable
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={maturity=4..}] run tag @e[tag=trackStandR,tag=!rtBlacklist,tag=trackExpert,type=armor_stand] add voteViable
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={maturity=7..}] run tag @e[tag=trackStandR,tag=!rtBlacklist,tag=trackMaster,type=armor_stand] add voteViable
...
tag @e[tag=vote1,type=armor_stand] remove vote1
execute if score #random value matches ..35 unless entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=forcetutorial] unless entity @e[tag=vote1,type=armor_stand] run tag @e[limit=1,sort=random,tag=voteViable,type=armor_stand,tag=!r_1_only,tag=!r_rare_track,scores={randomCooldown=..0}] add vote1
execute if score #random value matches 36..70 unless entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=forcetutorial] unless entity @e[tag=vote1,type=armor_stand] run tag @e[limit=1,sort=random,tag=voteViable,type=armor_stand,tag=!r_rare_track,scores={randomCooldown=..0}] add vote1
execute if score #random value matches 71.. unless entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=forcetutorial] unless entity @e[tag=vote1,type=armor_stand] run tag @e[limit=1,sort=random,tag=voteViable,type=armor_stand,scores={randomCooldown=..0}] add vote1
...
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={maturity=2..}] run tag @e[tag=trackStandR,tag=!rtBlacklist,tag=trackIntermed,type=armor_stand] add voteViable
...
execute unless entity @e[tag=vote1,type=armor_stand] run tag @e[tag=random,x=1548,y=155,z=406,distance=..1,type=armor_stand,limit=1,scores={rNumber=1}] add vote1
execute unless entity @e[tag=vote2,type=armor_stand] run tag @e[tag=random,x=1548,y=155,z=406,distance=..1,type=armor_stand,limit=1,scores={rNumber=2}] add vote2
execute unless entity @e[tag=vote3,type=armor_stand] run tag @e[tag=random,x=1548,y=155,z=406,distance=..1,type=armor_stand,limit=1,scores={rNumber=3}] add vote3