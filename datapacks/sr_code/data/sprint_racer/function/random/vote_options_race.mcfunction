...
scoreboard players set @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,limit=1] playerCountB 0
execute as @a[tag=playing] run scoreboard players add @e[tag=w,x=1560,y=150,z=406,distance=..1,limit=1] playerCountB 1
scoreboard players set @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,limit=1] maturity 0
execute as @a[tag=playing] run scoreboard players operation @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,limit=1] maturity += @s maturity
scoreboard players operation @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,limit=1] maturity /= @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,limit=1] playerCountB
scoreboard players set @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,limit=1,scores={difficultyRamp=..0}] maturity 100
...
tag @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand] remove forcetutorial
execute if entity @e[tag=trackTutorial,tag=!rtBlacklist,type=armor_stand] run tag @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,scores={maturity=..1}] add forcetutorial
...
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,scores={maturity=2..}] run tag @e[tag=trackStandR,tag=!rtBlacklist,tag=trackTutorial,type=armor_stand] add voteViable
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,scores={maturity=3..}] run tag @e[tag=trackStandR,tag=!rtBlacklist,tag=trackIntermed,type=armor_stand] add voteViable
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,scores={maturity=4..}] run tag @e[tag=trackStandR,tag=!rtBlacklist,tag=trackExpert,type=armor_stand] add voteViable
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,scores={maturity=7..}] run tag @e[tag=trackStandR,tag=!rtBlacklist,tag=trackMaster,type=armor_stand] add voteViable
