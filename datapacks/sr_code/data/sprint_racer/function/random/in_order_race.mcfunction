...
execute as @e[type=armor_stand,tag=random,x=1548,y=155,z=406,distance=..1,tag=trackStandR,scores={rNumber=1..50}] run scoreboard players operation @s math = @s rNumber
scoreboard players operation @e[type=armor_stand,tag=random,x=1548,y=155,z=406,distance=..1,tag=trackStandR,scores={rNumber=1..50}] math -= @e[tag=w,x=1560,y=150,z=406,distance=..1,limit=1,type=armor_stand] trackSequenceR

#choose the track that matches! (unless blacklisted)
tag @e[limit=1,type=armor_stand,tag=random,x=1548,y=155,z=406,distance=..1,tag=trackStandR,tag=!rtBlacklist,scores={rNumber=1..50,math=0}] add chosenTrack
