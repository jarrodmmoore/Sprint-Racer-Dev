...
execute unless entity @e[type=armor_stand,tag=cheats,x=1548,y=148,z=422,distance=..1,tag=38] run tag @e[type=armor_stand,tag=random,scores={rNumber=50}] add rSortSelect
execute unless entity @e[type=armor_stand,tag=cheats,x=1548,y=148,z=422,distance=..1,tag=56] run tag @e[type=armor_stand,tag=random,scores={rNumber=37}] add rSortSelect
