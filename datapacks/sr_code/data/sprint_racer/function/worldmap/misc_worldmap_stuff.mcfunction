...
execute if score #gateCheck value matches 15 if block 2499 74 202 redstone_block if block 2518 92 202 air if block 2529 92 202 air if block 2499 92 215 air if block 2518 92 215 air if block 2529 92 215 air if block 2499 92 228 air if block 2518 92 228 air if block 2529 92 228 air if entity @e[tag=w,type=armor_stand,tag=!COPPA] run function sprint_racer:worldmap/gates/casino_chase_show