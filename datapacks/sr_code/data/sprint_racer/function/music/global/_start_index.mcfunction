...
#execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=realms,scores={gameState=1}] run function sprint_racer:music/global/announce_index
#execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=realms,scores={gameState=3}] run function sprint_racer:music/global/announce_index
