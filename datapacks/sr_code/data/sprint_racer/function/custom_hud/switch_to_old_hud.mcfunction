...
execute if score #hudMode value matches 1 if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=!hideLaps,scores={lap=1..10}] run function sprint_racer:game_logic/1/lap_bossbar/lap_bossbar_index
execute if score #hudMode value matches 3 if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=!hideLaps,scores={lap=1..10}] run function sprint_racer:game_logic/1/lap_bossbar/lap_bossbar_index
