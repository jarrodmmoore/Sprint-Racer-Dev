...
execute if entity @e[limit=1,type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=halftick] run scoreboard players set #halftick value 1

#admin mode?
scoreboard players set #adminmode value 0
execute if entity @e[limit=1,type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=requireAdmin] run scoreboard players set #adminmode value 1
...
execute unless entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=requireAdmin] run function sprint_racer:inventory_check/global_no_admins
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=requireAdmin] run function sprint_racer:inventory_check/global_admins

#mid-game voting
function sprint_racer:mid_game_vote/mgv_main

#oTimerGlobal, helps run commands at half frequency when I want to
scoreboard players add @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] oTimerGlobal 1
scoreboard players set @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={oTimerGlobal=2..}] oTimerGlobal 0
...
execute if score global allowInvis matches 1 if score global gameState matches 1 if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gameTime=161..}] run function sprint_racer:game_logic/1/invisible_nearby/main
execute if score global allowInvis matches 2 if score global gameState matches 1 if score global playerCountM matches 5.. if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gameTime=161..}] run function sprint_racer:game_logic/1/invisible_nearby/main
...
execute unless entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=realms] as @a[gamemode=creative,tag=!restricted] at @s run function sprint_racer:admin

#get coordinates
execute as @a at @s run function sprint_racer:coordinates

#items
execute unless entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=teamplay,scores={gameState=1..3}] unless entity @e[type=armor_stand,tag=cheats,x=1548,y=148,z=422,distance=..1,tag=14a] as @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,limit=1] run function sprint_racer:items/item_tick/_main
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=teamplay,scores={gameState=1..3}] unless entity @e[type=armor_stand,tag=cheats,x=1548,y=148,z=422,distance=..1,tag=14a] as @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,limit=1] run function sprint_racer:items/item_tick/_main_teams
execute if entity @e[type=armor_stand,tag=cheats,x=1548,y=148,z=422,distance=..1,tag=14a] as @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,limit=1] run function sprint_racer:items/item_tick/_main
...
execute if score global gameState matches 1 if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,scores={gameTime=180..}] run bossbar set minecraft:control_holdtosprint players @a[tag=!bbarbump,tag=playing,gamemode=!spectator,scores={timeWalked=50..}]
...
execute as @a[tag=playing,gamemode=!spectator] run scoreboard players add @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] playerCountB 1


#show speedometer if only one racer is present
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=speedo,tag=!nospeedo] as @a[limit=1,tag=playing] at @s run function sprint_racer:speedometer/speedo_main
...
#global cheats
execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=cheatdetected] run function sprint_racer:cheats/_cheats_main
...
execute as @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,limit=1,scores={specJoinTime=1..}] run function sprint_racer:join_logic/mid_game_spec/_mgs_main
