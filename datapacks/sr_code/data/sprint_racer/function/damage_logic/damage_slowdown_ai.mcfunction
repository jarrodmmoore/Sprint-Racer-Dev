...
execute if entity @e[type=armor_stand,tag=cheats,x=1548,y=148,z=422,distance=..1,tag=25a] if entity @s[tag=ai,scores={attackerID=1..}] run data merge entity @s {Health:999.0f}
...
execute if entity @s[tag=cat_png] run playsound minecraft:sr_hitsounds/hit5 master @a ~ ~ ~ 1 1
