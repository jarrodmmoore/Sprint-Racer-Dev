...
scoreboard players operation #rb_sound value = @e[limit=1,tag=random,x=1548,y=155,z=406,distance=..1,type=armor_stand,sort=random,scores={rNumber=1..5}] rNumber
