...
give @s[tag=!justOne,scores={itemLuck=..3}] minecraft:iron_ingot[custom_name='{"translate":"sr.item.resistance","color":"yellow","bold":true,"italic":false}',custom_data={no7:1b,stay:1b,item:1b,normalitem:1b,rightclick:1b}] 1
give @s[tag=!justOne,scores={itemLuck=4..}] minecraft:iron_ingot[custom_name='{"translate":"sr.item.resistance","color":"yellow","bold":true,"italic":false}',custom_data={no7:1b,stay:1b,item:1b,normalitem:1b,rightclick:1b}] 2
