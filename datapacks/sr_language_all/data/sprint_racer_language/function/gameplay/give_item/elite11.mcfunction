...
give @s minecraft:flint[enchantments={levels:{"minecraft:lure":1},show_in_tooltip:0b},custom_name='["",{"text":"↑ ","color":"dark_purple","bold":true,"italic":false},{"translate":"sr.item_elite.warp","color":"aqua","bold":true,"italic":false}]',custom_data={elite11:1b,item:1b,eliteitem:1b,rightclick:1b}] 1
