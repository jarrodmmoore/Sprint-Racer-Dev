...
give @s[tag=!justOne,scores={itemLuck=..3}] minecraft:apple[custom_name='{"translate":"sr.item.apple","color":"yellow","bold":true,"italic":false}',custom_data={no5:1b,stay:1b,item:1b,normalitem:1b,rightclick:1b}] 1
give @s[tag=!justOne,scores={itemLuck=4}] minecraft:apple[custom_name='{"translate":"sr.item.apple","color":"yellow","bold":true,"italic":false}',custom_data={no5:1b,stay:1b,item:1b,normalitem:1b,rightclick:1b}] 2
give @s[tag=!justOne,scores={itemLuck=5..}] minecraft:apple[custom_name='{"translate":"sr.item.apple","color":"yellow","bold":true,"italic":false}',custom_data={no5:1b,stay:1b,item:1b,normalitem:1b,rightclick:1b}] 3
