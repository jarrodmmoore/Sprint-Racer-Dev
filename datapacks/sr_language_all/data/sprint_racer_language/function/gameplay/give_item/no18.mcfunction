give @s minecraft:black_terracotta[custom_model_data=1111111,custom_name='{"translate":"sr.item.enderman","color":"light_purple","bold":true,"italic":false}',custom_data={no18:1b,stay:1b,item:1b,normalitem:1b,rightclick:1b}] 1
