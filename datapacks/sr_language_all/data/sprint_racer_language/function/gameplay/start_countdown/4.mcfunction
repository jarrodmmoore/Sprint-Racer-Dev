...
execute if entity @s[scores={gameTime=160}] run title @a title ["",{translate:"sr.game.go",bold:true,color:"gold"}]
execute if entity @s[scores={gameTime=162}] run title @a title ["",{translate:"sr.game.go",bold:true,color:"gray"}]
execute if entity @s[scores={gameTime=164}] run title @a title ["",{translate:"sr.game.go",bold:true,color:"gold"}]
execute if entity @s[scores={gameTime=166}] run title @a title ["",{translate:"sr.game.go",bold:true,color:"gray"}]
execute if entity @s[scores={gameTime=168}] run title @a title ["",{translate:"sr.game.go",bold:true,color:"gold"}]
execute if entity @s[scores={gameTime=170}] run title @a title ["",{translate:"sr.game.go",bold:true,color:"gray"}]
execute if entity @s[scores={gameTime=172}] run title @a title ["",{translate:"sr.game.go",bold:true,color:"gold"}]
execute if entity @s[scores={gameTime=174}] run title @a title ["",{translate:"sr.game.go",bold:true,color:"gray"}]
execute if entity @s[scores={gameTime=176}] run title @a title ["",{translate:"sr.game.go",bold:true,color:"gold"}]
execute if entity @s[scores={gameTime=178}] run title @a title ["",{translate:"sr.game.go",bold:true,color:"gray"}]
execute if entity @s[scores={gameTime=180}] run title @a title ["",{translate:"sr.game.go",bold:true,color:"gold"}]
