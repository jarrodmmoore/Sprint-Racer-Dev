...
#state 1, player KO's
execute if score #bbPersonalize value matches 2 as @a[gamemode=!spectator,tag=!miniHUD,scores={actionbarState=1}] run title @s actionbar [""]
execute if score #bbPersonalize value matches 2 as @a[gamemode=!spectator,tag=miniHUD,scores={actionbarState=1}] run function sprint_racer:game_logic/3/show_position/_index
execute unless score #bbPersonalize value matches 2 as @a[gamemode=!spectator,scores={actionbarState=1}] run function sprint_racer:game_logic/3/show_position/_index
