...
execute as @e[tag=AImaster,scores={finishPos=1}] if entity @s[scores={addPoints=1}] run tellraw @a ["",{"text":"CPU_","color":"aqua"},{"score":{"name":"@s","objective":"rNumber"},"color":"aqua"},{"text":" >> [1st] +1","color":"yellow","bold":true},{"text":" "},{"translate":"sr.game.got_point","color":"yellow","bold":true}]
execute as @e[tag=AImaster,scores={finishPos=1}] unless entity @s[scores={addPoints=1}] run tellraw @a ["",{"text":"CPU_","color":"aqua"},{"score":{"name":"@s","objective":"rNumber"},"color":"aqua"},{"text":" >> [1st] +","color":"yellow","bold":true},{"score":{"name":"@s","objective":"addPoints"},"color":"yellow","bold":true},{"text":" "},{"translate":"sr.game.got_points","color":"yellow","bold":true}]
...
execute as @e[tag=AImaster,scores={finishPos=2}] if entity @s[scores={addPoints=1}] run tellraw @a ["",{"text":"CPU_","color":"aqua"},{"score":{"name":"@s","objective":"rNumber"},"color":"aqua"},{"text":" >> [2nd] +1","color":"gray","bold":true},{"text":" "},{"translate":"sr.game.got_point","color":"gray","bold":true}]
execute as @e[tag=AImaster,scores={finishPos=2}] unless entity @s[scores={addPoints=1}] run tellraw @a ["",{"text":"CPU_","color":"aqua"},{"score":{"name":"@s","objective":"rNumber"},"color":"aqua"},{"text":" >> [2nd] +","color":"gray","bold":true},{"score":{"name":"@s","objective":"addPoints"},"color":"gray","bold":true},{"text":" "},{"translate":"sr.game.got_points","color":"gray","bold":true}]
...
execute as @e[tag=AImaster,scores={finishPos=3}] if entity @s[scores={addPoints=1}] run tellraw @a ["",{"text":"CPU_","color":"aqua"},{"score":{"name":"@s","objective":"rNumber"},"color":"aqua"},{"text":" >> [3rd] +1","color":"gold","bold":true},{"text":" "},{"translate":"sr.game.got_point","color":"gold","bold":true}]
execute as @e[tag=AImaster,scores={finishPos=3}] unless entity @s[scores={addPoints=1}] run tellraw @a ["",{"text":"CPU_","color":"aqua"},{"score":{"name":"@s","objective":"rNumber"},"color":"aqua"},{"text":" >> [3rd] +","color":"gold","bold":true},{"score":{"name":"@s","objective":"addPoints"},"color":"gold","bold":true},{"text":" "},{"translate":"sr.game.got_points","color":"gold","bold":true}]
...
execute as @e[tag=AImaster,scores={finishPos=4}] if entity @s[scores={addPoints=1}] run tellraw @a ["",{"text":"CPU_","color":"aqua"},{"score":{"name":"@s","objective":"rNumber"},"color":"aqua"},{"text":" >> [4th] +1","color":"white","bold":true},{"text":" "},{"translate":"sr.game.got_point","color":"white","bold":true}]
execute as @e[tag=AImaster,scores={finishPos=4}] unless entity @s[scores={addPoints=1}] run tellraw @a ["",{"text":"CPU_","color":"aqua"},{"score":{"name":"@s","objective":"rNumber"},"color":"aqua"},{"text":" >> [4th] +","color":"white","bold":true},{"score":{"name":"@s","objective":"addPoints"},"color":"white","bold":true},{"text":" "},{"translate":"sr.game.got_points","color":"white","bold":true}]
