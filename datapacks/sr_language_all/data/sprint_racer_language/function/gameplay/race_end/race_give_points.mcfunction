...
execute as @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1,scores={finishPos=1}] run function sprint_racer_language:gameplay/race_end/ai_points_1st
...
execute as @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1,scores={finishPos=2}] run function sprint_racer_language:gameplay/race_end/ai_points_2nd
...
execute as @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1,scores={finishPos=3}] run function sprint_racer_language:gameplay/race_end/ai_points_3rd
...
execute as @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1,scores={finishPos=4}] run function sprint_racer_language:gameplay/race_end/ai_points_4th

tag @e[tag=playing,tag=finished,scores={finishPos=1..4}] add best4
tag @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1,scores={finishPos=1..4}] add best4
