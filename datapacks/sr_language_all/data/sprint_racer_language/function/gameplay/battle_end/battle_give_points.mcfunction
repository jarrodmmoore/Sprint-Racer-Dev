...
execute as @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1,scores={finishPos=1}] run function sprint_racer_language:gameplay/battle_end/ai_finished_1st
...
execute as @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1,scores={finishPos=2}] run function sprint_racer_language:gameplay/battle_end/ai_finished_2nd
...
execute as @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1,scores={finishPos=3}] run function sprint_racer_language:gameplay/battle_end/ai_finished_3rd
...
execute as @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1,scores={finishPos=4}] run function sprint_racer_language:gameplay/battle_end/ai_finished_4th
...
execute as @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1,scores={addPoints=1..}] run function sprint_racer_language:_dlc_3/gameplay/ai_points/display
execute as @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1,scores={aiPoints=1..}] run function sprint_racer_language:_dlc_3/gameplay/ai_points/display