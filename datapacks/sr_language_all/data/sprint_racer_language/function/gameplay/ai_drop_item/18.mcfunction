summon item ~ ~.3 ~ {Tags:["giveVelocity"],PickupDelay:40,Age:0,Item:{id:"minecraft:black_terracotta",count:1,components:{"minecraft:custom_model_data":1111111,"minecraft:custom_name":'{"translate":"sr.item.enderman","color":"light_purple","bold":true,"italic":false}',"minecraft:custom_data":{no18:1b,stay:1b,item:1b,normalitem:1b,rightclick:1b}}}}
