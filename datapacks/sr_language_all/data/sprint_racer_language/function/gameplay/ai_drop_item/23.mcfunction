summon item ~ ~.3 ~ {Tags:["giveVelocity"],PickupDelay:40,Age:0,Item:{id:"minecraft:tnt",count:1,components:{"minecraft:enchantments":{levels:{"minecraft:lure":1},show_in_tooltip:0b},"minecraft:custom_name":'["",{text:"↑ ",color:"dark_purple",bold:true,italic:false},{translate:"sr.item_elite.tnt",color:"red",bold:true,italic:false}]',"minecraft:custom_data":{elite3:1b,stay:1b,item:1b,eliteitem:1b,groundDeploy:1b,rightclick:1b}}}}
