...
summon item ~ ~.3 ~ {Tags:["giveVelocity"],PickupDelay:40,Age:0,Item:{id:"minecraft:flint",count:1,components:{"minecraft:enchantments":{lure:1},"minecraft:tooltip_display":{hidden_components:[enchantments]},"minecraft:custom_name":["",{text:"↑ ",color:"dark_purple",bold:true,italic:false},{translate:"sr.item_elite.warp",color:"aqua",bold:true,italic:false}],"minecraft:custom_data":{elite11:1b,item:1b,eliteitem:1b}}}}
