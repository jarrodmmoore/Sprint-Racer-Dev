...
execute if entity @a[scores={actionbarState=5}] as @e[tag=latestFinish,type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1] run function sprint_racer:game_logic/1/announce_finish_ai
