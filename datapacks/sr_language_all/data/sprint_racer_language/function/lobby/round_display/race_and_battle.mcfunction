...
#"Gamemode: X"
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,scores={roundNumber=1..4}] run summon armor_stand 1549 85 406 {Tags:["roundDisplay","roundText2"],CustomName:'["",{"translate":"sr.lobby.gamemode","color":"white","bold":false},{"translate":"sr.lobby.race","color":"aqua","bold":false}]',NoGravity:1b,Invisible:1b,Invulnerable:1b,Marker:1b,CustomNameVisible:1}
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,scores={roundNumber=5}] run summon armor_stand 1549 85 406 {Tags:["roundDisplay","roundText2"],CustomName:'["",{"translate":"sr.lobby.gamemode","color":"white","bold":false},{"translate":"sr.lobby.battle","color":"red","bold":false}]',NoGravity:1b,Invisible:1b,Invulnerable:1b,Marker:1b,CustomNameVisible:1}
