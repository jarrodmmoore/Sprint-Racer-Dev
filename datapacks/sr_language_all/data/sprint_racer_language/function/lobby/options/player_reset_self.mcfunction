...
data merge block 1556 88 411 {Text1:'{text:"Click here",click_event:{action:"run_command",command:"function sprint_racer_language:lobby/options/player_reset_self"},bold:true,color:"gold"}',Text2:'{text:"to reset",bold:true,color:"gold"}',Text3:'{text:"yourself!",bold:true,color:"gold"}'}
