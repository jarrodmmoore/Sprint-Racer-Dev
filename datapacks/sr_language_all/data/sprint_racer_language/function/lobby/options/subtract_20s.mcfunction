...
scoreboard players remove @e[tag=w,x=1560,y=150,z=406,distance=..1,scores={gameTime=21..}] gameTime 20
scoreboard players set @e[tag=w,x=1560,y=150,z=406,distance=..1,scores={gameTime=..20}] gameTime 5
