...
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=optSetB] run data merge block 1613 89 361 {front_text:{has_glowing_text:0b,messages:[{text:"",click_event:{action:"run_command",command:"function sprint_racer:game_logic/0/options_signs/ai_context_race"}},{text:"RACE AI",bold:true,color:"black"},{text:"[SINGLEPLAYER]",color:"dark_blue"},{text:""}]},is_waxed:1b}
