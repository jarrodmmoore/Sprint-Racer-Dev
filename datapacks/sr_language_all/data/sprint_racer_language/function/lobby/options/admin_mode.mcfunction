...
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=optSetB] run setblock 1601 88 369 minecraft:birch_wall_sign[facing=south]{front_text:{has_glowing_text:0b,messages:['{"text":"","clickEvent":{"action":"run_command","value":"function sprint_racer:game_logic/0/options_signs/save_state_loading"}}','{"text":"SAVE STATE","bold":true,"color":"black"}','{"text":"LOADING","bold":true,"color":"black"}','{"text":"[ADMIN ONLY]","color":"dark_blue"}']},is_waxed:1b}
