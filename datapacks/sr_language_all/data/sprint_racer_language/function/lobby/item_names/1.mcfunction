summon armor_stand ~ ~.8 ~ {CustomName:{translate:"sr.item.snowball",color:"white",bold:true},CustomNameVisible:1b,Marker:1b,Invulnerable:1b,Invisible:1b,Tags:["setscore"]}
