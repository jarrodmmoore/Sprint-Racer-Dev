summon armor_stand ~ ~.8 ~ {CustomName:'{"translate":"sr.item.resistance","color":"white","bold":true}',CustomNameVisible:1b,Marker:1b,Invulnerable:1,Invisible:1,Tags:["setscore"]}
