...
scoreboard players operation global math = @e[limit=1,sort=random,tag=random,scores={rNumber=1..50}] rNumber
scoreboard players operation global math2 = @e[limit=1,sort=random,tag=random,scores={rNumber=1..50}] rNumber
