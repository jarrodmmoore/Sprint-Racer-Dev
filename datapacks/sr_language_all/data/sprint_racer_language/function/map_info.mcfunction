...
execute unless entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=realms] run tellraw @s ["",{text:"Map version: v1.6.14",bold:false,color:"gray"}]
scoreboard players set @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] mapVersion 10614
