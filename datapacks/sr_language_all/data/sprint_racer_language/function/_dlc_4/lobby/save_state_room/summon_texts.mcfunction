execute positioned 1612 91 461 run summon armor_stand ~.5 ~ ~-.5 {Tags:["save_state_text","save_state_title","lobbyprop"],Invulnerable:1b,NoBasePlate:1b,NoGravity:1b,Invisible:1,Marker:1b,CustomName:'{"translate":"sr.lobby.save_state.current_settings","bold":true,"color":"#00CCCC"}',CustomNameVisible:1b,DisabledSlots:2039583}
