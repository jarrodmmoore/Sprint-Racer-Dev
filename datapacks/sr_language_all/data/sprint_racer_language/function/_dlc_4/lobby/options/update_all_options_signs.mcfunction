...
execute if entity @s[tag=optCustomRounds] run data merge block 1581 89 448 {front_text:{has_glowing_text:0b,messages:[{text:"",click_event:{action:"run_command",command:"trigger tOption set 1007"}},{text:"GAMEMODES",bold:true,color:"black"},{text:"[CUSTOM]",color:"dark_blue"},{text:""}]},is_waxed:1b}
...
execute if entity @s[tag=optItemsR] run data merge block 1581 89 450 {front_text:{has_glowing_text:0b,messages:[{text:"",click_event:{action:"run_command",command:"trigger tOption set 1005"}},{text:"ITEMS",bold:true,color:"black"},{text:"[RACE ONLY]",color:"dark_blue"},{text:""}]},is_waxed:1b}
execute if entity @s[tag=optItemsR] run data merge block 1595 79 433 {front_text:{has_glowing_text:0b,messages:[{text:"",click_event:{action:"run_command",command:"trigger tOption set 1005"}},{text:"ITEMS",bold:true,color:"black"},{text:"[RACE ONLY]",color:"dark_blue"},{text:""}]},is_waxed:1b}
