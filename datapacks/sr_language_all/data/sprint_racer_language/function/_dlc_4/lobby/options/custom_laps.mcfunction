...
scoreboard players operation @s customLapOffset = @e[limit=1,type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] customLapOffset
scoreboard players operation @s customLapType = @e[limit=1,type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] customLapType
scoreboard players operation @s customLapMult = @e[limit=1,type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] customLapMult
