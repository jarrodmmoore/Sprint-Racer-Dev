...
tellraw @s[scores={customLapType=1,customLapOffset=0..}] ["",{translate:"sr.cheats.custom_lap_modifier.offset",bold:true},{text:"+"},{score:{name:"@s",objective:"customLapOffset"}},{text:" "},{text:" "},{text:"[+]",color:"green",click_event:{action:"run_command",command:"/trigger cl_trigger set 10"},hover_event:{action:"show_text",value:"Increase"}},{text:"  "},{text:"[-]",color:"red",click_event:{action:"run_command",command:"/trigger cl_trigger set 11"},hover_event:{action:"show_text",value:"Decrease"}}]
...
tellraw @s[scores={customLapType=2}] ["",{translate:"sr.cheats.custom_lap_modifier.multiplier",bold:true},{score:{name:"@s",objective:"customLapMult"}},{text:"% "},{text:" "},{text:"[+]",color:"green",click_event:{action:"run_command",command:"/trigger cl_trigger set 20"},hover_event:{action:"show_text",value:"Increase"}},{text:"  "},{text:"[-]",color:"red",click_event:{action:"run_command",command:"/trigger cl_trigger set 21"},hover_event:{action:"show_text",value:"Decrease"}}]
