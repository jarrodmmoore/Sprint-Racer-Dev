...
setblock 1594 101 448 minecraft:pale_oak_wall_sign[facing=west]{front_text:{has_glowing_text:0b,messages:['{"text":"","clickEvent":{"action":"run_command","value":"function sprint_racer:game_logic/0/options_signs/custom_ai"}}','{"text":"CUSTOM AI","bold":true,"color":"black"}','{"text":"PARAMETERS","bold":true,"color":"black"}','{"text":"[SET]","color":"dark_blue"}']},is_waxed:1b}
