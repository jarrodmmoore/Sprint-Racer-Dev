...
setblock 1594 101 448 minecraft:pale_oak_wall_sign[facing=west]{front_text:{has_glowing_text:0b,messages:[{text:"",click_event:{action:"run_command",command:"trigger tOption set 1022"}},{text:"CUSTOM LAP",bold:true,color:"black"},{text:"OFFSET",bold:true,color:"black"},{text:"[CHANGE]",color:"dark_blue"}]},is_waxed:1b}


scoreboard players add @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] customLapOffset 0
scoreboard players add @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] customLapType 0
scoreboard players add @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] customLapMult 0