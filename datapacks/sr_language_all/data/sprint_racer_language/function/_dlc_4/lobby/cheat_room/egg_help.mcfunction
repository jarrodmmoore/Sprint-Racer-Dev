...
execute if score #egg_help value matches 1 if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=!COPPA] run tellraw @s ["",{translate:"sr.cheats.help.lobby"},{text:" -- 6"}]
execute if score #egg_help value matches 1 if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=COPPA] run tellraw @s ["",{translate:"sr.cheats.help.lobby"},{text:" -- 7"}]
...
execute if score #egg_help value matches 10 if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=!realms] run tellraw @s ["",{text:"Casino Chase",color:"aqua"},{text:" -- 1"}]
