...
execute positioned 1593 101 444 positioned ~ ~1.2 ~.5 run summon armor_stand ~ ~ ~ {CustomName:{text:"--",color:"white",bold:false,italic:false},Tags:["lobbyprop","cheattext","cheattext3"],NoGravity:1b,Marker:1b,Invisible:1b,Invulnerable:1b,NoBasePlate:1b,CustomNameVisible:false}

execute positioned 1593 101 444 positioned ~ ~.7 ~.5 run summon armor_stand ~ ~ ~ {CustomName:{text:"--",color:"white",bold:false,italic:false},Tags:["lobbyprop","cheattext","cheattext4"],NoGravity:1b,Marker:1b,Invisible:1b,Invulnerable:1b,NoBasePlate:1b,CustomNameVisible:false}
