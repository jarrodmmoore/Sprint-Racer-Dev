...
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=optSetB] run data merge block 1593 79 433 {front_text:{has_glowing_text:0b,messages:['{"text":"","clickEvent":{"action":"run_command","value":"function sprint_racer:game_logic/0/options_signs/extra_chests"}}','{"text":"EXTRA CHESTS","bold":true,"color":"black"}','{"text":"[NEVER]","color":"dark_blue"}','{"text":""}']},is_waxed:1b}
