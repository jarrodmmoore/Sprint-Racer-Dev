...
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=optSetB] run data merge block 1609 80 365 {front_text:{has_glowing_text:0b,messages:[{text:"",click_event:{action:"run_command",command:"function sprint_racer:game_logic/0/options_signs/absorption_race_start"}},{text:"ABSORPTION",bold:true,color:"black"},{text:"@ RACE START?",bold:true,color:"black"},{text:"[ALWAYS]",color:"dark_blue"}]},is_waxed:1b}
...
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=optSetB] run data merge block 1609 80 365 {front_text:{has_glowing_text:0b,messages:[{text:"",click_event:{action:"run_command",command:"function sprint_racer:game_logic/0/options_signs/absorption_race_start"}},{text:"ABSORPTION",bold:true,color:"black"},{text:"@ RACE START?",bold:true,color:"black"},{text:"[5+ PLAYERS]",color:"dark_blue"}]},is_waxed:1b}
...
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=optSetB] run data merge block 1609 80 365 {front_text:{has_glowing_text:0b,messages:[{text:"",click_event:{action:"run_command",command:"function sprint_racer:game_logic/0/options_signs/absorption_race_start"}},{text:"ABSORPTION",bold:true,color:"black"},{text:"@ RACE START?",bold:true,color:"black"},{text:"[NEVER]",color:"dark_blue"}]},is_waxed:1b}
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=optSetB] run tag @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand] remove absorpAlways
