...
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=optSetB] run data merge block 1583 69 432 {front_text:{has_glowing_text:0b,messages:[{text:"",click_event:{action:"run_command",command:"trigger tOption set 1017"}},{text:"LOOP?",bold:true,color:"black"},{text:"[YES]",color:"dark_blue"},{text:""}]},is_waxed:1b,allow_op_features:1b}
...
tag @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=optSetA,tag=grandprixloop] add optSetB
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=optSetB] run data merge block 1583 69 432 {front_text:{has_glowing_text:0b,messages:[{text:"",click_event:{action:"run_command",command:"trigger tOption set 1017"}},{text:"LOOP?",bold:true,color:"black"},{text:"[NO]",color:"dark_blue"},{text:""}]},is_waxed:1b,allow_op_features:1b}
