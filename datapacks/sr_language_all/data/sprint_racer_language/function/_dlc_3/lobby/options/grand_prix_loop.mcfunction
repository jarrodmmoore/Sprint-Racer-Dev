...
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=optSetB] run data merge block 1583 69 432 {front_text:{has_glowing_text:0b,messages:['{"text":"","clickEvent":{"action":"run_command","value":"function sprint_racer:game_logic/0/options_signs/grand_prix_loop"}}','{"text":"LOOP?","bold":true,"color":"black"}','{"text":"[YES]","color":"dark_blue"}','{"text":""}']},is_waxed:1b}
...
tag @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=optSetA,tag=grandprixloop] add optSetB
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=optSetB] run data merge block 1583 69 432 {front_text:{has_glowing_text:0b,messages:['{"text":"","clickEvent":{"action":"run_command","value":"function sprint_racer:game_logic/0/options_signs/grand_prix_loop"}}','{"text":"LOOP?","bold":true,"color":"black"}','{"text":"[NO]","color":"dark_blue"}','{"text":""}']},is_waxed:1b}
