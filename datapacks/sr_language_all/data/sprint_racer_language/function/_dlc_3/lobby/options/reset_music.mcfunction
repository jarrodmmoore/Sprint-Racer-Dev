...
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=optSetB] run data merge block 1609 80 364 {front_text:{has_glowing_text:0b,messages:[{text:"",click_event:{action:"run_command",command:"function sprint_racer:game_logic/0/options_signs/reset_music"}},{text:"RESET MUSIC",bold:true,color:"black"},{text:"ON DEATH?",bold:true,color:"black"},{text:"[NO]",color:"dark_blue"}]},is_waxed:1b}
