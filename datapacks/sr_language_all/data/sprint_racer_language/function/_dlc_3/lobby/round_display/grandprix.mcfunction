...
#execute if entity @e[tag=w,type=armor_stand,scores={roundNumber=2}] as @e[tag=roundDisplay,tag=roundNoTP] at @s run tp @s ~ ~ ~1
#execute if entity @e[tag=w,type=armor_stand,scores={roundNumber=3}] as @e[tag=roundDisplay,tag=roundNoTP] at @s run tp @s ~ ~ ~2
#execute if entity @e[tag=w,type=armor_stand,scores={roundNumber=4}] as @e[tag=roundDisplay,tag=roundNoTP] at @s run tp @s ~ ~ ~3
#execute if entity @e[tag=w,type=armor_stand,scores={roundNumber=5}] as @e[tag=roundDisplay,tag=roundNoTP] at @s run tp @s ~ ~ ~4

#mark the current round so it can show particles later
#execute if entity @e[tag=w,type=armor_stand,scores={roundNumber=1}] run tag @e[tag=roundNo1,tag=roundDisplay] add roundCurrent
#execute if entity @e[tag=w,type=armor_stand,scores={roundNumber=2}] run tag @e[tag=roundNo2,tag=roundDisplay] add roundCurrent
#execute if entity @e[tag=w,type=armor_stand,scores={roundNumber=3}] run tag @e[tag=roundNo3,tag=roundDisplay] add roundCurrent
#execute if entity @e[tag=w,type=armor_stand,scores={roundNumber=4}] run tag @e[tag=roundNo4,tag=roundDisplay] add roundCurrent
#execute if entity @e[tag=w,type=armor_stand,scores={roundNumber=5}] run tag @e[tag=roundNo5,tag=roundDisplay] add roundCurrent