summon armor_stand ~ ~1.6 ~ {CustomName:'{"translate":"sr.game.ko","color":"green","bold":true}',CustomNameVisible:1b,Marker:1b,Invulnerable:1b,Invisible:1b,Tags:["setscore","floatup"]}
