...
execute unless entity @a[tag=playing,scores={addPoints=1..}] if entity @e[tag=random,type=armor_stand,scores={addPoints=1..}] run scoreboard players remove @e[tag=w,type=armor_stand] gameTime 4