...
execute as @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1,scores={finishPos=1}] run function sprint_racer_language:_dlc_2/gameplay/race_end/race_give_points_teams_ai_nth {place:"1st"}
...
execute as @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1,scores={finishPos=2}] run function sprint_racer_language:_dlc_2/gameplay/race_end/race_give_points_teams_ai_nth {place:"2nd"}
...
execute as @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1,scores={finishPos=3}] run function sprint_racer_language:_dlc_2/gameplay/race_end/race_give_points_teams_ai_nth {place:"3rd"}
...
execute as @e[type=armor_stand,tag=AImaster,x=1548,y=155,z=406,distance=..1,scores={finishPos=4}] run function sprint_racer_language:_dlc_2/gameplay/race_end/race_give_points_teams_ai_nth {place:"4th"}
