...
execute as @a[tag=playing,tag=playerOrange,scores={addPoints=100..}] run scoreboard players add @e[tag=w,type=armor_stand] teamPoints 100
execute as @a[tag=playing,tag=playerOrange,scores={addPoints=10..}] run scoreboard players add @e[tag=w,type=armor_stand] teamPoints 10
execute as @a[tag=playing,tag=playerOrange,scores={addPoints=1..}] run scoreboard players add @e[tag=w,type=armor_stand] teamPoints 1
execute as @e[tag=random,type=armor_stand,tag=playerOrange,scores={addPoints=100..}] run scoreboard players add @e[tag=w,type=armor_stand] teamPoints 100
execute as @e[tag=random,type=armor_stand,tag=playerOrange,scores={addPoints=10..}] run scoreboard players add @e[tag=w,type=armor_stand] teamPoints 10
execute as @e[tag=random,type=armor_stand,tag=playerOrange,scores={addPoints=1..}] run scoreboard players add @e[tag=w,type=armor_stand] teamPoints 1

execute as @a[tag=playing,tag=playerCyan,scores={addPoints=100..}] run scoreboard players remove @e[tag=w,type=armor_stand] teamPoints 100
execute as @a[tag=playing,tag=playerCyan,scores={addPoints=10..}] run scoreboard players remove @e[tag=w,type=armor_stand] teamPoints 10
execute as @a[tag=playing,tag=playerCyan,scores={addPoints=1..}] run scoreboard players remove @e[tag=w,type=armor_stand] teamPoints 1
execute as @e[tag=random,type=armor_stand,tag=playerCyan,scores={addPoints=100..}] run scoreboard players remove @e[tag=w,type=armor_stand] teamPoints 100
execute as @e[tag=random,type=armor_stand,tag=playerCyan,scores={addPoints=10..}] run scoreboard players remove @e[tag=w,type=armor_stand] teamPoints 10
execute as @e[tag=random,type=armor_stand,tag=playerCyan,scores={addPoints=1..}] run scoreboard players remove @e[tag=w,type=armor_stand] teamPoints 1
...
execute unless entity @a[tag=playing,scores={addPoints=1..}] if entity @e[tag=random,type=armor_stand,scores={addPoints=1..}] run scoreboard players remove @e[tag=w,type=armor_stand,limit=1] gameTime 4