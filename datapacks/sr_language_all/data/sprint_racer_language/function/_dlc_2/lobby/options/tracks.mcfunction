...
scoreboard players set @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] trackSequenceR 0
scoreboard players set @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] trackSequenceB 0
