...
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,tag=optSetB] run data merge block 1588 89 453 {front_text:{has_glowing_text:0b,messages:[{text:"",click_event:{action:"run_command",command:"function sprint_racer:game_logic/0/options_signs/difficulty_ramp"}},{text:"DIFFICULTY",bold:true,color:"black"},{text:"RAMP-UP",bold:true,color:"black"},{text:"[OFF]",color:"dark_blue"}]},is_waxed:1b}
