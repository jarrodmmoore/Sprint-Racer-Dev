...
tellraw @a[tag=playing,tag=!self] ["",{text:" "},{text:" "},{translate:"sr.text_menu.yes",color:"yellow",bold:false,click_event:{action:"run_command",command:"/trigger mgVoteTrigger set 1"},hover_event:{action:"show_text",value:"Yes"}},{text:" "},{translate:"sr.mid_game_vote.click_to_vote",color:"gray"}]
