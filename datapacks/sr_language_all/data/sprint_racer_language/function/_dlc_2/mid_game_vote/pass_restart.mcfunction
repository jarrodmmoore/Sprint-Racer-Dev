...
execute if entity @e[tag=w,type=armor_stand,scores={gameState=1}] run function sprint_racer:game_logic/1/_initialize
execute if entity @e[tag=w,type=armor_stand,scores={gameState=3}] run function sprint_racer:game_logic/3/_initialize