...
#settings overrides
tellraw @a [{translate:"sr.basic.bracket_button",color:"light_purple",with:[{translate:"sr.custom_track.settings_overrides"}],click_event:{action:"run_command",command:"/trigger tTrackEditor set 1125"},hover_event:{action:"show_text",value:{translate:"sr.basic.bracket_button",color:"aqua",with:[{translate:"sr.custom_track.settings_overrides"}]}}}]

tellraw @a ["",{text:"[<<]",color:"yellow",click_event:{action:"run_command",command:"/trigger tTrackEditor set 1012"},hover_event:{action:"show_text",value:[{translate:"sr.basic.previous"}]}},{text:"  "},{text:"p. 2/3",italic:true},{text:"  "},{text:"[>>]",color:"yellow",click_event:{action:"run_command",command:"/trigger tTrackEditor set 1238"},hover_event:{action:"show_text",value:[{translate:"sr.basic.next"}]}}]
tellraw @a ["",{text:"===/\\=== ",color:"red"},{selector:"@e[limit=1,tag=focusT,type=armor_stand]"},{text:" ===/\\===",color:"red"}]