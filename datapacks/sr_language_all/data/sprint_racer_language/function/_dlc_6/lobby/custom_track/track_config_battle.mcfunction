...
#size
execute if entity @e[tag=focusT,type=armor_stand,tag=trackTiny] run tellraw @a ["",{"translate":"sr.custom_track.track_size","color":"white","bold":true},{"text":" "},{"text":"[<]","color":"yellow","clickEvent":{"action":"run_command","value":"/function sprint_racer:game_logic/10/custom_config/size_previous"},"hoverEvent":{"action":"show_text","contents":"Previous"}},{"text":" "},{"text":"[>]","color":"yellow","clickEvent":{"action":"run_command","value":"/function sprint_racer:game_logic/10/custom_config/size_next"},"hoverEvent":{"action":"show_text","contents":"Next"}},{"text":" "},{"text":" "},{"translate":"sr.lobby.size_tiny","color":"blue","bold":false}]
