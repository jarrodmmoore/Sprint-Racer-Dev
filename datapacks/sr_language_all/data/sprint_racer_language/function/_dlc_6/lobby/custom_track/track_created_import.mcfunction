...
execute if score #version_needs_warning value matches 0.. if score @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,limit=1] mapVersion <= #version_needs_warning value run tellraw @a ["",{translate:"sr.custom_track.imported_track_might_be_outdated",color:"red",bold:true}]
