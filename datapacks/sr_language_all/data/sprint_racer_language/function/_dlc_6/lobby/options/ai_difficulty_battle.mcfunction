...
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,scores={optBAIdiff=2}] run data merge block 1613 88 356 {front_text:{has_glowing_text:0b,messages:['{"text":"","clickEvent":{"action":"run_command","value":"function sprint_racer:game_logic/0/options_signs/ai_difficulty_battle"}}','{"text":"DIFFICULTY","bold":true,"color":"black"}','{"text":"[NORMAL]","color":"dark_blue"}','{"text":""}']},is_waxed:1b}
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,type=armor_stand,scores={optBAIdiff=3}] run data merge block 1613 88 356 {front_text:{has_glowing_text:0b,messages:['{"text":"","clickEvent":{"action":"run_command","value":"function sprint_racer:game_logic/0/options_signs/ai_difficulty_battle"}}','{"text":"DIFFICULTY","bold":true,"color":"black"}','{"text":"[HARD]","color":"dark_blue"}','{"text":""}']},is_waxed:1b}
