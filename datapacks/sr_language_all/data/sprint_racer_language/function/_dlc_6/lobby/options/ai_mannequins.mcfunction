...
execute store result score #test value run execute if entity @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1,tag=optMannequinAI,limit=1]
execute if score #test value matches ..0 run tag @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] add optMannequinAI
