...
execute if entity @e[tag=w,scores={currentTimeMsec=..4}] as @a[tag=playing,tag=!eliminated,scores={hp=..9,KOs=0..,subtitleDelay=..0}] run title @s subtitle ["",{"text":"❤ ","color":"red","bold":false},{"text":"0","color":"red","bold":true},{"score":{"name":"@s","objective":"hp"},"color":"red","bold":true}]
execute if entity @e[tag=w,scores={currentTimeMsec=5..}] as @a[tag=playing,tag=!eliminated,scores={hp=..9,KOs=0..,subtitleDelay=..0}] run title @s subtitle ["",{"text":"❤ ","color":"dark_red","bold":false},{"text":"0","color":"dark_red","bold":true},{"score":{"name":"@s","objective":"hp"},"color":"dark_red","bold":true}]
