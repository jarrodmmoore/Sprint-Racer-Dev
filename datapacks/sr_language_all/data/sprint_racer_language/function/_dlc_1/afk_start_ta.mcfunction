...
tag @s add self
execute if entity @e[tag=w,x=1560,y=150,z=406,distance=..1,scores={gameState=7..8}] run tellraw @a[tag=!self] ["",{"selector":"@s"},{"translate":"sr.was_moved_to_spectator_mode"}]
tag @s remove self