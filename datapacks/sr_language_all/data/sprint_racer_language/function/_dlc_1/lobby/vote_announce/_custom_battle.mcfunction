...
execute if entity @e[tag=chosenTrack,tag=trackSmall] run tag @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] add sizeSmall
execute if entity @e[tag=chosenTrack,tag=trackMedium] run tag @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] add sizeMedium
execute if entity @e[tag=chosenTrack,tag=trackLarge] run tag @e[type=armor_stand,tag=w,x=1560,y=150,z=406,distance=..1] add sizeLarge
