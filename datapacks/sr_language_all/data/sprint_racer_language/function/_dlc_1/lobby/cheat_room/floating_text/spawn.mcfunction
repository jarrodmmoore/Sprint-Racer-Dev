...
summon armor_stand 1635 89.2 443 {CustomName:{text:"--",color:"white",bold:false,italic:false},Tags:["lobbyprop","cheattext","cheattext3"],NoGravity:1b,Marker:1b,Invisible:1b,Invulnerable:1b,NoBasePlate:1b,CustomNameVisible:0b}

summon armor_stand 1635 88.7 443 {CustomName:{text:"--",color:"white",bold:false,italic:false},Tags:["lobbyprop","cheattext","cheattext4"],NoGravity:1b,Marker:1b,Invisible:1b,Invulnerable:1b,NoBasePlate:1b,CustomNameVisible:0b}
