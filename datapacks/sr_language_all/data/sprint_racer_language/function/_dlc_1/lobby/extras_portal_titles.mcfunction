...
#execute if entity @e[tag=w,type=armor_stand,tag=!realms] run summon armor_stand 1581 93 363 {CustomName:'{"text":"Custom Track Manager","color":"light_purple","bold":"true"}',CustomNameVisible:0b,Marker:1b,Invulnerable:1b,Invisible:1b,Tags:["cDisplay2"]}
