...
execute if score #test value matches 0 run return run schedule function mkmc:autoload_classic_dragon 10t
#=====

#import track
#(note: this will work once, then doing nothing on subsequent import attempts)
function sprint_racer:game_logic/10/storage/import_track {filename:"mkmc_classic_dragon"}
...
tag 948d076b-4daf-4521-8f94-fc634970a830 add r_1_only