...
execute if score #test value matches 0 run return run schedule function mkmc:autoload_presidio 10t
#=====

#import track
#(note: this will work once, then doing nothing on subsequent import attempts)
function sprint_racer:game_logic/10/storage/import_track {filename:"presidio"}