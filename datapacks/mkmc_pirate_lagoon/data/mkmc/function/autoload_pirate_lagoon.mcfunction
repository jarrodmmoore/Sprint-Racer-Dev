...
execute if score #test value matches 0 run return run schedule function mkmc:autoload_pirate_lagoon 10t
#=====

#import track
#(note: this will work once, then doing nothing on subsequent import attempts)
function sprint_racer:game_logic/10/storage/import_track {filename:"mkmc_pirate_lagoon"}