...
execute if score #test value matches 0 run return run schedule function mkmc:autoload_hurricane_islands_m 10t
#=====

#import track
#(note: this will work once, then doing nothing on subsequent import attempts)
function sprint_racer:game_logic/10/storage/import_track {filename:"mkmc_hurricane_islands_m"}
...
tag be032ae0-fc83-421b-ae32-b60e602fc1e1 add r_1_only
